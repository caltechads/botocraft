.. _api__eventbridge__ssm__configuration_compliance_state_change:

SSM Configuration Compliance State Change
=========================================

This is emitted when Systems Manager sends a `Configuration Compliance State Change` event. See `AWS
documentation
...
.. autopydantic_model:: botocraft.eventbridge.ssm.SSMConfigurationComplianceStateChangeEvent
    :show-inheritance:
    :inherited-members:
...
.. automodule:: botocraft.eventbridge.raw.ssm.configuration_compliance_state_change
    :members:
    :undoc-members:
    :show-inheritance:
    :exclude-members: update_forward_refs, model_extra, model_fields_set, validate, schema_json, model_rebuild, model_post_init, model_parametrized_name, model_json_schema, copy, from_orm, dict, json, schema, schema_json, model_dump
