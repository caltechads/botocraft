.. _api__eventbridge__ssm__ec2_command_status_change_notification:

SSM EC2 Command Status-change Notification
==========================================

This is emitted when Systems Manager sends a `EC2 Command Status-change Notification` event. See `AWS
documentation
...
.. autopydantic_model:: botocraft.eventbridge.ssm.SSMEC2CommandStatusChangeNotificationEvent
    :show-inheritance:
    :inherited-members:
...
.. automodule:: botocraft.eventbridge.raw.ssm.ec2_command_status_change_notification
    :members:
    :undoc-members:
    :show-inheritance:
    :exclude-members: update_forward_refs, model_extra, model_fields_set, validate, schema_json, model_rebuild, model_post_init, model_parametrized_name, model_json_schema, copy, from_orm, dict, json, schema, schema_json, model_dump
