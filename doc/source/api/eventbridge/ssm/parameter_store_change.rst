.. _api__eventbridge__ssm__parameter_store_change:

SSM Parameter Store Change
==========================

This is emitted when Systems Manager sends a `Parameter Store Change` event. See `AWS
documentation
...
.. autopydantic_model:: botocraft.eventbridge.ssm.SSMParameterStoreChangeEvent
    :show-inheritance:
    :inherited-members:
...
.. automodule:: botocraft.eventbridge.raw.ssm.parameter_store_change
    :members:
    :undoc-members:
    :show-inheritance:
    :exclude-members: update_forward_refs, model_extra, model_fields_set, validate, schema_json, model_rebuild, model_post_init, model_parametrized_name, model_json_schema, copy, from_orm, dict, json, schema, schema_json, model_dump
