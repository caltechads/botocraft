.. _api__eventbridge__codepipeline__action_execution_state_change:

CodePipeline Action Execution State Change
==========================================

This is emitted when a CodePipeline action execution changes state. See `AWS
documentation
...
.. autopydantic_model:: botocraft.eventbridge.codepipeline.CodePipelineActionExecutionStateChangeEvent
    :show-inheritance:
    :inherited-members:
...
.. automodule:: botocraft.eventbridge.raw.codepipeline.codepipelineactionexecutionstatechange
    :members:
    :undoc-members:
    :show-inheritance:
    :exclude-members: update_forward_refs, model_extra, model_fields_set, validate, schema_json, model_rebuild, model_post_init, model_parametrized_name, model_json_schema, copy, from_orm, dict, json, schema, schema_json, model_dump
