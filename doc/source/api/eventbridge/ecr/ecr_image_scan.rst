.. _api__eventbridge__ecr__ecr_image_scan:

ECR Image Scan
==============

This is emitted when an ECR image scan occurs.  See `AWS
documentation
...
.. autopydantic_model:: botocraft.eventbridge.ecr.ECRImageScanEvent
    :show-inheritance:
    :inherited-members:
...
.. automodule:: botocraft.eventbridge.ecr.raw.ecr_image_scan
    :members:
    :undoc-members:
    :show-inheritance:
    :exclude-members: update_forward_refs, model_extra, model_fields_set, validate, schema_json, model_rebuild, model_post_init, model_parametrized_name, model_json_schema, copy, from_orm, dict, json, schema, schema_json, model_dump