...
class TunnelSettings(BaseModel):
    ...
    Args:
        ...
        provisioner_tag_key: EC2 tag key used to identify provisioner instances.
        provisioner_tag_value: EC2 tag value used to identify provisioner instances.
    ...
    enabled: bool = True
    #: EC2 tag key used to discover provisioner instances in a target VPC.
    provisioner_tag_key: str = "Purpose"
    #: EC2 tag value used to discover provisioner instances in a target VPC.
    provisioner_tag_value: str = "provisioner"
