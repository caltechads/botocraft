...
class ScalingPolicyManager(Boto3ModelManager):
    ...
    def delete(
        ...
        Args:
            ...
            ServiceNamespace: The namespace of the Amazon Web Services service that
                provides the resource. For a resource
    ...
    def list(
        ...
        *,
        PolicyNames: "builtins.list[str] | None" = None,
        ...
        Keyword Args:
            ...
            ResourceId: The identifier of the resource associated with the scaling
                policy. This string consists of the resource
                type and unique identifier.
            ScalableDimension: The scalable dimension. This string consists of the
                service namespace, resource type, and scaling
...
class ScalableTargetManager(Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            Tags: Assigns one or more tags to the scalable target. Use this parameter to
                tag the scalable target when it is
                created. To tag an existing scalable target, use the TagResource
                operation.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
    ...
    def delete(
        ...
        To see which resources have been registered, use `DescribeScalableTargets <https://docs.aws.amazon.com/autoscaling/application/APIReference/API_Desc
        ...
        Args:
            ...
            ScalableDimension: The scalable dimension associated with the scalable
                target. This string consists of the service
    ...
    def list(
        ...
        *,
        ResourceIds: "builtins.list[str] | None" = None,
        ScalableDimension: "Literal['ecs:service:DesiredCount', 'ec2:spot-fleet-request:TargetCapacity', 'elasticmapreduce:instancegroup:InstanceCount', 'appstream:fleet:DesiredCapacity', 'dynamodb:table:ReadCapacityUnits', 'dynamodb:table:WriteCapacityUnits', 'dynamodb:index:ReadCapacityUnits', 'dynamodb:index:WriteCapacityUnits', 'rds:cluster:ReadReplicaCount', 'sagemaker:variant:DesiredInstanceCount', 'custom-resource:ResourceType:Property', 'comprehend:document-classifier-endpoint:DesiredInferenceUnits', 'comprehend:entity-recognizer-endpoint:DesiredInferenceUnits', 'lambda:function:ProvisionedConcurrency', 'cassandra:table:ReadCapacityUnits', 'cassandra:table:WriteCapacityUnits', 'kafka:broker-storage:VolumeSize', 'elasticache:cache-cluster:Nodes', 'elasticache:replication-group:NodeGroups', 'elasticache:replication-group:Replicas', 'neptune:cluster:ReadReplicaCount', 'sagemaker:variant:DesiredProvisionedConcurrency', 'sagemaker:inference-component:DesiredCopyCount', 'workspaces:workspacespool:DesiredUserSessions'] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
...
class ScheduledActionManager(Boto3ModelManager):
    ...
    def delete(
        ...
        Args:
            ...
            ResourceId: The identifier of the resource associated with the scheduled
                action. This string consists of the
                resource type and unique identifier.
            ScalableDimension: The scalable dimension. This string consists of the
                service namespace, resource type, and scaling
                property.
    ...
    def list(
        ...
        *,
        ScheduledActionNames: "builtins.list[str] | None" = None,
        ResourceId: "str | None" = None,
        ScalableDimension: "Literal['ecs:service:DesiredCount', 'ec2:spot-fleet-request:TargetCapacity', 'elasticmapreduce:instancegroup:InstanceCount', 'appstream:fleet:DesiredCapacity', 'dynamodb:table:ReadCapacityUnits', 'dynamodb:table:WriteCapacityUnits', 'dynamodb:index:ReadCapacityUnits', 'dynamodb:index:WriteCapacityUnits', 'rds:cluster:ReadReplicaCount', 'sagemaker:variant:DesiredInstanceCount', 'custom-resource:ResourceType:Property', 'comprehend:document-classifier-endpoint:DesiredInferenceUnits', 'comprehend:entity-recognizer-endpoint:DesiredInferenceUnits', 'lambda:function:ProvisionedConcurrency', 'cassandra:table:ReadCapacityUnits', 'cassandra:table:WriteCapacityUnits', 'kafka:broker-storage:VolumeSize', 'elasticache:cache-cluster:Nodes', 'elasticache:replication-group:NodeGroups', 'elasticache:replication-group:Replicas', 'neptune:cluster:ReadReplicaCount', 'sagemaker:variant:DesiredProvisionedConcurrency', 'sagemaker:inference-component:DesiredCopyCount', 'workspaces:workspacespool:DesiredUserSessions'] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
...
class StepAdjustment(Boto3Model):
    ...
    APIReference/API_StepScalingPolicyConfiguration.html>`_. Describes an adjustment
    based on the difference between the value
    of the aggregated CloudWatch metric and the breach threshold that you've defined for
    the alarm.
    ...
    * To initiate the adjustment when the metric is greater than or equal to 50 and less
    than 60, specify a lower bound of
    ...
    * At most one step adjustment can have a null lower bound. If one step adjustment
    has a negative lower bound, then there
    ...
    * At most one step adjustment can have a null upper bound. If one step adjustment
    has a positive upper bound, then there
...
interpreted (for example, an absolute number or a percentage). The valid values are
``ChangeInCapacity``,
``ExactCapacity``, and ``PercentChangeInCapacity``.
    """

    StepAdjustments: "builtins.list[StepAdjustment] | None" = Field(
    ...
    ECS service by 25 percent and you specify a ``MinAdjustmentMagnitude`` of 2. If the
    service has 4 tasks and the scaling policy is performed, 25 percent of 4 is 1.
    However, because you specified a ``MinAdjustmentMagnitude`` of 2, Application Auto
    ...
    Valid values are ``Minimum``, ``Maximum``, and ``Average``. If the aggregation type
    is null, the value is treated as ``Average``.
    """
...
class ApplicationAutoscalingPredefinedMetricSpecification(Boto3Model):
    ...
    The ``ALBRequestCountPerTarget`` metric type applies only to Spot Fleets and ECS
    services.
    """
    ...
    ``ALBRequestCountPerTarget`` and there is a target group attached to the Spot Fleet
    or ECS service.
    """
...
class TargetTrackingMetric(Boto3Model):
    ...
    Dimensions: "builtins.list[TargetTrackingMetricDimension] | None" = Field(
        default_factory=list
    )
    """
...
class TargetTrackingMetricDataQuery(Boto3Model):
    ...
    This expression can use the ``Id`` of the other metrics to refer to those metrics,
    and can also use the ``Id`` of other expressions to use the result of those
    expressions.
    """
    ...
    This name must be unique among all ``MetricDataQuery`` objects specified for a
    single scaling policy. If you are performing math expressions on this set of data,
    this name represents that data and can serve as a variable in the mathematical
...
class ApplicationAutoscalingCustomizedMetricSpecification(Boto3Model):
    ...
    * Add values for each required parameter from CloudWatch. You can use an existing
    metric, or a new metric that you
    ...
    * Choose a metric that changes proportionally with capacity. The value of the metric
    should increase or decrease in
      inverse proportion to the number of capacity units. That is, the value of the
      metric should decrease when capacity
    ...
    Dimensions: "builtins.list[MetricDimension] | None" = Field(default_factory=list)
    """
    ...
    *Amazon CloudWatch API Reference*.
    ...
    Metrics: "builtins.list[TargetTrackingMetricDataQuery] | None" = Field(
        default_factory=list
    )
    """
...
class ApplicationAutoscalingTargetTrackingScalingPolicyConfiguration(Boto3Model):
    ...
    For more information and for default values, see `Define cooldown periods <https://docs.aws.amazon.com/autoscaling/application/userguide/target-
    tracking-scaling-policy-overview.html#target-tracking-cooldown>`_ in the
    *Application Auto Scaling User Guide*.
    ...
    overview.html#target-tracking-cooldown>`_ in the *Application Auto Scaling User
    Guide*.
    """
    ...
    enabled and the target tracking scaling policy can remove capacity from the scalable
...
class PredictiveScalingPredefinedScalingMetricSpecification(Boto3Model):
    ...
    scaling policy uses individually
...
class PredictiveScalingMetric(Boto3Model):
    ...
    """
    Dimensions: "builtins.list[PredictiveScalingMetricDimension] | None" = Field(
        default_factory=list
    )
    """
...
class PredictiveScalingCustomizedMetricSpecification(Boto3Model):
    ...
    MetricDataQueries: "builtins.list[PredictiveScalingMetricDataQuery]"
    """
...
class ApplicationAutoscalingPredictiveScalingPolicyConfiguration(Boto3Model):
    ...
    MetricSpecifications: "builtins.list[PredictiveScalingMetricSpecification]"
    """
...
class ScalingPolicy(PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ScalingPolicyManager
    ...
    Alarms: "builtins.list[Alarm] | None" = Field(default_factory=list)
    """
    ...
    def pk(self) -> OrderedDict[str, Any]:
        ...
        :py:meth:`botocraft.services.application_autoscaling.ScalingPolicyManager.get`
        method, or to do
    ...
    @cached_property
    def scalable_target(self) -> "ScalableTarget | None":
        """
...
class ApplicationAutoscalingSuspendedState(Boto3Model):
    ...
    Set the value to ``true`` if you don't want Application Auto Scaling to remove
...
class ScalableTarget(ScalableTargetModelMixin, PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ScalableTargetManager
    ...
    def arn(self) -> str | None:
        ...
        This is the value of the :py:attr:`ScalableTargetARN` attribute.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`ResourceId` attribute.
    ...
    @cached_property
    def scheduled_action(self) -> "ScheduledAction | None":
        """
...
class ScheduledAction(PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ScheduledActionManager
    ...
    def arn(self) -> str | None:
        ...
        This is the value of the :py:attr:`ScheduledActionARN` attribute.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`ScheduledActionName` attribute.
    ...
    def pk(self) -> OrderedDict[str, Any]:
        ...
        :py:meth:`botocraft.services.application_autoscaling.ScheduledActionManager.get`
        method, or to do
...
class DescribeScalingPoliciesResponse(Boto3Model):
    ScalingPolicies: "builtins.list[ScalingPolicy] | None" = Field(default_factory=list)
    """
...
class DescribeScalableTargetsResponse(Boto3Model):
    ScalableTargets: "builtins.list[ScalableTarget] | None" = Field(
        default_factory=list
    )
    """
...
class DescribeScheduledActionsResponse(Boto3Model):
    ScheduledActions: "builtins.list[ScheduledAction] | None" = Field(
        default_factory=list
    )
    """
