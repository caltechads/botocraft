...
class DocDBClusterManager(Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            DBClusterParameterGroupName: The name of the cluster parameter group to
                associate with this cluster.
            ...
            MasterUserPassword: The password for the master database user. This password
            ...
            ManageMasterUserPassword: Specifies whether to manage the master user
                password with Amazon Web Services Secrets
                Manager.
            MasterUserSecretKmsKeyId: The Amazon Web Services KMS key identifier to
                encrypt a secret that is automatically
                generated and managed in Amazon Web Services Secrets Manager. This
                setting is valid only if the master user password
                is managed by Amazon DocumentDB in Amazon Web Services Secrets Manager
                for the DB cluster.
            SourceRegion: The ID of the region that contains the source for the db
                cluster.
        """
    ...
    def update(
        ...
        Keyword Args:
            NewDBClusterIdentifier: The new cluster identifier for the cluster when
                renaming a cluster. This value is stored as
                a lowercase string.
            ApplyImmediately: A value that specifies whether the changes in this request
                and any pending changes are
                ...
                window.
            DBClusterParameterGroupName: The name of the cluster parameter group to use
                for the cluster.
            VpcSecurityGroupIds: A list of virtual private cloud (VPC) security groups
                that the cluster will belong to.
            MasterUserPassword: The password for the master database user. This password
                can contain any printable ASCII
                character except forward slash (/), double quote ("), or the "at" symbol
                (@).
            CloudwatchLogsExportConfiguration: The configuration setting for the log
                types to be enabled for export to Amazon
            ...
            ManageMasterUserPassword: Specifies whether to manage the master user
                password with Amazon Web Services Secrets
                Manager. If the cluster doesn't manage the master user password with
                Amazon Web Services Secrets Manager, you can
                turn on this management. In this case, you can't specify
                ``MasterUserPassword``. If the cluster already manages the
                master user password with Amazon Web Services Secrets Manager, and you
                specify that the master user password is not
                managed with Amazon Web Services Secrets Manager, then you must specify
                ``MasterUserPassword``. In this case, Amazon
                DocumentDB deletes the secret and uses the new password for the master
            ...
            RotateMasterUserPassword: Specifies whether to rotate the secret managed by
                Amazon Web Services Secrets Manager for
    ...
    def delete(
        ...
        *,
        ...
        Args:
            DBClusterIdentifier: The cluster identifier for the cluster to be deleted.
                This parameter isn't case sensitive.

        Keyword Args:
            SkipFinalSnapshot: Determines whether a final cluster snapshot is created
                before the cluster is deleted. If ``true``
                is specified, no cluster snapshot is created. If ``false`` is specified,
                a cluster snapshot is created before the DB
                cluster is deleted.
            FinalDBSnapshotIdentifier: The cluster snapshot identifier of the new
                cluster snapshot created when
    ...
    def get(self, *, DBClusterIdentifier: "str | None" = None) -> "DocDBCluster | None":
        ...
        ``filterName=engine,Values=docdb`` filter
        parameter to return only Amazon DocumentDB clusters.

        Keyword Args:
            DBClusterIdentifier: The user-provided cluster identifier. If this parameter
                is specified, information from only the
    ...
    def failover(
        ...
        *,
        ...
        Keyword Args:
            DBClusterIdentifier: A cluster identifier to force a failover for. This
    ...
    def restore_to_point_in_time(
        ...
        *,
        ...
        Args:
            ...
            SourceDBClusterIdentifier: The identifier of the source cluster from which
                to restore.
        ...
        Keyword Args:
            ...
            UseLatestRestorableTime: A value that is set to ``true`` to restore the
                cluster to the latest restorable backup
            ...
            VpcSecurityGroupIds: A list of VPC security groups that the new cluster
                belongs to.
            Tags: The tags to be assigned to the restored cluster.
            KmsKeyId: The KMS key identifier to use when restoring an encrypted cluster
                from an encrypted cluster.
            EnableCloudwatchLogsExports: A list of log types that must be enabled for
            ...
            DeletionProtection: Specifies whether this cluster can be deleted. If
                ...
                cannot be deleted unless it is modified and ``DeletionProtection`` is
                disabled. ``DeletionProtection`` protects
                clusters from being accidentally deleted.
            ServerlessV2ScalingConfiguration: Contains the scaling configuration of an
    ...
    def start(self, DBClusterIdentifier: str) -> "DocDBCluster":
        ...
        For more information, see `Stopping and Starting an Amazon DocumentDB Cluster <https://docs.aws.amazon.com/documentdb/latest/developerguide/db-cluster-stop-
        start.html>`_.
...
class DocDBInstanceManager(Boto3ModelManager):
    ...
    def update(
        ...
        Keyword Args:
            ApplyImmediately: Specifies whether the modifications in this request and
                any pending modifications are
                asynchronously applied as soon as possible, regardless of the
                ``PreferredMaintenanceWindow`` setting for the
                instance.
            NewDBInstanceIdentifier: The new instance identifier for the instance when
                renaming an instance. When you change the
                instance identifier, an instance reboot occurs immediately if you set
                ``Apply Immediately`` to ``true``. It occurs
                during the next maintenance window if you set ``Apply Immediately`` to
                ``false``. This value is stored as a
                lowercase string.
    ...
    def delete(self, DBInstanceIdentifier: str) -> "DocDBInstance":
        ...
        Args:
            DBInstanceIdentifier: The instance identifier for the instance to be
        ...
        This API supports pagination.
                Keyword Args:
                    DBInstanceIdentifier: The user-provided instance identifier. If this
                        parameter is specified, information from only
                        the specific instance is returned. This parameter isn't case
                        sensitive.
    ...
    def reboot(
        ...
        Args:
            DBInstanceIdentifier: The instance identifier. This parameter is stored as a
                lowercase string.
...
class DocDBCluster(TagsDictMixin, DocDBClusterModelMixin, PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = DocDBClusterManager
    ...
    If ``DeletionProtection`` is enabled, the cluster cannot be deleted unless it is
    modified and ``DeletionProtection`` is disabled. ``DeletionProtection`` protects
    clusters from being accidentally deleted.
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`DBClusterIdentifier` attribute.
    ...
    def arn(self) -> str | None:
        ...
        This is the value of the :py:attr:`DBClusterArn` attribute.
    ...
    def subnets(self) -> "list[Subnet] | None":
        """
        Return the EC2 subnets associated with this DB cluster, if any.
...
class DBInstanceStatusInfo(Boto3Model):
    ...
    For a ``StatusType`` of read replica, the values can be ``replicating``, error,
...
class DocDBInstance(TagsDictMixin, PrimaryBoto3Model):
    ...
    """
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = DocDBInstanceManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`DBInstanceIdentifier` attribute.
    ...
    def arn(self) -> str | None:
        ...
        This is the value of the :py:attr:`DBInstanceArn` attribute.
...
class DocDBSubnetGroup(PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = DocDBSubnetGroupManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`DBSubnetGroupArn` attribute.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`DBSubnetGroupName` attribute.
