...
class IAMAccessKeyManager(Boto3ModelManager):
    ...
    def delete(self, AccessKeyId: str, *, UserName: "str | None" = None) -> None:
        ...
        Args:
            AccessKeyId: The access key ID for the access key ID and secret access key
                you want to delete.
    ...
    def list(
        ...
        Keyword Args:
            ...
            MaxItems: Use this only when paginating results to indicate the maximum
                number of items you want in the response. If
...
class IAMGroupManager(Boto3ModelManager):
    ...
    def detach_policy(self, GroupName: str, PolicyArn: str) -> "None":
        ...
        Args:
            GroupName: The name (friendly name, not ARN) of the IAM group to detach the
                policy from.
    ...
    def list(
        ...
        Keyword Args:
            PathPrefix: The path prefix for filtering the results. For example, the
                prefix ``/division_abc/subdivision_xyz/``
    ...
    def list_for_user(
        ...
        results: "builtins.list[IAMGroup]" = []
        ...
        self.sessionize(results)
        return cast("builtins.list[IAMGroup]", results)
        ...
        *,
        ...
        Keyword Args:
            PathPrefix: The path prefix for filtering the results. This parameter is
                optional. If it is not included, it
        ...
        results: "builtins.list[AttachedPolicy]" = []
        ...
        self.sessionize(results)
        return cast("builtins.list[AttachedPolicy]", results)
    ...
    def update(
        ...
        Keyword Args:
            NewPath: New path for the IAM group. Only include this if changing the
                group's path.
            NewGroupName: New name for the IAM group. Only include this if changing the
                group's name.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
...
class InstanceProfileManager(Boto3ModelManager):
    ...
    def get(self, InstanceProfileName: str) -> "InstanceProfile | None":
        """
    ...
    def list(
        ...
        *IAM User Guide*.
        ...
        Keyword Args:
            PathPrefix: The path prefix for filtering the results. For example, the
                prefix ``/application_abc/component_xyz/``
    ...
    def list_for_role(
        ...
        *IAM User Guide*.
        ...
        results: "builtins.list[InstanceProfile]" = []
        ...
        self.sessionize(results)
        return cast("builtins.list[InstanceProfile]", results)
...
class IAMLoginProfileManager(Boto3ModelManager):
    ...
    def get(self, UserName: str) -> "IAMLoginProfile | None":
        """
...
class IAMPolicyManager(IAMPolicyManagerMixin, Boto3ModelManager):
    ...
    def get(self, PolicyArn: str) -> "IAMPolicy | None":
        """
        Retrieves information about the specified managed policy, including the policy's
        default version and the total number of
        IAM users, groups, and roles to which the policy is attached. To retrieve the
        list of the specific users, groups, and
        ...
        document for a specific version of the
    ...
    def list(
        ...
        *,
        ...
        Keyword Args:
            ...
            PathPrefix: The path prefix for filtering the results. This parameter is
                optional. If it is not included, it
                defaults to a slash (/), listing all policies. This parameter allows
                ...
                (``u0021``) through the DEL character (``u007F``), including most
    ...
    def list_entities(
        ...
        *,
        ...
        Args:
            PolicyArn: The Amazon Resource Name (ARN) of the IAM policy for which you
                want the versions.
        ...
        Keyword Args:
            ...
            Marker: Use this parameter only when paginating results and only after you
                receive a response indicating that the
                results are truncated. Set it to the value of the ``Marker`` element in
                the response that you received to indicate
        ...
        _response = self.client.list_entities_for_policy(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ListEntitiesForPolicyResponse(**_response)

        results: "ListEntitiesForPolicyResponse" = None
        if response is not None:
            results = response
    ...
    def list_versions(
    ...
    ) -> "builtins.list[IAMPolicyVersion]":
        """
        ...
        results: "builtins.list[IAMPolicyVersion]" = []
        ...
        self.sessionize(results)
        return cast("builtins.list[IAMPolicyVersion]", results)
    ...
    def set_default_version(self, PolicyArn: str, VersionId: str) -> "None":
        ...
        Args:
            PolicyArn: The Amazon Resource Name (ARN) of the IAM policy whose default
...
class IAMPolicyVersionManager(Boto3ModelManager):
    ...
    def delete(self, PolicyArn: str, VersionId: str) -> None:
        ...
        Args:
            PolicyArn: The Amazon Resource Name (ARN) of the IAM policy from which you
    ...
    def get(self, PolicyArn: str, VersionId: str) -> "IAMPolicyVersion | None":
        """
...
class IAMRoleManager(Boto3ModelManager):
    ...
    def create_service_linked_role(
        ...
        *,
        ...
        Args:
            AWSServiceName: The service principal for the Amazon Web Services service to
                which this role is attached. You use a
        ...
        Keyword Args:
            ...
            CustomSuffix: A string that you provide, which is combined with the
                service-provided prefix to form the complete
                role name. If you make multiple requests for the same service, then you
                must supply a different ``CustomSuffix`` for
                each request. Otherwise the request fails with a duplicate role name
                error. For example, you could add ``-1`` or
                ``-debug`` to the suffix.
        """
        args: dict[str, Any] = dict(
    ...
    def delete_role_permissions_boundary(self, RoleName: str) -> "None":
        ...
        Args:
            RoleName: The name (friendly name, not ARN) of the IAM role from which you
    ...
    def list(
        ...
        If there are none, the operation returns an empty list. For more information about roles, see `IAM roles <https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html>`_ in the
        *IAM User Guide*.
    ...
    def update_assume_role_policy(self, RoleName: str, PolicyDocument: str) -> "None":
        ...
        Args:
            ...
            PolicyDocument: The policy that grants an entity permission to assume the
                role.
        """
        args: dict[str, Any] = dict(
            RoleName=self.serialize(RoleName),
    ...
    def add_to_instance_profile(
        ...
        must then wait for the change to appear across all of Amazon Web Services
        because of `eventual
    ...
    def attach_policy(self, RoleName: str, PolicyArn: str) -> "None":
        ...
        Args:
            RoleName: The name (friendly name, not ARN) of the role to attach the policy
                to.
            PolicyArn: The Amazon Resource Name (ARN) of the IAM policy you want to
                attach.
        """
    ...
    def detach_policy(self, RoleName: str, PolicyArn: str) -> "None":
        ...
        Args:
            RoleName: The name (friendly name, not ARN) of the IAM role to detach the
                policy from.
            PolicyArn: The Amazon Resource Name (ARN) of the IAM policy you want to
                detach.
        """
...
class IAMUserManager(Boto3ModelManager):
    ...
    def get(self, UserName: str) -> "IAMUser | None":
        """
    ...
    def list(
        ...
        Keyword Args:
            PathPrefix: The path prefix for filtering the results. For example:
                ``/division_abc/subdivision_xyz/``, which would
    ...
    def update(
        ...
        Keyword Args:
            NewPath: New path for the IAM user. Include this parameter only if you're
                changing the user's path.
            NewUserName: New name for the user. Include this parameter only if you're
    ...
    def attach_policy(self, UserName: str, PolicyArn: str) -> "None":
        ...
        Args:
            UserName: The name (friendly name, not ARN) of the IAM user to attach the
                policy to.
            PolicyArn: The Amazon Resource Name (ARN) of the IAM policy you want to
                attach.
        """
    ...
    def detach_policy(self, UserName: str, PolicyArn: str) -> "None":
        ...
        Args:
            UserName: The name (friendly name, not ARN) of the IAM user to detach the
                policy from.
            PolicyArn: The Amazon Resource Name (ARN) of the IAM policy you want to
                detach.
        """
    ...
    def put_permission_boundary(
        ...
        Args:
            UserName: The name (friendly name, not ARN) of the IAM user for which you
    ...
    def delete_permission_boundary(self, UserName: str) -> "None":
        ...
        Args:
            UserName: The name (friendly name, not ARN) of the IAM user from which you
                want to remove the permissions boundary.
        """
        args: dict[str, Any] = dict(UserName=self.serialize(UserName))
...
class IAMSSHPublicKeyManager(Boto3ModelManager):
    ...
    def get(
        ...
        Args:
            UserName: The name of the IAM user associated with the SSH public key.
            SSHPublicKeyId: The unique identifier for the SSH public key.
            Encoding: Specifies the public key encoding format to use in the response.
                To retrieve the public key in ssh-rsa
                format, use ``SSH``. To retrieve the public key in PEM format, use
                ``PEM``.
        """
        args: dict[str, Any] = dict(
            UserName=self.serialize(UserName),
    ...
    def list(
        ...
        Args:
            UserName: The name of the IAM user to list SSH public keys for. If none is
                specified, the ``UserName`` field is
                determined implicitly based on the Amazon Web Services access key used
                to sign the request.
...
class IAMAccessKey(PrimaryBoto3Model):
    ...
    access key only when you first create an access key; you cannot recover the secret
    access key later. If you lose a
    secret access key, you must create a new access key.
    """

    manager_class: ClassVar[ModelType[Boto3ModelManager]] = IAMAccessKeyManager
    ...
    ``Active`` means that the key is valid for API calls, while ``Inactive`` means it is
    not.
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`AccessKeyId` attribute.
...
class IAMGroup(PrimaryBoto3Model):
    ...
    * `ListGroups <https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListGroups.html>`_
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = IAMGroupManager
...
The date and time, in `ISO 8601 date-time format <http://www.iso.org/iso/iso8601>`_, when the group was created.
    ...
    def attached_policies(self) -> "builtins.list[AttachedPolicy]":
        """
    ...
    def inline_policies(self) -> "builtins.list[str]":
        """
...
class IAMTag(Boto3Model):
    ...
    ``Human Resources``, ``Accounting``, and ``Support``. Tags with a key name of ``Cost
    Center`` might have values that consist of the number associated with the different
    cost centers in your company. Typically, many resources have tags with the same key
...
class InstanceProfile(TagsDictMixin, PrimaryBoto3Model):
    ...
    *
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = IAMTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = InstanceProfileManager
    ...
    Roles: "builtins.list[IAMRole]" = Field(frozen=True)
    """
    The role associated with the instance profile.
    """

    Tags: "builtins.list[IAMTag] | None" = Field(default_factory=list)
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`InstanceProfileName` attribute.
...
class IAMLoginProfile(PrimaryBoto3Model):
    ...
    This data type is used as a response element in the
    `CreateLoginProfile <https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateLoginProfile.html>`_ and
    `GetLoginProfile <https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetLoginProfile.html>`_ operations.
    """

    manager_class: ClassVar[ModelType[Boto3ModelManager]] = IAMLoginProfileManager
    UserName: str
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`UserName` attribute.
...
class IAMPolicy(TagsDictMixin, IAMPolicyMixin, PrimaryBoto3Model):
    ...
    `GetPolicy <https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetPolicy.html>`_, and
    `ListPolicies <https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListPolicies.html>`_ operations.

    For more information about managed policies, refer to `Managed policies and inline
    policies <https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html>`_ in the *IAM User Guide*.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = IAMTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = IAMPolicyManager
...
The date and time, in `ISO 8601 date-time format <http://www.iso.org/iso/iso8601>`_, when the policy was last updated.
    ...
    def versions(self) -> "builtins.list[IAMPolicyVersion]":
        """
...
class IAMPolicyVersion(PrimaryBoto3Model):
    ...
    `ListPolicyVersions <https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListPolicyVersions.html>`_, and `GetAccountAu
    thorizationDetails <https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetAccountAuthorizationDetails.html>`_
    operations.
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = IAMPolicyVersionManager
...
class IAMRoleLastUsed(Boto3Model):
    ...
    been used more than 400 days ago. For
    ...
    ps://docs.aws.amazon.com/IAM/latest/APIReference/API_GetAccountAuthorizationDetails.html>`_
    operations.
    """
...
class IAMRole(TagsDictMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = IAMTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = IAMRoleManager
    AssumeRolePolicyDocument: "dict[str, Any] | None" = Field(default_factory=dict)
    """
...
The date and time, in `ISO 8601 date-time format <http://www.iso.org/iso/iso8601>`_, when the role was created.
    ...
    Anyone who uses the CLI, or API to assume the role can specify the duration using
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`RoleName` attribute.
    ...
    def instance_profiles(self) -> "builtins.list[InstanceProfile]":
        """
...
class IAMUser(TagsDictMixin, PrimaryBoto3Model):
    ...
    * `ListUsers <https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListUsers.html>`_
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = IAMTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = IAMUserManager
...
used to sign in to an Amazon Web Services website. For a list of Amazon Web Services
...
span, only the first use is
returned in this field. If the field is null (no value), then it indicates that they
...
identities <https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html>`_  in the *IAM User Guide*.
    ...
    def groups(self) -> "builtins.list[IAMGroup]":
        """
...
class IAMSSHPublicKey(PrimaryBoto3Model):
    ...
    This data type is used as a response element in the
    `GetSSHPublicKey <https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetSSHPublicKey.html>`_ and
    `UploadSSHPublicKey <https://docs.aws.amazon.com/IAM/latest/APIReference/API_UploadSSHPublicKey.html>`_ operations.
    """

    manager_class: ClassVar[ModelType[Boto3ModelManager]] = IAMSSHPublicKeyManager
...
The date and time, in `ISO 8601 date-time format <http://www.iso.org/iso/iso8601>`_, when the SSH public key was uploaded.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`SSHPublicKeyId` attribute.
...
class AccessKeyMetadata(Boto3Model):
    ...
    This data type is used as a response element in the
    `ListAccessKeys <https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListAccessKeys.html>`_ operation.
    """
...
ListAccessKeysResponseAccessKeyMetadata = AccessKeyMetadata
...
class ListAccessKeysResponse(Boto3Model):
    ...
    AccessKeyMetadata: "builtins.list[ListAccessKeysResponseAccessKeyMetadata]"
    """
    ...
    If your results were truncated, you can make a subsequent pagination request using
    the ``Marker`` request parameter to retrieve more items. Note that IAM might return
    fewer than the ``MaxItems`` number of results even when there are more results
    available. We recommend that you check ``IsTruncated`` after every call to ensure
...
class IAMAccessKeyLastUsed(Boto3Model):
    ...
    This data type is used as a response element in the
    `GetAccessKeyLastUsed <https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetAccessKeyLastUsed.html>`_ operation.
    """
...
class AttachedPolicy(Boto3Model):
    ...
    role. This data type is used as a
    ...
    `ListAttachedUserPolicies <https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListAttachedUserPolicies.html>`_, and `
    GetAccountAuthorizationDetails <https://docs.aws.amazon.com/IAM/latest/APIReference/API_GetAccountAuthorizationDetails.h
    tml>`_ operations.
...
class ListAttachedGroupPoliciesResponse(Boto3Model):
    ...
    AttachedPolicies: "builtins.list[AttachedPolicy] | None" = Field(
...
class ListInstanceProfilesResponse(Boto3Model):
    ...
    InstanceProfiles: "builtins.list[InstanceProfile]"
    """
...
class ListPoliciesResponse(Boto3Model):
    ...
    Policies: "builtins.list[IAMPolicy] | None" = Field(default_factory=list)
    """
    A list of policies.
    """
...
class PolicyGroup(Boto3Model):
    ...
    This data type is used as a response element in the
    `ListEntitiesForPolicy <https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListEntitiesForPolicy.html>`_ operation.
...
class ListEntitiesForPolicyResponse(Boto3Model):
    ...
    """
    PolicyGroups: "builtins.list[PolicyGroup] | None" = Field(default_factory=list)
    """
    A list of IAM groups that the policy is attached to.
    """

    PolicyUsers: "builtins.list[PolicyUser] | None" = Field(default_factory=list)
    """
    A list of IAM users that the policy is attached to.
    """
    PolicyRoles: "builtins.list[PolicyRole] | None" = Field(default_factory=list)
    """
...
class ListPolicyVersionsResponse(Boto3Model):
    ...
    """
    Versions: "builtins.list[IAMPolicyVersion] | None" = Field(default_factory=list)
    """
...
class SSHPublicKeyMetadata(Boto3Model):
    ...
    This data type is used as a response element in the
    `ListSSHPublicKeys <https://docs.aws.amazon.com/IAM/latest/APIReference/API_ListSSHPublicKeys.html>`_ operation.
    """
...
class ListSSHPublicKeysResponse(Boto3Model):
    ...
    SSHPublicKeys: "builtins.list[SSHPublicKeyMetadata] | None" = Field(
        default_factory=list
    )
    """
