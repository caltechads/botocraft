...
class SecretManager(Boto3ModelManager):
    ...
    def create(
        ...
        AddReplicaRegions: List["ReplicaRegionType"] | None = None,
    ...
    def get(self, SecretId: str) -> Optional["Secret"]:
        ...
        response = DescribeSecretResponse(**_response)
    ...
    def list(
        ...
        *,
        ...
        Filters: List["SecretsFilter"] | None = None,
    ...
    def rotate(
        ...
        *,
        ...
        ExternalSecretRotationMetadata: List["ExternalSecretRotationMetadataItem"] | None = None,
...
```RotateSecret`` <https://docs.aws.amazon.com/secretsmanager/latest/apireference/API_RotateSecret.html>`_ .
    ...
    A structure that defines the rotation configuration for the secret.
    """
    ExternalSecretRotationMetadata: List["ExternalSecretRotationMetadataItem"] = Field(
    ...
    """
    SecretVersionsToStages: Dict[str, List[str]] = Field(
...
class CreateSecretResponse(Boto3Model):
    ...
    """
    ReplicationStatus: List["ReplicationStatusType"] | None = None
    """
...
class DescribeSecretResponse(TagsDictMixin, Boto3Model):
    ...
    """
    VersionIdsToStages: Dict[str, List[str]] | None = None
    """
...
class ListSecretsResponse(Boto3Model):
    SecretList: List["Secret"] | None = None
    """
