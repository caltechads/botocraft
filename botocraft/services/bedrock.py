...
class ResourcePolicyManager(Boto3ModelManager):
    service_name: str = "bedrock"

    def get(self, resourceArn: str) -> "ResourcePolicy | None":
        """
        ...
        response = BedrockGetResourcePolicyResponse(**_response)

        if response and response.resourcePolicy:
            self.sessionize(response.resourcePolicy)
...
class FoundationModel(ReadonlyPrimaryBoto3Model):
    """
...
class Guardrail(PrimaryBoto3Model):
...
class AutomatedReasoningPolicy(PrimaryBoto3Model):
    """
...
class PromptRouter(PrimaryBoto3Model):
    """
...
class InferenceProfile(PrimaryBoto3Model):
    """
...
class ModelInvocationLoggingConfiguration(PrimaryBoto3Model):
    manager_class: ClassVar[type[Boto3ModelManager]] = (
...
class BedrockGetResourcePolicyResponse(Boto3Model):
    resourcePolicy: "str | None" = None
    """
