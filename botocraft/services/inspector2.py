...
class Inspector2FilterManager(Boto3ModelManager):
    ...
    def create(
        ...
        Args:
            ...
            filterCriteria: Defines the criteria to be used in the filter for querying
                findings.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
    ...
    def get(self, arn: str) -> "Inspector2Filter | None":
        """
...
class FindingManager(ReadonlyBoto3ModelManager):
    ...
    def list_aggregations(
        ...
        *,
        ...
        Keyword Args:
            accountIds: The Amazon Web Services account IDs to retrieve finding
                aggregation data for.
            aggregationRequest: Details of the aggregation request that is used to
                filter your aggregation results.
        """
...
class FindingsReportManager(Boto3ModelManager):
    ...
    def create_report(
        ...
        *,
        ...
        Keyword Args:
            filterCriteria: The filter criteria to apply to the results of the finding
                report.
        """
        args: dict[str, Any] = dict(
...
class DelegatedAdminAccountManager(Boto3ModelManager):
    ...
    def enable(
        ...
        Args:
            delegatedAdminAccountId: The Amazon Web Services account ID of the Amazon
    ...
    def disable(self, delegatedAdminAccountId: str) -> str:
        ...
        Args:
            delegatedAdminAccountId: The Amazon Web Services account ID of the current
                Amazon Inspector delegated administrator.
        """
        args: dict[str, Any] = dict(
            delegatedAdminAccountId=self.serialize(delegatedAdminAccountId)
        )
...
class VulnerabilityManager(VulnerabilityManagerMixin, ReadonlyBoto3ModelManager):
    service_name: str = "inspector2"
    ...
    def list(
        ...
        Args:
            filterCriteria: The criteria used to filter the results of a vulnerability
                search.
        """
...
class CisScanConfiguration(PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = CisScanConfigurationManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`scanConfigurationArn` attribute.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`scanName` attribute.
...
class FilterCriteria(Boto3Model):
    ...
    some, but not all, of the packages identified in the finding have fixes available
    through updated versions.
    """
...
layers.
    ...
    """
Filters the list of Amazon Web Services Lambda functions by the date and time that a
user last updated the
...
class Inspector2Filter(PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = Inspector2FilterManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`filterArn` attribute.
...
class Finding(ReadonlyPrimaryBoto3Model):
    ...
    """
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = FindingManager
    ...
    The ``type`` value determines the valid values for ``resource`` in your request. For
    more information, see
    `Finding types <https://docs.aws.amazon.com/inspector/latest/user/findings-types.html>`_
    in the Amazon
    ...
    ``UNTRIAGED`` applies to ``PACKAGE_VULNERABILITY`` type findings that the vendor has
    not assigned a severity yet. For more information, see
    `Severity levels for findings <https://docs.aws.amazon.com/inspector/latest/user/findings-understanding-severity.html>`_
    in the Amazon
    Inspector user guide.
    """
    ...
    The ``resource`` value determines the valid values for ``type`` in your request. For
    more information, see
    `Finding types <https://docs.aws.amazon.com/inspector/latest/user/findings-types.html>`_
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`findingArn` attribute.
...
class FindingsReport(ReadonlyPrimaryBoto3Model):
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = FindingsReportManager
...
class DelegatedAdminAccount(ReadonlyPrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = DelegatedAdminAccountManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`accountId` attribute.
...
class Vulnerability(ReadonlyPrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = VulnerabilityManager
...
class Ec2InstanceAggregation(Boto3Model):
    ...
    Valid values must be uppercase and underscore separated, examples are
