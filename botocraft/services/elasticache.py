...
class ElastiCacheUserManager(Boto3ModelManager):
    ...
    def create(
        ...
        """
        For Valkey engine version 7.2 onwards and Redis OSS 6.0 to 7.1: Creates a user. For more information, see `Using Role
        Based Access Control (RBAC) <http://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Clusters.RBAC.html>`_.
    ...
    def delete(self, UserId: str) -> "ElastiCacheUser":
        """
        For Valkey engine version 7.2 onwards and Redis OSS 6.0 onwards: Deletes a user. The user will be removed from all user
        groups and in turn removed from all replication groups. For more information, see `Using Role Based Access Control
...
class ElastiCacheUserGroupManager(Boto3ModelManager):
    ...
    def create(self, model: "ElastiCacheUserGroup") -> "ElastiCacheUserGroup":
        """
        For Valkey engine version 7.2 onwards and Redis OSS 6.0 to 7.1: Creates a user group. For more information, see `Using
        Role Based Access Control (RBAC) <http://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Clusters.RBAC.html>`_
    ...
    def delete(self, UserGroupId: str) -> "ElastiCacheUserGroup":
        """
        For Valkey engine version 7.2 onwards and Redis OSS 6.0 onwards: Deletes a user group. The user group must first be
        disassociated from the replication group before it can be deleted. For more information, see `Using Role Based Access
...
class ElastiCacheUserGroup(TagsDictMixin, PrimaryBoto3Model):
    ...
    def name(self) -> str | None:
        """
        Return the name of the model.   This is the value of the :py:attr:`UserGroupId`
        attribute.
