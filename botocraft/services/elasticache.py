...
from botocraft.services.elbv2 import AvailabilityZone
...
class CacheClusterManager(ElastiCacheManagerTagsMixin, Boto3ModelManager):
    ...
    def create(
        ...
        PreferredAvailabilityZones: "builtins.list[str] | None" = None,
        CacheParameterGroupName: "str | None" = None,
        CacheSecurityGroupNames: "builtins.list[str] | None" = None,
        SecurityGroupIds: "builtins.list[str] | None" = None,
        Tags: "builtins.list[Tag] | None" = None,
        SnapshotArns: "builtins.list[str] | None" = None,
        ...
        PreferredOutpostArns: "builtins.list[str] | None" = None,
    ) -> "CacheCluster":
        """
        Creates a cluster.
        ...
        Keyword Args:
            AZMode: Specifies whether the nodes in this Memcached cluster are created in
                a single Availability Zone or created
            ...
            SnapshotArns: A single-element string list containing an Amazon Resource
                Name (ARN) that uniquely identifies a
                Valkey or Redis OSS RDB snapshot file stored in Amazon S3. The snapshot
                file is used to populate the node group
            ...
            SnapshotName: The name of a Valkey or Redis OSS snapshot from which to
                restore data into the new node group (shard).
                The snapshot status changes to ``restoring`` while the new node group
            ...
            NotificationTopicArn: The Amazon Resource Name (ARN) of the Amazon Simple
                Notification Service (SNS) topic to which
    ...
    def update(
        self,
        model: "CacheCluster",
        CacheNodeIdsToRemove: "builtins.list[str] | None" = None,
        AZMode: "Literal['single-az', 'cross-az'] | None" = None,
        NewAvailabilityZones: "builtins.list[str] | None" = None,
        CacheSecurityGroupNames: "builtins.list[str] | None" = None,
        SecurityGroupIds: "builtins.list[str] | None" = None,
        NotificationTopicArn: "str | None" = None,
        CacheParameterGroupName: "str | None" = None,
        ...
        Keyword Args:
            CacheNodeIdsToRemove: A list of cache node IDs to be removed. A node ID is a
                numeric identifier (0001, 0002, etc.).
                This parameter is only valid when ``NumCacheNodes`` is less than the
                existing number of cache nodes. The number of
                cache node IDs supplied in this parameter must match the difference
                between the existing number of cache nodes in
                the cluster or pending cache nodes, whichever is greater, and the value
                of ``NumCacheNodes`` in the request.
            AZMode: Specifies whether the new nodes in this Memcached cluster are all
                created in a single Availability Zone or
            ...
            NotificationTopicStatus: The status of the Amazon SNS notification topic.
                Notifications are sent only if the status
                is ``active``.
            ApplyImmediately: If ``true``, this parameter causes the modifications in
                this request and any pending modifications
                to be applied, asynchronously and as soon as possible, regardless of the
                ``PreferredMaintenanceWindow`` setting for
                the cluster.
            AuthToken: Reserved parameter. The password used to access a password
                protected server. This parameter must be
                specified with the ``auth-token-update`` parameter. Password
                constraints:
            AuthTokenUpdateStrategy: Specifies the strategy to use to update the AUTH
                token. This parameter must be specified
                with the ``auth-token`` parameter. Possible values:
            ScaleConfig: Configures horizontal or vertical scaling for Memcached
                clusters, specifying the scaling percentage and
                interval.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
    ...
    def delete(
        ...
        the cluster itself. When you receive a successful response from this operation,
        Amazon ElastiCache immediately begins
        ...
        Keyword Args:
            FinalSnapshotIdentifier: The user-supplied name of a final cluster snapshot.
                This is the unique name that identifies
        ...
        *,
        ...
        Args:
            CacheClusterId: The user-supplied cluster identifier. If this parameter is
                specified, only information about that
...
class CacheParameterGroupManager(Boto3ModelManager):
    ...
    def create(
        self, model: "CacheParameterGroup", Tags: "builtins.list[Tag] | None" = None
    ) -> "CacheParameterGroup":
        """
        ...
        Keyword Args:
            Tags: A list of tags to be added to this resource. A tag is a key-value
                pair. A tag key must be accompanied by a tag
    ...
    def get(self, CacheParameterGroupName: str) -> "CacheParameterGroup | None":
        """
    ...
    def reset(
        ...
        *,
        ...
        ParameterNameValues: "builtins.list[ParameterNameValue] | None" = None,
    ) -> str:
        """
        ...
        Keyword Args:
            ResetAllParameters: If ``true``, all parameters in the cache parameter group
                are reset to their default values. If
                ``false``, only the parameters listed by ``ParameterNameValues`` are
                reset to their default values.
            ParameterNameValues: An array of parameter names to reset to their default
                values. If ``ResetAllParameters`` is
                ``true``, do not use ``ParameterNameValues``. If ``ResetAllParameters``
                is ``false``, you must specify the name of
    ...
    def parameters(
        ...
        results: "builtins.list[CacheParameter]" = []
        ...
        self.sessionize(results)
        return cast("builtins.list[CacheParameter]", results)
...
class CacheSubnetGroupManager(Boto3ModelManager):
    ...
    def create(
        self, model: "CacheSubnetGroup", Tags: "builtins.list[Tag] | None" = None
    ) -> "CacheSubnetGroup":
        """
    ...
    def update(
        self, model: "CacheSubnetGroup", SubnetIds: "builtins.list[str] | None" = None
    ) -> "CacheSubnetGroup":
        """
    ...
    def get(self, CacheSubnetGroupName: str) -> "CacheSubnetGroup | None":
        """
...
class CacheSecurityGroupManager(Boto3ModelManager):
    ...
    def create(
        self, model: "CacheSecurityGroup", Tags: "builtins.list[Tag] | None" = None
    ) -> "CacheSecurityGroup":
        """
        ...
        Use a cache security group to control access to one or more clusters.
                ...
                Keyword Args:
                    Tags: A list of tags to be added to this resource. A tag is a
                        key-value pair. A tag key must be accompanied by a tag
                        value, although null is accepted.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
    ...
    def get(self, CacheSecurityGroupName: str) -> "CacheSecurityGroup | None":
        """
    ...
    def authorize_ingress(
        ...
        Args:
            ...
            EC2SecurityGroupOwnerId: The Amazon account number of the Amazon EC2
                security group owner. Note that this is not the
                same thing as an Amazon access key ID - you must provide a valid Amazon
...
class ReplicationGroupManager(ElastiCacheManagerTagsMixin, Boto3ModelManager):
    ...
    def create(
        ...
        PreferredCacheClusterAZs: "builtins.list[str] | None" = None,
        NumNodeGroups: "int | None" = None,
        ReplicasPerNodeGroup: "int | None" = None,
        NodeGroupConfiguration: "builtins.list[NodeGroupConfiguration] | None" = None,
        ...
        Keyword Args:
            ...
            PreferredCacheClusterAZs: A list of EC2 Availability Zones in which the
                replication group's clusters are created.
                The order of the Availability Zones in the list is the order in which
                clusters are allocated. The primary cluster is
                created in the first AZ in the list.
            NumNodeGroups: An optional parameter that specifies the number of node
                groups (shards) for this Valkey or Redis OSS
                (cluster mode enabled) replication group. For Valkey or Redis OSS
                (cluster mode disabled) either omit this parameter
                or set it to 1.
            ...
            EngineVersion: The version number of the cache engine to be used for the
                clusters in this replication group. To view
                the supported cache engine versions, use the
                ``DescribeCacheEngineVersions`` operation.
            CacheParameterGroupName: The name of the parameter group to associate with
                this replication group. If this argument
                is omitted, the default cache parameter group for the specified engine
                is used.
            ...
            Tags: A list of tags to be added to this resource. Tags are comma-separated
                ...
                Value=``myKeyValue``. You can include multiple tags as shown following: Key=``myKey``,
                    Value=``myKeyValue``
            ...
            SnapshotName: The name of a snapshot from which to restore data into the new
                replication group. The snapshot status
                changes to ``restoring`` while the new replication group is being
                created.
            PreferredMaintenanceWindow: Specifies the weekly time range during which
                maintenance on the cluster is performed. It
                is specified as a range in the format ddd:hh24:mi-ddd:hh24:mi (24H Clock
                UTC). The minimum maintenance window is a
                60 minute period.
            ...
            DataTieringEnabled: Enables data tiering. Data tiering is only supported for
                replication groups using the r6gd node
            ...
            ServerlessCacheSnapshotName: The name of the snapshot used to create a
                replication group. Available for Valkey,
                Redis OSS only.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
    ...
    def update(
        ...
        AuthToken: "str | None" = None,
        AuthTokenUpdateStrategy: "Literal['SET', 'ROTATE', 'DELETE'] | None" = None,
        UserGroupIdsToAdd: "builtins.list[str] | None" = None,
        UserGroupIdsToRemove: "builtins.list[str] | None" = None,
        ...
        This is limited to Valkey and Redis OSS 7 and above.
                ...
                Keyword Args:
                    ReplicationGroupDescription: A description for the replication
                        group. Maximum length is 255 characters.
                    PrimaryClusterId: For replication groups with a single primary, if
                        this parameter is specified, ElastiCache promotes
                        the specified cluster in the specified replication group to the
                        primary role. The nodes of all other clusters in the
                    ...
                    CacheSecurityGroupNames: A list of cache security group names to
                        authorize for the clusters in this replication
                        group. This change is asynchronously applied as soon as
                        possible.
                    SecurityGroupIds: Specifies the VPC Security Groups associated with
                        the clusters in the replication group.
                    PreferredMaintenanceWindow: Specifies the weekly time range during
                        which maintenance on the cluster is performed. It
                        is specified as a range in the format ddd:hh24:mi-ddd:hh24:mi
                        (24H Clock UTC). The minimum maintenance window is a
                        60 minute period.
                    ...
                    EngineVersion: The upgraded version of the cache engine to be run on
                        the clusters in the replication group.
                    AuthToken: Reserved parameter. The password used to access a
                        password protected server. This parameter must be
                        specified with the ``auth-token-update-strategy``  parameter.
                        Password constraints:
                    AuthTokenUpdateStrategy: Specifies the strategy to use to update the
                        AUTH token. This parameter must be specified
                        with the ``auth-token`` parameter. Possible values:
                    UserGroupIdsToAdd: The ID of the user group you are associating with
                        the replication group.
                    UserGroupIdsToRemove: The ID of the user group to disassociate from
                        the replication group, meaning the users in the
                        group no longer can access the replication group.
                    RemoveUserGroups: Removes the user group associated with this
                        replication group.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
    ...
    def delete(
        ...
        *,
        ...
        only one primary, you can optionally delete
        ...
        Keyword Args:
            ...
            FinalSnapshotIdentifier: The name of a final node group (shard) snapshot.
                ElastiCache creates the snapshot from the
                primary node in the cluster, rather than one of the replicas; this is to
                ensure that it captures the freshest data.
    ...
    def get(self, ReplicationGroupId: str) -> "ReplicationGroup | None":
        """
...
class ElastiCacheUserManager(Boto3ModelManager):
    service_name: str = "elasticache"

    def create(
        self,
        model: "ElastiCacheUser",
        Passwords: "builtins.list[str] | None" = None,
        NoPasswordRequired: "bool | None" = None,
        AuthenticationMode: "AuthenticationMode | None" = None,
    ) -> "ElastiCacheUser":
        """
        For Valkey engine version 7.2 onwards and Redis OSS 6.0 to 7.1: Creates a user.

        For more information, see `Using Role Based Access Control (RBAC) <http://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Clusters.RBAC.html>`_.

        Args:
            model: The :py:class:`User` to create.

        Keyword Args:
            Passwords: Passwords used for this user. You can create up to two passwords
                for each user.
        ...
        args = dict(
            ...
            Passwords=self.serialize(Passwords),
            NoPasswordRequired=self.serialize(NoPasswordRequired),
            Tags=data.get("Tags"),
            AuthenticationMode=self.serialize(AuthenticationMode),
        )
        _response = self.client.create_user(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ElastiCacheUser(**_response)

        self.sessionize(response)
        return cast("ElastiCacheUser", response)

    def update(
        self,
        model: "ElastiCacheUser",
        AppendAccessString: "str | None" = None,
        Passwords: "builtins.list[str] | None" = None,
        NoPasswordRequired: "bool | None" = None,
        AuthenticationMode: "AuthenticationMode | None" = None,
    ) -> "ElastiCacheUser":
        ...
        args = dict(
            UserId=data.get("UserId"),
            AccessString=data.get("AccessString"),
            AppendAccessString=self.serialize(AppendAccessString),
            Passwords=self.serialize(Passwords),
            NoPasswordRequired=self.serialize(NoPasswordRequired),
            AuthenticationMode=self.serialize(AuthenticationMode),
            Engine=data.get("Engine"),
        )
        _response = self.client.modify_user(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ElastiCacheUser(**_response)
    ...
    def delete(self, UserId: str) -> "ElastiCacheUser":
        """
        ...
        replication groups. For more information, see `Using Role Based Access Control
        (RBAC) <http://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Clusters.RBAC.html>`_.

        Args:
            UserId: The ID of the user.
        """
        args: dict[str, Any] = dict(UserId=self.serialize(UserId))
        _response = self.client.delete_user(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ElastiCacheUser(**_response)
        return response

    @elasticache_user_add_tags
    def get(
        self, UserId: str, *, Engine: "str | None" = None
    ) -> "ElastiCacheUser | None":
        """
        ...
        """
        args: dict[str, Any] = dict(
            Engine=self.serialize(Engine), UserId=self.serialize(UserId)
        )
        _response = self.client.describe_users(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeUsersResult(**_response)

        if response and response.Users:
            self.sessionize(response.Users[0])
            return response.Users[0]
        return None

    @elasticache_users_get_add_tags
    def list(
        self,
        *,
        ...
        """
        paginator = self.client.get_paginator("describe_users")
        args: dict[str, Any] = dict(
            Engine=self.serialize(Engine),
            UserId=self.serialize(UserId),
...
class ElastiCacheUserGroupManager(Boto3ModelManager):
    service_name: str = "elasticache"

    def create(self, model: "ElastiCacheUserGroup") -> "ElastiCacheUserGroup":
        """
        For Valkey engine version 7.2 onwards and Redis OSS 6.0 to 7.1: Creates a user
        group.
        ...
        Args:
            model: The :py:class:`UserGroup` to create.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
        ...
        _response = self.client.create_user_group(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ElastiCacheUserGroup(**_response)

        self.sessionize(response)
        return cast("ElastiCacheUserGroup", response)

    def update(
        self,
        model: "ElastiCacheUserGroup",
        UserIdsToAdd: "builtins.list[str] | None" = None,
        UserIdsToRemove: "builtins.list[str] | None" = None,
    ) -> "ElastiCacheUserGroup":
        """
        Changes the list of users that belong to the user group.

        Args:
            model: The :py:class:`UserGroup` to update.
        ...
        args = dict(
            UserGroupId=data.get("UserGroupId"),
            UserIdsToAdd=self.serialize(UserIdsToAdd),
            UserIdsToRemove=self.serialize(UserIdsToRemove),
            Engine=data.get("Engine"),
        )
        _response = self.client.modify_user_group(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ElastiCacheUserGroup(**_response)
    ...
    def delete(self, UserGroupId: str) -> "ElastiCacheUserGroup":
        """
        For Valkey engine version 7.2 onwards and Redis OSS 6.0 onwards: Deletes a user
        group.
        ...
        Control (RBAC) <http://docs.aws.amazon.com/AmazonElastiCache/latest/dg/Clusters.RBAC.html>`_.

        Args:
            UserGroupId: The ID of the user group.
        """
        args: dict[str, Any] = dict(UserGroupId=self.serialize(UserGroupId))
        _response = self.client.delete_user_group(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ElastiCacheUserGroup(**_response)
        return response

    @elasticache_user_group_add_tags
    def get(self, UserGroupId: str) -> "ElastiCacheUserGroup | None":
        """
        ...
        """
        args: dict[str, Any] = dict(UserGroupId=self.serialize(UserGroupId))
        _response = self.client.describe_user_groups(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeUserGroupsResult(**_response)

        if response and response.UserGroups:
            self.sessionize(response.UserGroups[0])
            return response.UserGroups[0]
        return None

    @elasticache_user_groups_get_add_tags
    def list(self, *, UserGroupId: "str | None" = None) -> PrimaryBoto3ModelQuerySet:
        """
        Returns a list of user groups.
        ...
        Keyword Args:
            UserGroupId: The ID of the user group.
        """
        paginator = self.client.get_paginator("describe_user_groups")
        args: dict[str, Any] = dict(UserGroupId=self.serialize(UserGroupId))
        response_iterator = paginator.paginate(
            **{k: v for k, v in args.items() if v is not None}
        )
        ...
        for _response in response_iterator:
            ...
            if response.UserGroups:
                results.extend(response.UserGroups)
            else:
                if getattr(response, "NextToken", None):
                    continue
                break
...
class ElastiCachePendingModifiedValues(Boto3Model):
    ...
    CacheNodeIdsToRemove: "builtins.list[str] | None" = Field(default_factory=list)
    """
    ...
    LogDeliveryConfigurations: "builtins.list[PendingLogDeliveryConfiguration] | None" = Field(
...
class CacheParameterGroupStatus(Boto3Model):
    ...
    CacheNodeIdsToReboot: "builtins.list[str] | None" = Field(default_factory=list)
    """
...
class CacheNode(Boto3Model):
    ...
    Each cache node runs its own instance of the cluster's protocol- compliant caching
    ...
    current generation types provide more
    ...
    **M6g node types** (available only for Redis OSS engine version 5.0.6 onward and for
    Memcached engine version 1.5.16
    ...
    **T2 node types:** ``cache.t2.micro``, ``cache.t2.small``, ``cache.t2.medium``
    + Previous generation: (not recommended. Existing clusters are still supported but
        creation of new clusters is not
    ...
    * The configuration variables ``appendonly`` and ``appendfsync`` are not supported
    on Valkey, or on Redis OSS version
      2.8.22 and later.
    """
...
Refers to `slow-log <https://redis.io/commands/slowlog>`_ or engine-log.
    ...
    Values are one of ``enabling`` | ``disabling`` | ``modifying`` | ``active`` |
    ``error``
    """
...
class CacheCluster(CacheClusterModelMixin, PrimaryBoto3Model):
    ...
    """
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = CacheClusterManager
    ...
    CacheSecurityGroups: "builtins.list[CacheSecurityGroupMembership]" = Field(
    ...
    CacheNodes: "builtins.list[CacheNode]" = Field(default_factory=list, frozen=True)
    """
    ...
    SecurityGroups: "builtins.list[SecurityGroupMembership]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    For example, if you set ``SnapshotRetentionLimit`` to 5, a snapshot that was taken
    ...
    LogDeliveryConfigurations: "builtins.list[LogDeliveryConfiguration] | None" = Field(
        default_factory=list
    )
    """
    Returns the destination, format and type of the logs.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`CacheClusterId` attribute.
    ...
    @cached_property
    def parameter_group(self) -> "CacheParameterGroup | None":
        """
    ...
    def vpc(self) -> "Vpc | None":
        """
        Return the VPC associated with this cache cluster.
    ...
    def subnets(self) -> "list[Subnet] | None":
        """
        Return the EC2 subnets associated with this cache cluster.
    ...
    def security_groups(self) -> "list[SecurityGroup] | None":
        """
        Return the EC2 security groups associated with this cache cluster.
            ...
            pk = OrderedDict(
                {
                    "GroupIds": [
                        ...
                        for group in self.SecurityGroups
...
class CacheParameterGroup(PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = CacheParameterGroupManager
    IsGlobal: "bool | None"
    """
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`CacheParameterGroupName` attribute.
    ...
    def reset(
        self,
        ResetAllParameters: "bool | None" = None,
        ParameterNameValues: "builtins.list[ParameterNameValue] | None" = {},
    ) -> "str":
        """
...
class ElastiCacheSubnetOutpost(Boto3Model):
    """
    The ID of the outpost subnet.
    """

    SubnetOutpostArn: "str | None" = None
    """
    The outpost ARN of the subnet.
    """

class ElastiCacheSubnet(Boto3Model):
    """
    Represents the subnet associated with a cluster.

    This parameter refers to subnets defined in Amazon Virtual Private Cloud (Amazon
    VPC) and used with ElastiCache.
    """
    ...
    SubnetAvailabilityZone: "AvailabilityZone | None" = None
    """
    The Availability Zone associated with the subnet.
    """

    SubnetOutpost: "ElastiCacheSubnetOutpost | None" = None
    """
    The outpost ARN of the subnet.
    """

    SupportedNetworkTypes: "builtins.list[Literal['ipv4', 'ipv6', 'dual_stack']] | None" = Field(
        default_factory=list
    )
    """
...
class CacheSubnetGroup(PrimaryBoto3Model):
    ...
    * ``ModifyCacheSubnetGroup``
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = CacheSubnetGroupManager
    ...
    Subnets: "builtins.list[ElastiCacheSubnet]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    SupportedNetworkTypes: "builtins.list[Literal['ipv4', 'ipv6', 'dual_stack']]" = (
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`CacheSubnetGroupName` attribute.
...
class CacheSecurityGroup(PrimaryBoto3Model):
    ...
    * ``RevokeCacheSecurityGroupIngress``
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = CacheSecurityGroupManager
    ...
    EC2SecurityGroups: "builtins.list[EC2SecurityGroup]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`CacheSecurityGroupName` attribute.
...
class UserGroupsUpdateStatus(Boto3Model):
    ...
    UserGroupIdsToAdd: "builtins.list[str] | None" = Field(default_factory=list)
    """
    The ID of the user group to add.
    """

    UserGroupIdsToRemove: "builtins.list[str] | None" = Field(default_factory=list)
    """
...
member is only applicable for Valkey
...
``modifying``, ``deleting``.
    ...
    NodeGroupMembers: "builtins.list[NodeGroupMember] | None" = Field(
        default_factory=list
    )
    """
...
class ReplicationGroup(ReplicationGroupModelMixin, PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ReplicationGroupManager
...
failed``, ``snapshotting``.
    ...
    MemberClusters: "builtins.list[str]" = Field(default_factory=list, frozen=True)
    """
    The names of all the cache clusters that are part of this replication group.
    """

    NodeGroups: "builtins.list[NodeGroup]" = Field(default_factory=list, frozen=True)
    """
    ...
    A flag that enables encryption at-rest when set to ``true``.
    """
    MemberClustersOutpostArns: "builtins.list[str]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    """
    UserGroupIds: "builtins.list[str] | None" = Field(default_factory=list)
    """
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`ReplicationGroupId` attribute.
...
class CacheParameter(ReadonlyPrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = CacheParameterManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`ParameterName` attribute.
...
class ElastiCacheAuthentication(Boto3Model):
    """
    Indicates whether the user requires a password to authenticate.
    """

    Type: "Literal['password', 'no-password', 'iam'] | None" = None
    """
    Indicates whether the user requires a password to authenticate.
    """
...
class ElastiCacheUser(TagsDictMixin, PrimaryBoto3Model):
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ElastiCacheUserManager
    ...
    MinimumEngineVersion: str = Field(default=None, frozen=True)
    """
    The minimum engine version required, which is Redis OSS 6.0.
    """
    AccessString: "str | None" = None
    """
    Access permissions string used for this user.
    """

    UserGroupIds: "builtins.list[str]" = Field(default_factory=list, frozen=True)
    """
    Returns a list of the user group IDs the user belongs to.
    """

    Authentication: ElastiCacheAuthentication = Field(default=None, frozen=True)
    """
...
class UserGroupPendingChanges(Boto3Model):
    """
    Returns the updates being applied to the user group.
    """
    UserIdsToRemove: "builtins.list[str] | None" = Field(default_factory=list)
    """
    The list of user IDs to remove.
    """

    UserIdsToAdd: "builtins.list[str] | None" = Field(default_factory=list)
    """
    The list of user IDs to add.
    """

class ElastiCacheUserGroup(TagsDictMixin, PrimaryBoto3Model):
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ElastiCacheUserGroupManager
    ...
    UserIds: "builtins.list[str] | None" = Field(default_factory=list)
    """
    ...
    The minimum engine version required, which is Redis OSS 6.0.
    """
    PendingChanges: UserGroupPendingChanges = Field(default=None, frozen=True)
    """
    A list of updates being applied to the user group.
    """

    ReplicationGroups: "builtins.list[str]" = Field(default_factory=list, frozen=True)
    """
    A list of replication groups that the user group can access.
    """

    ServerlessCaches: "builtins.list[str]" = Field(default_factory=list, frozen=True)
    """
    ...
    Tags: "builtins.list[Tag] | None" = Field(default_factory=list)
    """
    The tags associated with the user group.
    """
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`UserGroupId` attribute.
...
class CacheClusterMessage(Boto3Model):
    ...
    CacheClusters: "builtins.list[CacheCluster] | None" = Field(default_factory=list)
    """
    A list of clusters.
...
class CacheParameterGroupsMessage(Boto3Model):
    ...
    CacheParameterGroups: "builtins.list[CacheParameterGroup] | None" = Field(
        default_factory=list
    )
    """
...
class CacheNodeTypeSpecificParameter(Boto3Model):
    ...
    For example, in a Valkey or Redis OSS cluster, a ``cache.m1.large`` cache node type
    ...
    CacheNodeTypeSpecificValues: "builtins.list[CacheNodeTypeSpecificValue] | None" = (
...
class CacheParameterGroupDetails(Boto3Model):
    ...
    Parameters: "builtins.list[CacheParameter] | None" = Field(default_factory=list)
    """
    A list of Parameter instances.
    """

    CacheNodeTypeSpecificParameters: "builtins.list[CacheNodeTypeSpecificParameter] | None" = Field(
        default_factory=list
    )
    """
...
class CacheSubnetGroupMessage(Boto3Model):
    ...
    CacheSubnetGroups: "builtins.list[CacheSubnetGroup] | None" = Field(
        default_factory=list
    )
    """
...
class CacheSecurityGroupMessage(Boto3Model):
    ...
    CacheSecurityGroups: "builtins.list[CacheSecurityGroup] | None" = Field(
        default_factory=list
    )
    """
...
class NodeGroupConfiguration(Boto3Model):
    ...
    Keyspaces range from 0 to 16,383. The string is in the format ``startkey-endkey``.
    """
    ...
    ReplicaAvailabilityZones: "builtins.list[str] | None" = Field(default_factory=list)
    """
    ...
    ReplicaOutpostArns: "builtins.list[str] | None" = Field(default_factory=list)
    """
...
class ReplicationGroupMessage(Boto3Model):
    ...
    ReplicationGroups: "builtins.list[ReplicationGroup] | None" = Field(
        default_factory=list
    )
    """
...
class AuthenticationMode(Boto3Model):
    """
    Specifies the authentication mode to use.
    """

    Type: "Literal['password', 'no-password-required', 'iam'] | None" = None
    """
    ...
    Passwords: "builtins.list[str] | None" = Field(default_factory=list)
    """
    Specifies the passwords to use for authentication if ``Type`` is set to
    ``password``.
    """

class DescribeUsersResult(Boto3Model):
    Users: "builtins.list[ElastiCacheUser] | None" = Field(default_factory=list)
    """
    A list of users.
    """
    ...
    Use this marker for pagination of results from this operation. If this parameter is
    specified, the response includes only records beyond the marker, up to the value
    specified by MaxRecords. >
    """

class DescribeUserGroupsResult(Boto3Model):
    UserGroups: "builtins.list[ElastiCacheUserGroup] | None" = Field(
        default_factory=list
    )
    """
    Returns a list of user groups.
