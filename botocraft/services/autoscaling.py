...
class AutoScalingGroupManager(Boto3ModelManager):
    ...
    def create(
        ...
        LifecycleHookSpecificationList: "builtins.list[LifecycleHookSpecification] | None" = None,
        ...
        **We strongly recommend using a launch template when calling this operation to
        ...
        Keyword Args:
            InstanceId: The ID of the instance used to base the launch configuration on.
                If specified, Amazon EC2 Auto Scaling
                uses the configuration values from the specified instance to create a
                new launch configuration. To get the instance
                ...
                information, see `Create an Auto Scaling group using parameters from an
                existing instance
            ...
            LifecycleHookSpecificationList: One or more lifecycle hooks to add to the
                Auto Scaling group before instances are
                launched.
            SkipZonalShiftValidation: If you enable zonal shift with cross-zone disabled
                load balancers, capacity could become
                imbalanced across Availability Zones. To skip the validation, specify
                ``true``. For more information, see `Auto
        ...
        args = dict(
            ...
            AvailabilityZoneIds=data.get("AvailabilityZoneIds"),
    ...
    def delete(
        ...
        Keyword Args:
            ForceDelete: Specifies that the group is to be deleted along with all
                instances associated with the group, without
                waiting for all instances to be terminated. This action also deletes any
    ...
    def get(
        ...
        Keyword Args:
            IncludeInstances: Specifies whether to include information about Amazon EC2
                instances in the response. When set to
    ...
    def list(
        self,
        *,
        AutoScalingGroupNames: "builtins.list[str] | None" = None,
        ...
        Keyword Args:
            AutoScalingGroupNames: The names of the Auto Scaling groups. By default, you
                can only specify up to 50 names. You
    ...
    def scale(self, AutoScalingGroupName: str, DesiredCapacity: int) -> None:
        ...
        Args:
            ...
            DesiredCapacity: The desired capacity is the initial capacity of the Auto
                Scaling group after this operation
    ...
    def instance_status(
        self, *, InstanceIds: "builtins.list[str] | None" = None
    ) -> "builtins.list[AutoScalingInstanceDetails]":
        """
        Gets information about the Auto Scaling instances in the account and Region.

        Keyword Args:
            InstanceIds: The IDs of the instances. If you omit this property, all Auto
                Scaling instances are described. If you
        ...
        results: "builtins.list[AutoScalingInstanceDetails]" = []
        ...
        self.sessionize(results)
        return cast("builtins.list[AutoScalingInstanceDetails]", results)
    ...
    def terminate_instance(
        ...
        Args:
            ...
            ShouldDecrementDesiredCapacity: Indicates whether terminating the instance
                also decrements the size of the Auto
                Scaling group.
        """
        args: dict[str, Any] = dict(
            InstanceId=self.serialize(InstanceId),
...
class LaunchConfigurationManager(Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            InstanceId: The ID of the instance to use to create the launch
                configuration. The new launch configuration derives
    ...
    def get(self, LaunchConfigurationName: str) -> "LaunchConfiguration | None":
        """
    ...
    def list(
        self, *, LaunchConfigurationNames: "builtins.list[str] | None" = None
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Gets information about the launch configurations in the account and Region.
        ...
        Keyword Args:
            LaunchConfigurationNames: The launch configuration names. If you omit this
                property, all launch configurations are
                described.
        """
...
class AutoScalingLaunchTemplateSpecification(Boto3Model):
    ...
    To get the version number, use the Amazon EC2 `DescribeLaunchTemplateV ersions <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeLaunchTemplateVersions.html>`_ API operation.
    New launch template versions can be created using the Amazon EC2 `CreateLaunchTemplateVersion <https://docs.aws.amazon.c
    om/AWSEC2/latest/APIReference/API_CreateLaunchTemplateVersion.html>`_ API. If the
    value is ``$Latest``, Amazon EC2 Auto
    Scaling selects the latest version of the launch template when launching instances.
    If the value is ``$Default``, Amazon
    EC2 Auto Scaling selects the default version of the launch template when launching
...
class NetworkBandwidthGbpsRequest(Boto3Model):
    ...
    minimum bandwidth. Amazon EC2 will
    identify instance types that support the specified minimum bandwidth, but the actual
    bandwidth of your instance might go
...
class AutoScalingPerformanceFactorReferenceRequest(Boto3Model):
    ...
    be compared against the CPU performance of the referenced instance family,
...
class AutoScalingCpuPerformanceFactorRequest(Boto3Model):
    ...
    References: "builtins.list[AutoScalingPerformanceFactorReferenceRequest] | None" = (
...
class AutoScalingBaselinePerformanceFactorsRequest(Boto3Model):
    ...
    The instance family establishes the lowest acceptable level of performance. Auto
    Scaling uses this baseline to guide instance type selection, but there is no
    guarantee that the selected instance types will always exceed the baseline for every
    application.

    Currently, this parameter only supports CPU performance as a baseline performance
    factor. For example, specifying ``c6i`` uses the CPU performance of the ``c6i``
...
class AutoScalingInstanceRequirements(Boto3Model):
    ...
    matching instance types, you can use
    ...
    * ``ExcludedInstanceTypes`` - The instance types to exclude from the list, even if
    ...
    type-selection.html>`_ in the *Amazon EC2 Auto Scaling User Guide*. For help
    determining which instance types match your
    attributes before you apply them to your Auto Scaling group, see `Preview instance
    types with specified
    attributes <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet-attribute-based-instance-type-
    selection.html#ec2fleet-get-instance-types-from-instance-requirements>`_ in the
    *Amazon EC2 User Guide*.
    ...
    For more information, see `Amazon EBS-optimized instances <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-optimized.html>`_ in the *Amazon EC2 User
    Guide*.
    """
    ...
    """
    AcceleratorManufacturers: "builtins.list[Literal['nvidia', 'amd', 'amazon-web-services', 'xilinx']] | None" = Field(
        default_factory=list
    )
    """
    ...
    AcceleratorNames: "builtins.list[Literal['a100', 'v100', 'k80', 't4', 'm60', 'radeon-pro-v520', 'vu9p']] | None" = Field(
        default_factory=list
    )
    """
...
class LaunchTemplateOverrides(Boto3Model):
    ...
    * Use multiple instance types.
    ...
    instead and let Amazon EC2 Auto Scaling
    provision the available instance types that meet your requirements. This can provide
    Amazon EC2 Auto Scaling with a
    larger selection of instance types to choose from when fulfilling Spot and On-Demand
    capacities. You can view which
    instance types are matched before you apply the instance requirements to your Auto
    Scaling group.

    After you define your instance requirements, you don't have to keep updating these
    settings to get new EC2 instance
    types automatically. Amazon EC2 Auto Scaling uses the instance requirements of the
    Auto Scaling group to determine
    ...
    see
    `Configure an Auto Scaling group to use instance weights <https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-mixed-instances-groups-instance-
    weighting.html>`_ in the *Amazon EC2 Auto Scaling User Guide*. Value must be in the
    range of 1-999.
    """
    ...
    `Specifying a different launch template for an instance type <https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-mixed-instances-
    groups-launch-template-overrides.html>`_ in the *Amazon EC2 Auto Scaling User
    Guide*.
    """
    ...
    When using Instance Refresh with ``ReplaceRootVolume`` strategy, this specifies the
    AMI for root volume replacement operations.
    """
...
class AutoScalingLaunchTemplate(Boto3Model):
    ...
    Overrides: "builtins.list[LaunchTemplateOverrides] | None" = Field(
        default_factory=list
    )
    """
...
class AutoScalingInstancesDistribution(Boto3Model):
    ...
    Valid only when the ``SpotAllocationStrategy`` is ``lowest-price``. Value must be in
    the range of 1-20.
    """
...
class AutoScalingInstanceReference(Boto3Model):
    ...
    The ``Quarantined`` state is not used. For more information, see
    `Amazon EC2 Auto Scaling instance lifecycle <https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-
    ...
    ``Healthy`` means that the instance is healthy and should remain in service.
    ``Unhealthy`` means that the instance is unhealthy and that Amazon EC2 Auto Scaling
...
class AutoScalingInstanceMaintenancePolicy(Boto3Model):
    ...
    *Amazon EC2 Auto Scaling User Guide*.
    ...
    ready to use to support your workload when replacing instances. Value range is 0 to
    ...
    It represents the maximum percentage of the group that can be in service and
    healthy, or pending, to support your workload when replacing instances. Value range
    is 100 to 200. To clear a previously set value, specify a value of ``-1``.
    """
...
class AutoScalingAvailabilityZoneImpairmentPolicy(Boto3Model):
    ...
    If you select ``Replace unhealthy``, instances that appear unhealthy will be
    replaced in all Availability Zones. If you select ``Ignore unhealthy``, instances
    will not be replaced in the Availability Zone with the active zonal shift. For more
    information, see
    `Auto Scaling group zonal shift <https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-zonal-
    shift.html>`_ in the *Amazon EC2 Auto Scaling User Guide*.
    """
...
class AutoScalingCapacityReservationTarget(Boto3Model):
    ...
    CapacityReservationIds: "builtins.list[str] | None" = Field(default_factory=list)
    """
    The Capacity Reservation IDs to launch instances into.
    """

    CapacityReservationResourceGroupArns: "builtins.list[str] | None" = Field(
        default_factory=list
    )
    """
...
class AutoScalingCapacityReservationSpecification(Boto3Model):
    ...
    If you specify ``open`` or ``none`` for ``CapacityReservationPreference``, do not
    specify a ``CapacityReservationTarget``.
    """
...
class AutoScalingInstanceLifecyclePolicy(Boto3Model):
    ...
    This policy controls instance behavior when an instance transitions through its
    lifecycle states. Configure retention triggers to specify when instances should move
    to a ``Retained`` state instead of automatic termination.
    ...
    These triggers determine when instances should move to a ``Retained`` state instead
    of automatic termination. This allows you to maintain control over instance
...
class AutoScalingGroup(TagsDictMixin, AutoScalingGroupModelMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = AutoScalingTagDescription
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = AutoScalingGroupManager
    ...
    AvailabilityZoneIds: "builtins.list[str] | None" = Field(default_factory=list)
    """
    The Availability Zone IDs where the Auto Scaling group can launch instances.
    """

    LoadBalancerNames: "builtins.list[str] | None" = Field(default_factory=list)
    """
    One or more load balancers associated with the group.
    """

    TargetGroupARNs: "builtins.list[str] | None" = Field(default_factory=list)
    """
    ...
    Instances: "builtins.list[AutoScalingInstanceReference]" = Field(
    ...
    """
    SuspendedProcesses: "builtins.list[SuspendedProcess]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    EnabledMetrics: "builtins.list[EnabledMetric]" = Field(
        default_factory=list, frozen=True
    )
    """
...
operation is in progress.
    ...
    Tags: "builtins.list[AutoScalingTagDescription] | None" = Field(
        default_factory=list
    )
    """
    ...
    TerminationPolicies: "builtins.list[str] | None" = Field(default_factory=list)
    """
    ...
    TrafficSources: "builtins.list[TrafficSourceIdentifier] | None" = Field(
        default_factory=list
    )
    """
    ...
    DeletionProtection: "Literal['none', 'prevent-force-deletion', 'prevent-all-deletion'] | None" = None
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`AutoScalingGroupName` attribute.
    ...
    def arn(self) -> str | None:
        ...
        This is the value of the :py:attr:`AutoScalingGroupARN` attribute.
    ...
    @cached_property
    def launch_configuration(self) -> "LaunchConfiguration | None":
        """
    ...
    @cached_property
    def launch_template(self) -> "LaunchTemplateVersion | None":
        """
...
class EbsMapping(Boto3Model):
    ...
    Guide*. If your AMI uses encrypted volumes, you can also only launch it on supported
    instance types.
    """
...
class LaunchConfiguration(PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = LaunchConfigurationManager
    ...
    ClassicLinkVPCSecurityGroups: "builtins.list[str] | None" = Field(
        default_factory=list
    )
    """
    Available for backward compatibility.
    ...
    BlockDeviceMappings: "builtins.list[AutoScalingBlockDeviceMapping] | None" = Field(
        default_factory=list
    )
    """
    ...
    Spot Instances are launched when the price you specify exceeds the current Spot
    price. For more information, see `Requesting Spot Instances for
    ...
    For more information, see `Amazon EBS-optimized instances <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-optimized.html>`_ in the
    *Amazon EC2 User Guide*.
    """
    ...
    An instance with ``dedicated`` tenancy runs on isolated, single-tenant hardware and
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`LaunchConfigurationName` attribute.
    ...
    def arn(self) -> str | None:
        ...
        This is the value of the :py:attr:`LaunchConfigurationARN` attribute.
...
class LifecycleHookSpecification(Boto3Model):
    ...
    The range is from ``30`` to ``7200`` seconds. The default value is ``3600`` seconds
    (1 hour).
    """
...
class AutoScalingGroupsType(Boto3Model):
    AutoScalingGroups: "builtins.list[AutoScalingGroup]"
    """
    The groups.
    """
    ...
    To receive additional items, specify this string for the ``NextToken`` value when
    requesting the next set of items. This value is null when there are no more items to
    return.
    """
...
class AutoScalingInstanceDetails(Boto3Model):
    ...
    The ``Quarantined`` state is not used. For more information, see
    `Amazon EC2 Auto Scaling instance lifecycle <https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-lifecycle.html>`_
    in
    the *Amazon EC2 Auto Scaling User Guide*.
    """
    HealthStatus: str
    ...
    ``Healthy`` means that the instance is healthy and should remain in service.
    ``Unhealthy`` means that the instance is unhealthy and Amazon EC2 Auto Scaling
    should terminate and replace it.
    """
    LaunchConfigurationName: "str | None" = None
    """
...
class AutoScalingInstancesType(Boto3Model):
    AutoScalingInstances: "builtins.list[AutoScalingInstanceDetails] | None" = Field(
        default_factory=list
    )
    """
    The instances.
...
class LaunchConfigurationsType(Boto3Model):
    LaunchConfigurations: "builtins.list[LaunchConfiguration]"
    """
