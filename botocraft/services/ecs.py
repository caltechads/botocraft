...
from botocraft.services.ec2 import Volume
...
from botocraft.mixins.ecs import ECSTaskModelMixin
...
class CapacityProviderManager(CapacityProviderManagerMixin, Boto3ModelManager):
    service_name: str = "ecs"

    def create(self, model: "CapacityProvider") -> "CapacityProvider":
        """
        ...
        providers for Amazon ECS Managed Instances and
        EC2 instances. Fargate has the predefined ``FARGATE`` and ``FARGATE_SPOT``
        capacity providers.
    ...
    def get(
        ...
        *,
        ...
        Args:
            capacityProvider: The short name or full Amazon Resource Name (ARN) of the
                capacity provider to describe.

        Keyword Args:
            cluster: The name of the cluster to describe capacity providers for. When
                specified, only capacity providers
                associated with this cluster are returned, including Amazon ECS Managed
                Instances capacity providers.
            include: Specifies whether or not you want to see the resource tags for the
                capacity provider. If ``TAGS`` is
    ...
    def get_many(
        ...
        *,
        ...
        Keyword Args:
            capacityProviders: The short name or full Amazon Resource Name (ARN) of one
                or more capacity providers. Up to
            ...
            maxResults: The maximum number of account setting results returned by
                ...
                output. When this parameter is used, ``DescribeCapacityProviders`` only
                returns ``maxResults`` results in a single
                page along with a ``nextToken`` response element. The remaining results
                of the initial request can be seen by
                sending another ``DescribeCapacityProviders`` request with the returned
                ``nextToken`` value. This value can be
                between 1 and 10. If this parameter is not used, then
                ``DescribeCapacityProviders`` returns up to 10 results and a
                ``nextToken`` value if applicable.
            nextToken: The ``nextToken`` value returned from a previous paginated
                ``DescribeCapacityProviders`` request where
                ``maxResults`` was used and the results exceeded the value of that
                parameter. Pagination continues from the end of
    ...
    def update(self, model: "CapacityProvider") -> "CapacityProvider":
        """
    ...
    def delete(
        ...
        Keyword Args:
            cluster: The name of the cluster that contains the capacity provider to
                delete. Managed instances capacity providers
                are cluster- scoped and can only be deleted from their associated
                cluster.
        """
        args: dict[str, Any] = dict(
...
class ServiceManager(ECSServiceManagerMixin, Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            clientToken: An identifier that you provide to ensure the idempotency of the
                request. It must be unique and is case
                sensitive. Up to 36 ASCII characters in the range of 33-126 (inclusive)
                are allowed.
            serviceConnectConfiguration: The configuration for this service to discover
                and connect to services, and be
            ...
            volumeConfigurations: The configuration for a volume specified in the task
                definition as a volume that is configured
                at launch time. Currently, the only supported volume type is an Amazon
                EBS volume.
            vpcLatticeConfigurations: The VPC Lattice configuration for the service
                being created.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
    ...
    def delete(
        ...
        Keyword Args:
            cluster: The short name or full Amazon Resource Name (ARN) of the cluster
                that hosts the service to delete. If you
            ...
            force: If ``true``, allows you to delete a service even if it wasn't scaled
                down to zero tasks. It's only necessary
        ...
        *,
        ...
        Keyword Args:
            cluster: The short name or full Amazon Resource Name (ARN)the cluster that
                hosts the service to describe. If you do
                not specify a cluster, the default cluster is assumed. This parameter is
                required if the service or services you are
            ...
            include: Determines whether you want to see the resource tags for the
                service. If ``TAGS`` is specified, the tags
                are included in the response. If this field is omitted, tags aren't
        ...
        You can filter the results by cluster, launch type, and scheduling strategy.
                Keyword Args:
                    cluster: The short name or full Amazon Resource Name (ARN) of the
                        cluster to use when filtering the ``ListServices``
                        results. If you do not specify a cluster, the default cluster is
                        assumed.
                    launchType: The launch type to use when filtering the
                        ``ListServices`` results.
                    schedulingStrategy: The scheduling strategy to use when filtering
                        the ``ListServices`` results.
                    resourceManagementType: The resourceManagementType type to use when
                        filtering the ``ListServices`` results.
        """
    ...
    def update(
        ...
        Keyword Args:
            forceNewDeployment: Determines whether to force a new deployment of the
                service. By default, deployments aren't
                forced. You can use this option to start a new deployment with no
                service definition changes. For example, you can
            ...
            volumeConfigurations: The details of the volume that was
                ``configuredAtLaunch``. You can configure the size,
                ...
                If set to null, no new deployment is
                triggered. Otherwise, if this configuration differs from the existing
                one, it triggers a new deployment.
            vpcLatticeConfigurations: An object representing the VPC Lattice
                configuration for the service being updated.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
    ...
    def partial_update(
        ...
        *,
        ...
        Keyword Args:
            cluster: The short name or full Amazon Resource Name (ARN) of the cluster
                that your service runs on. If you do not
            ...
            taskDefinition: The ``family`` and ``revision`` (``family:revision``) or
                full ARN of the task definition to run in
                your service. If a ``revision`` is not specified, the latest ``ACTIVE``
                revision is used. If you modify the task
                definition with ``UpdateService``, Amazon ECS spawns a task with the new
                version of the task definition and then
                stops an old task after the new version is running.
            capacityProviderStrategy: The details of a capacity provider strategy. You
                can set a capacity provider when you
                create a cluster, run a task, or update a service.
            deploymentConfiguration: Optional deployment parameters that control how
                many tasks run during the deployment and
                the ordering of stopping and starting tasks.
            availabilityZoneRebalancing: Indicates whether to use Availability Zone
                rebalancing for the service.
            ...
            placementConstraints: An array of task placement constraint objects to
                update the service to use. If no value is
                specified, the existing placement constraints for the service will
                remain unchanged. If this value is specified, it
                will override any existing placement constraints defined for the
                service. To remove all existing placement
                constraints, specify an empty array.
            placementStrategy: The task placement strategy objects to update the service
                to use. If no value is specified, the
                ...
                existing placement strategy, specify an empty
                object.
            platformVersion: The platform version that your tasks in the service run on.
                A platform version is only specified
                for tasks using the Fargate launch type. If a platform version is not
                specified, the ``LATEST`` platform version is
            ...
            enableECSManagedTags: Determines whether to turn on Amazon ECS managed tags
                for the tasks in the service. For more
            ...
            loadBalancers: You must have a service-linked role when you update this
                property
            propagateTags: Determines whether to propagate the tags from the task
                definition or the service to the task. If no
                value is specified, the tags aren't propagated.
            serviceRegistries: You must have a service-linked role when you update this
                property.
            serviceConnectConfiguration: The configuration for this service to discover
                and connect to services, and be
                discovered by, and connected from, other services within a namespace.
...
class ClusterManager(Boto3ModelManager):
    ...
    def delete(self, cluster: str) -> "Cluster":
        ...
        Args:
            cluster: The short name or full Amazon Resource Name (ARN) of the cluster to
                delete.
        """
        ...
        *,
        ...
        Keyword Args:
            include: Determines whether to include additional information about the
                clusters in the response. If this field is
        ...
        *,
        ...
        Keyword Args:
            clusters: A list of up to 100 cluster names or full cluster Amazon Resource
                Name (ARN) entries. If you do not
                specify a cluster, the default cluster is assumed.
            include: Determines whether to include additional information about the
                clusters in the response. If this field is
                omitted, this information isn't included.
        ...
        *,
        ...
        Keyword Args:
            ...
            serviceConnectDefaults: Use this parameter to set a default Service Connect
                namespace. After you set a default
                Service Connect namespace, any new services with Service Connect turned
                on that are created in the cluster are added
                as client services in the namespace. This setting only applies to new
                services that set the ``enabled`` parameter to
                ``true`` in the ``ServiceConnectConfiguration``. You can set the
                namespace of each service individually in the
...
class TaskDefinitionManager(TaskDefinitionManagerMixin, Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            tags: The metadata that you apply to the task definition to help you
                categorize and organize them. Each tag consists
    ...
    def delete(self, taskDefinitions: "builtins.list[str]") -> "TaskDefinition":
        ...
        Args:
            taskDefinitions: The ``family`` and ``revision`` (``family:revision``) or
                full Amazon Resource Name (ARN) of the
        ...
        *,
    ...
    ) -> "DescribeTaskDefinitionResponse | None":
        """
        Describes a task definition.

        You can specify a ``family`` and ``revision`` to find information about a
        specific task definition, or you can simply specify the family to find the
        ...
        Keyword Args:
            include: Determines whether to see the resource tags for the task
                definition. If ``TAGS`` is specified, the tags are
        ...
        *,
        ...
        Keyword Args:
            ...
            status: The task definition status to filter the ``ListTaskDefinitions``
                ...
                If you paginate the resulting output, be
            ...
            sort: The order to sort the results in. Valid values are ``ASC`` and
                ``DESC``. By default, (``ASC``) task
                definitions are listed lexicographically by family name and in ascending
                numerical order by revision so that the
                newest task definitions in a family are listed last. Setting this
                parameter to ``DESC`` reverses the sort order on
                family name and revision. This is so that the newest task definitions in
    ...
    def deregister(self, taskDefinition: str) -> "TaskDefinition":
        ...
        Upon deregistration, the task definition is marked as ``INACTIVE``. Existing
        tasks and services that reference an ``INACTIVE`` task definition continue to
        run without
        disruption. Existing services that reference an ``INACTIVE`` task definition can
        still scale up or down by modifying the
        service's desired count. If you want to delete a task definition revision, you
        must first deregister the task definition
        revision.

        Args:
            taskDefinition: The ``family`` and ``revision`` (``family:revision``) or
                full Amazon Resource Name (ARN) of the task
    ...
    def families(
        ...
        *,
        ...
        Keyword Args:
            familyPrefix: The ``familyPrefix`` is a string that's used to filter the
                results of ``ListTaskDefinitionFamilies``.
                If you specify a ``familyPrefix``, only task definition family names
                that begin with the ``familyPrefix`` string are
                returned.
            status: The task definition family status to filter the
                ``ListTaskDefinitionFamilies`` results with. By default,
                both ``ACTIVE`` and ``INACTIVE`` task definition families are listed. If
                this parameter is set to ``ACTIVE``, only
                task definition families that have an ``ACTIVE`` task definition
                revision are returned. If this parameter is set to
                ``INACTIVE``, only task definition families that do not have any
                ``ACTIVE`` task definition revisions are returned.
                If you paginate the resulting output, be sure to keep the ``status``
...
class ContainerInstanceManager(ReadonlyBoto3ModelManager):
    ...
    def get(
        ...
        *,
        ...
        Returns metadata about each container instance requested.
                Args:
                    containerInstance: The container instance ID or full Amazon Resource
                        Name (ARN) entry for the container instance you
                        want to describe.

                Keyword Args:
                    cluster: The short name or full Amazon Resource Name (ARN) of the
                        cluster that hosts the container instances to
                        describe. If you do not specify a cluster, the default cluster
                        is assumed. This parameter is required if the
                        container instance or container instances you are describing
                        were launched in any cluster other than the default
                        cluster.
                    include: Specifies whether you want to see the resource tags for the
                        container instance. If ``TAGS`` is specified,
                        the tags are included in the response. If
                        ``CONTAINER_INSTANCE_HEALTH`` is specified, the container
                        instance health
                        is included in the response. If this field is omitted, tags and
                        container instance health status aren't included in
                        the response.
        """
        args: dict[str, Any] = dict(
    ...
    def get_many(
        ...
        *,
        ...
        Returns metadata about each container instance requested.
                Args:
                    containerInstances: A list of up to 100 container instance IDs or
    ...
    def list(
        ...
        *,
        ...
        cluster query language statements inside the ``filter`` parameter. For more
        ...
        Keyword Args:
            cluster: The short name or full Amazon Resource Name (ARN) of the cluster
                that hosts the container instances to
                list. If you do not specify a cluster, the default cluster is assumed.
            filter: You can filter the results of a ``ListContainerInstances`` operation
            ...
            status: Filters the container instances by status. For example, if you
                specify the ``DRAINING`` status, the results
                include only container instances that have been set to ``DRAINING``
                ...
                specify this parameter, the The default is to include container
        ...
        *,
        ...
        Args:
            containerInstance: The container instance ID or full ARN of the container
                instance to use when filtering the
                ``ListTasks`` results. Specifying a ``containerInstance`` limits the
                results to tasks that belong to that container
                instance.

        Keyword Args:
            cluster: The short name or full Amazon Resource Name (ARN) of the cluster to
                use when filtering the ``ListTasks``
                results. If you do not specify a cluster, the default cluster is
                assumed.
            ...
            startedBy: The ``startedBy`` value to filter the task results with.
                Specifying a ``startedBy`` value limits the
                results to tasks that were started with that value.
            serviceName: The name of the service to use when filtering the ``ListTasks``
            ...
            desiredStatus: The task desired status to use when filtering the
                ``ListTasks`` results. Specifying a
                ``desiredStatus`` of ``STOPPED`` limits the results to tasks that Amazon
                ECS has set the desired status to
                ``STOPPED``. This can be useful for debugging tasks that aren't starting
                properly or have died or finished. The
                default status filter is ``RUNNING``, which shows tasks that Amazon ECS
                has set the desired status to ``RUNNING``.
            launchType: The launch type to use when filtering the ``ListTasks`` results.
            daemonName: The name of the daemon to use when filtering the ``ListTasks``
                results. Specifying a ``daemonName``
...
class TaskManager(Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            ...
            networkConfiguration: The network configuration for the task. This parameter
                is required for task definitions that
                use the ``awsvpc`` network mode to receive their own elastic network
                interface, and it isn't supported for other
            ...
            placementConstraints: An array of placement constraint objects to use for
                the task. You can specify up to 10
                constraints for each task (including constraints in the task definition
            ...
            propagateTags: Specifies whether to propagate the tags from the task
                definition to the task. If no value is
                specified, the tags aren't propagated. Tags can only be propagated to
                the task during task creation. To add tags to
            ...
            clientToken: An identifier that you provide to ensure the idempotency of the
                request. It must be unique and is case
                sensitive. Up to 64 characters are allowed. The valid characters are
    ...
    def delete(
        ...
        Any tags associated with the task will be deleted.
                ...
                Keyword Args:
                    cluster: The short name or full Amazon Resource Name (ARN) of the
                        cluster that hosts the task to stop. If you do not
                        specify a cluster, the default cluster is assumed.
                    reason: An optional message specified when a task is stopped. For
                        example, if you're using a custom scheduler, you
                        can use this parameter to specify the reason for stopping the
                        task here, and the message appears in subsequent
...
class TaskSetManager(TaskSetManagerMixin, Boto3ModelManager):
    service_name: str = "ecs"

    def create(self, model: "TaskSet", clientToken: "str | None" = None) -> "TaskSet":
        """
    ...
    def get(
        ...
        *,
        ...
        Args:
            cluster: The short name or full Amazon Resource Name (ARN) of the cluster
                that hosts the service that the task sets
                exist in.
            service: The short name or full Amazon Resource Name (ARN) of the service
                that the task sets exist in.
            taskSet: The short name or full Amazon Resource Name (ARN) of the task set
                to describe.

        Keyword Args:
            include: Specifies whether to see the resource tags for the task set. If
                ``TAGS`` is specified, the tags are
                included in the response. If this field is omitted, tags aren't included
                in the response.
        """
        args: dict[str, Any] = dict(
    ...
    def update(self, model: "TaskSet") -> "TaskSet":
        """
        Modifies a task set.

        This is used when a service uses the ``EXTERNAL`` deployment controller type. For more information, see `Amazon ECS Deployment Types <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/deployment-types.html>`_ in
    ...
    def delete(
        ...
        Args:
            ...
            taskSet: The task set ID or full Amazon Resource Name (ARN) of the task set
                to delete.

        Keyword Args:
            force: If ``true``, you can delete a task set even if it hasn't been scaled
                down to zero.
        """
        args: dict[str, Any] = dict(
            cluster=self.serialize(cluster),
...
class ServiceDeploymentManager(ReadonlyBoto3ModelManager):
    ...
    def get(self, serviceDeploymentArn: str) -> "ServiceDeployment | None":
        """
        Describes one or more of your service deployments.

        Args:
            serviceDeploymentArn: The deployment ID or full Amazon Resource Name (ARN)
                entry of the deployment that you want to
                describe.
        """
        args: dict[str, Any] = dict(
    ...
    def list(
        ...
        *,
        ...
        Keyword Args:
            cluster: The cluster that hosts the service. This can either be the cluster
                name or ARN. Starting April 15, 2023,
                Amazon Web Services will not onboard new customers to Amazon Elastic
                Inference (EI), and will help current customers
                migrate their workloads to options that offer better price and
                performance. If you don't specify a cluster,
                ``default`` is used.
            status: An optional filter you can use to narrow the results. If you do not
                specify a status, then all status values
                are included in the result.
            createdAt: An optional filter you can use to narrow the results by the
                service creation date. If you do not specify
                a value, the result includes all services created before the current
                time. The format is yyyy-MM-dd HH:mm:ss.SSSSSS.
            nextToken: The ``nextToken`` value returned from a
                ``ListServiceDeployments`` request indicating that more results
                are available to fulfill the request and further calls are needed. If
                you provided ``maxResults``, it's possible the
                number of results is fewer than ``maxResults``.
            maxResults: The maximum number of service deployment results that
                ``ListServiceDeployments`` returned in paginated
                output. When this parameter is used, ``ListServiceDeployments`` only
                returns ``maxResults`` results in a single page
                ...
                100. If this parameter isn't used, then ``ListServiceDeployments``
    ...
    def stop(
        ...
        *,
        ...
        Args:
            serviceDeploymentArn: The ARN of the service deployment that you want to
                stop.
...
class ServiceRevisionManager(ServiceRevisionManagerMixin, ReadonlyBoto3ModelManager):
    service_name: str = "ecs"

    def get(self, serviceRevisionArn: str) -> "ServiceRevision | None":
        """
        Describes one or more service revisions.

        Args:
            serviceRevisionArn: The full Amazon Resource Name (ARN) of the service
...
class DaemonManager(DaemonManagerMixin, Boto3ModelManager):
    service_name: str = "ecs"

    def get(self, daemonArn: str) -> "Daemon | None":
        """
...
class DaemonTaskDefinitionManager(DaemonTaskDefinitionManagerMixin, Boto3ModelManager):
    service_name: str = "ecs"

    def get(self, daemonTaskDefinition: str) -> "DaemonTaskDefinition | None":
        """
        Describes a daemon task definition.

        You can specify a ``family`` and ``revision`` to find information about a
        specific daemon task definition, or you can simply specify the family to find
...
class DaemonRevisionManager(ReadonlyBoto3ModelManager):
    service_name: str = "ecs"

    def get(self, daemonRevisionArn: str) -> "DaemonRevision | None":
        """
        Describes one or more of your daemon revisions.

        Args:
            daemonRevisionArn: The full Amazon Resource Name (ARN) of the daemon
                revision to describe.
        """
        args: dict[str, Any] = dict(
    ...
    def get_many(
        ...
        Args:
            daemonRevisionArns: The ARN of the daemon revisions to describe. You can
                specify up to 20 ARNs.
        """
        args: dict[str, Any] = dict(
...
class DaemonDeploymentManager(DaemonDeploymentManagerMixin, ReadonlyBoto3ModelManager):
    service_name: str = "ecs"


class ExpressGatewayServiceManager(
    ...
    def create(
        ...
        Args:
            ...
            executionRoleArn: The Amazon Resource Name (ARN) of the task execution role
                that grants the Amazon ECS container
                agent permission to make Amazon Web Services API calls on your behalf.
                This role is required for Amazon ECS to pull
                container images from Amazon ECR, send container logs to Amazon
                CloudWatch Logs, and retrieve sensitive data from
                Amazon Web Services Systems Manager Parameter Store or Amazon Web
                Services Secrets Manager.
            primaryContainer: The primary container configuration for the Express
                service. This defines the main application
                container that will receive traffic from the Application Load Balancer.

        Keyword Args:
            healthCheckPath: The path on the container that the Application Load
                Balancer uses for health checks. This should be
                a valid HTTP endpoint that returns a successful response (HTTP 200) when
                the application is healthy.
            taskRoleArn: The Amazon Resource Name (ARN) of the IAM role that containers
                in this task can assume. This role
                allows your application code to access other Amazon Web Services
                services securely.
            networkConfiguration: The network configuration for the Express service
                tasks. This specifies the VPC subnets and
                security groups for the tasks.
            cpu: The number of CPU units used by the task. This parameter determines the
                CPU allocation for each task in the
                Express service. The default value for an Express service is 256 (.25
                vCPU).
            memory: The amount of memory (in MiB) used by the task. This parameter
                determines the memory allocation for each
                task in the Express service. The default value for an express service is
                512 MiB.
            scalingTarget: The auto-scaling configuration for the Express service. This
                defines how the service automatically
    ...
    def get(
        ...
        *,
        ...
        Args:
            serviceArn: The full Amazon Resource Name (ARN) of the Express gateway
                service to describe.

        Keyword Args:
            include: Specifies additional information to include in the response. Valid
                values are ``TAGS`` to include resource
    ...
    def delete(self, serviceArn: str) -> "ExpressGatewayService":
        """
        ...
        Args:
            serviceArn: The Amazon Resource Name (ARN) of the Express service to delete.
                The ARN uniquely identifies the service
...
class ECSTag(Boto3Model):
    ...
    * If your tagging schema is used across multiple services and resources, remember
    that other services may have
      restrictions on allowed characters. Generally allowed characters are: letters,
          numbers, and spaces representable in
      UTF-8, and the following characters: + - = . _ : / @.
    * Tag keys and values are case-sensitive.
    * Do not use ``aws:``, ``AWS:``, or any upper or lowercase combination of such as a
    prefix for either keys or values as
      it is reserved for Amazon Web Services use. You cannot edit or delete tag keys or
      values with this prefix. Tags with
...
class ManagedScaling(Boto3Model):
    """
    The managed scaling settings for the Auto Scaling group capacity provider.

    When managed scaling is turned on, Amazon ECS manages the scale-in and scale-out
    actions of the Auto Scaling group.
    Amazon ECS manages a target tracking scaling policy using an Amazon ECS managed
    CloudWatch metric with the specified
    ...
    that means the utilization is 90%, so use a ``targetCapacity`` of ``90``. The
    default value of ``100`` percent results in the Amazon EC2 instances in your Auto
...
class AutoScalingGroupProvider(Boto3Model):
    """
    ...
    """
class ManagedInstancesNetworkConfiguration(Boto3Model):
    """
    The network configuration for Amazon ECS Managed Instances.

    This specifies the VPC subnets and security groups that instances use for network
    connectivity. Amazon ECS Managed Instances support multiple network modes including
    ``awsvpc`` (instances receive ENIs for task isolation), ``host`` (instances share
    network namespace with tasks), and ``none`` (no external network connectivity),
    ensuring backward compatibility for migrating workloads from Fargate or Amazon EC2.
    """
    ...
    """
class ManagedInstancesStorageConfiguration(Boto3Model):
    """
    ...
    """
class ManagedInstancesLocalStorageConfiguration(Boto3Model):
    """
    ...
    EBS volumes are not provisioned for data storage. If the container instance has
    multiple instance store volumes, a single data volume is created. Consider defining
    instance store requirements using the ``localStorage``, ``localStorageTypes`` and
    ``totalLocalStorageGB`` properties.
    """
class ECSVCpuCountRangeRequest(Boto3Model):
    """
...
class ECSMemoryMiBRequest(Boto3Model):
    """
...
class ECSMemoryGiBPerVCpuRequest(Boto3Model):
    """
...
class ECSNetworkInterfaceCountRequest(Boto3Model):
    """
...
class ECSTotalLocalStorageGBRequest(Boto3Model):
    """
...
class ECSBaselineEbsBandwidthMbpsRequest(Boto3Model):
    """
...
class ECSAcceleratorCountRequest(Boto3Model):
    """
...
class ECSAcceleratorTotalMemoryMiBRequest(Boto3Model):
    """
    ...
    """
class ECSNetworkBandwidthGbpsRequest(Boto3Model):
    """
...
class ECSInstanceRequirementsRequest(Boto3Model):
    """
    ...
    You can specify ``intel``, ``amd``, or ``amazon-web-services`` to control which CPU
    types are used for your workloads.
    """
    ...
    Set to ``included`` to allow bare metal instances, ``excluded`` to exclude them, or
    ...
    Set to ``included`` to allow burstable instances, ``excluded`` to exclude them, or
    ``required`` to use only burstable instances.
    """
    ...
    Set to ``included`` to allow local storage, ``excluded`` to exclude it, or
    ...
    You can specify ``gpu`` for graphics processing units, ``fpga`` for field
    programmable gate arrays, or ``inference`` for machine learning inference
    accelerators.
    """
...
class CapacityReservationRequest(Boto3Model):
    """
...
class InstanceLaunchTemplate(Boto3Model):
    """
    ...
    By default, your managed instance is configured for basic monitoring. You can
    optionally enable detailed monitoring to help you more quickly identify and act on
    operational issues. You can enable or turn off detailed monitoring at launch or when
    the managed instance is running or stopped. For more information, see
    `Detailed monitoring for Amazon ECS Managed Instances <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/detailed-monitoring-managed-instances.html>`_
    in
    ...
    If ``true``, instances use FIPS-compliant cryptographic algorithms and modules for
    enhanced security compliance. If ``false``, instances use standard cryptographic
    implementations.
    """
...
class InfrastructureOptimization(Boto3Model):
    """
...
class AutoRepairConfiguration(Boto3Model):
    """
    ...
    When set to ``ENABLED``, Amazon ECS automatically replaces container instances with
    an ``IMPAIRED`` health status. When set to ``DISABLED``, Amazon ECS still monitors
    container instance health but does not automatically replace impaired instances.
    """

class ManagedInstancesProvider(Boto3Model):
    """
...
class CapacityProvider(TagsDictMixin, PrimaryBoto3Model):
    """
    The details for a capacity provider.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = ECSTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = CapacityProviderManager
    ...
    Only capacity providers in an ``ACTIVE`` state can be used in a cluster. When a
    capacity provider is successfully deleted, it has an ``INACTIVE`` status.
    """
    ...
    For Amazon ECS Managed Instances, this value is ``MANAGED_INSTANCES``, indicating
    that Amazon ECS manages the underlying Amazon EC2 instances on your behalf.
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`capacityProviderArn` attribute.
...
class AdvancedConfiguration(Boto3Model):
    ...
    traffic shifting during blue/green deployments. For more information, see `Required
    resources for Amazon ECS blue/green deployments <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/blue-green-
    deployment-implementation.html>`_ in the *Amazon Elastic Container Service Developer
    Guide*.
    """
...
class LoadBalancerConfiguration(Boto3Model):
    ...
    new deployment with the updated
    Elastic Load Balancing configuration. This causes tasks to register to and
...
class CapacityProviderStrategyItem(Boto3Model):
    ...
    A capacity provider strategy can be set when using the `RunTask <https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_RunTask.html>`_or
    ...
    ``ACTIVE`` or ``UPDATING`` status can be
    used in a capacity provider strategy. The `PutClusterCapacityProviders <https://docs.aws.amazon.com/AmazonECS/latest/API
    Reference/API_PutClusterCapacityProviders.html>`_ API is used to associate a
    capacity provider with a cluster.

    If specifying a capacity provider that uses an Auto Scaling group, the capacity
    provider must already be created. New
    Auto Scaling group capacity providers can be created with the `CreateClusterCapacityProvider <https://docs.aws.amazon.co
    m/AmazonECS/latest/APIReference/API_CreateClusterCapacityProvider.html>`_ API
    operation.

    To use a Fargate capacity provider, specify either the ``FARGATE`` or
    ``FARGATE_SPOT`` capacity providers. The Fargate
    capacity providers are available to all accounts and only need to be associated with
    a cluster to be used in a capacity
    provider strategy.

    With ``FARGATE_SPOT``, you can run interruption tolerant tasks at a rate that's
    discounted compared to the ``FARGATE``
    price. ``FARGATE_SPOT`` runs tasks on spare compute capacity. When Amazon Web
    Services needs the capacity back, your
    tasks are interrupted with a two-minute warning. ``FARGATE_SPOT`` supports Linux
    tasks with the X86_64 architecture on
    platform version 1.3.0 or later. ``FARGATE_SPOT`` supports Linux tasks with the
    ARM64 architecture on platform version
    1.4.0 or later.
    ...
    The ``weight`` value is taken into consideration after the ``base`` value, if
    ...
    Only one capacity provider in a capacity provider strategy can have a *base*
...
class DeploymentAlarms(Boto3Model):
    ...
    `Rolling update <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/deployment-type-
...
class HookDetails(Boto3Model):
    pass
class DeploymentLifecycleHookTimeoutConfiguration(Boto3Model):
    """
    The timeout configuration for a deployment lifecycle hook.

    This determines how long Amazon ECS waits for the hook to complete before taking the
    specified timeout action.
    """

    timeoutInMinutes: "int | None" = None
    """
    The number of minutes Amazon ECS waits for the lifecycle hook to complete before
    taking the timeout action.
    """

    action: "Literal['ROLLBACK', 'CONTINUE'] | None" = None
    """
...
class DeploymentLifecycleHook(Boto3Model):
    ...
    *Amazon Elastic Container Service Developer Guide*.
    ...
    targetType: "Literal['AWS_LAMBDA', 'PAUSE'] | None" = None
    """
    ...
    lifecycleStages: "builtins.list[Literal['RECONCILE_SERVICE', 'PRE_SCALE_UP', 'POST_SCALE_UP', 'TEST_TRAFFIC_SHIFT', 'POST_TEST_TRAFFIC_SHIFT', 'PRE_PRODUCTION_TRAFFIC_SHIFT', 'PRODUCTION_TRAFFIC_SHIFT', 'POST_PRODUCTION_TRAFFIC_SHIFT']] | None" = Field(
        default_factory=list
    )
    """
    ...
    timeoutConfiguration: "DeploymentLifecycleHookTimeoutConfiguration | None" = None
    """
    The timeout configuration for the lifecycle hook.

    This specifies how long Amazon ECS waits before taking the timeout action if the
    hook is not resolved.
    """
...
class DeploymentConfiguration(Boto3Model):
    ...
    service is using the ``REPLICA`` service scheduler and has a ``desiredCount`` of
    four tasks and a ``maximumPercent`` value of 200%, the scheduler may start four new
    tasks before stopping the four older tasks (provided that the cluster resources
    required to do this are available). The default ``maximumPercent`` value for a
    service using the ``REPLICA`` service scheduler is 200%.
    """
    ...
    Only valid when the deployment strategy is ``LINEAR``. This configuration enables
    progressive traffic shifting in equal percentage increments with configurable bake
    ...
    Only valid when the deployment strategy is ``CANARY``. This configuration enables
    shifting a fixed percentage of traffic for testing, followed by shifting the
...
class TaskSet(TagsDictMixin, PrimaryBoto3Model):
    """
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = ECSTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = TaskSetManager
    ...
    If an CodeDeploy deployment created the task set, the ``startedBy`` parameter is
    ``CODE_DEPLOY``. If an external deployment created the task set, the ``startedBy``
    field isn't used.
    """
    ...
    This is calculated by multiplying the service's ``desiredCount`` by the task set's
    ``scale`` percentage. The result is always rounded up. For example, if the computed
    ...
    set enters the ``PENDING`` status when it launches for the first time or when it's
    ...
    This indicates whether the task set has reached a steady state. If the following
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`taskSetArn` attribute.
...
class ServiceConnectTestTrafficHeaderRules(Boto3Model):
    ...
    These rules specify which HTTP headers to examine and what values to match for
    routing decisions.
    ...
    *Amazon Elastic Container Service Developer Guide*.
    ...
    Common examples include custom headers like ``X-Test- Version`` or ``X-Canary-
    Request`` that can be used to identify test traffic.
    """
...
class ServiceConnectTestTrafficRules(Boto3Model):
    ...
    This configuration allows you to define rules for routing specific traffic to the
    new service revision during the deployment process, allowing for safe testing
    before full production traffic shift.
...
class TimeoutConfiguration(Boto3Model):
    ...
    A value of ``0`` can be set to disable ``perRequestTimeout``. ``perRequestTimeout``
...
class ServiceConnectService(Boto3Model):
    ...
    configuration.
    """
class ECSContainerDefinitionSecret(Boto3Model):
    """
...
class LogConfiguration(Boto3Model):
    ...
    However, the container might use a
    ...
    * Amazon ECS currently supports a subset of the logging drivers available to the
    Docker daemon. Additional log drivers
    ...
    * For tasks that are hosted on Amazon EC2 instances, the Amazon ECS container agent
    must register the available logging
      drivers with the ``ECS_AVAILABLE_LOGGING_DRIVERS`` environment variable before
      containers placed on that instance can
      use these log configuration options. For more information, see `Amazon ECS
      container agent
    ...
    * For tasks that are on Fargate, because you don't have access to the underlying
    infrastructure your tasks are hosted
      on, any additional software needed must be installed outside of the task. For
      example, the Fluentd output aggregators or
...
class ServiceConnectAccessLogConfiguration(Boto3Model):
    ...
    Access logs provide detailed information about requests made to your service,
    including request patterns, response codes, and timing data for debugging and
    monitoring purposes.
...
class ServiceConnectServiceResource(Boto3Model):
    ...
    Each configuration maps a discovery name to a Cloud Map service name. The data is
    stored in Cloud Map as part of the Service Connect configuration for each discovery
    name of this Amazon ECS service.
...
class EBSTagSpecification(TagsDictMixin, Boto3Model):
    ...
    Tags can only propagate to a
    ``SERVICE`` specified in ``ServiceVolumeConfiguration``. If no value is specified,
...
class ServiceManagedEBSVolumeConfiguration(Boto3Model):
    ...
    for each task in the service. For information about the supported launch types and
    operating systems, see
    `Supported operating systems and launch types <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ebs-volumes.html#ebs-volumes-configuration>`_
    in the
    *Amazon Elastic Container Service Developer Guide*.
    ...
    If you turn on Region-level Amazon EBS encryption by default but set this value as
    ``false``, the setting is overridden and the volume is encrypted with the KMS key
    specified for Amazon EBS encryption by default. This parameter maps 1:1 with the
    ``Encrypted`` parameter of the
    `CreateVolume API <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html>`_
    ...
    When a key is specified using this parameter, it overrides Amazon EBS default
    encryption or any KMS key that you specified for cluster-level managed storage
    encryption. This parameter maps 1:1 with the ``KmsKeyId`` parameter of the
    `CreateVolume API <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html>`_
    in the *Amazon EC2    API Reference*. For more information about encrypting Amazon
    EBS volumes attached to tasks, see
    `Encrypt data stored in Amazon EBS volumes attached to Amazon ECS tasks <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ebs-kms-
    encryption.html>`_.
    """
    ...
    You must specify either a volume size or a snapshot ID. If you specify a snapshot
    ID, the snapshot size is used for the volume size by default. You can optionally
    specify a volume size greater than or equal to the snapshot size. This parameter
    maps 1:1 with the ``Size`` parameter of the
    `CreateVolume API <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateVolume.html>`_
    in the *Amazon EC2 API Reference*.
    """
    ...
    You must specify either ``snapshotId`` or ``sizeInGiB`` in your volume
    ...
    *Amazon EC2 API Reference*.
    ...
    This property can be specified only if you specify a ``snapshotId``. For more
    information, see
    ...
    This is the Amazon ECS infrastructure IAM role that is used to manage your Amazon
    ...
    information, see
    `Amazon ECS infrastructure IAM role <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/infrastructure_IAM_role.html>`_
    in
    the *Amazon ECS Developer Guide*.
    """
...
class Deployment(ReadonlyBoto3Model):
    ...
    This is used only when a service uses the ``ECS`` deployment controller type.
    """
    ...
    A task is considered a failure if the service scheduler can't launch the task, the
    task doesn't transition to a ``RUNNING`` state, or if it fails any of its defined
    ...
    A platform version is only specified for tasks using the Fargate launch type. If one
...
``awsvpc`` networking mode.
    ...
    You can configure different settings like the size, throughput, volumeType, and ecryption in `ServiceManagedEBSVolumeConfiguration <https://docs.aws.amazon.com/AmazonECS/la
    test/APIReference/API_ServiceManagedEBSVolumeConfiguration.html>`_. The ``name`` of
...
class PlacementConstraint(Boto3Model):
    ...
    Use ``distinctInstance`` to ensure that each task in a particular group is running
    on a different container instance. Use ``memberOf`` to restrict the selection to a
...
class PlacementStrategy(Boto3Model):
    ...
    candidates that have the least available amount of the resource that's specified
    with the ``field`` parameter. For example, if you binpack on memory, a task is
    placed on the instance with the least amount of remaining memory but still enough to
    run the task.
    """
...
class Service(TagsDictMixin, ECSServiceModelMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = ECSTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ServiceManager
    ...
    This value is specified when the service is created with
    `CreateService <https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_CreateService.html>`_ , and it can be
    modified with `UpdateService <https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_UpdateService.html>`_.
    """
    ...
    For more information about the ARN format, see `Amazon Resource Name (ARN) <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-account-settings.html#ecs-resource-ids>`_ in the
    *Amazon ECS Developer Guide*.
    ...
    A platform version is only specified for tasks that are hosted on Fargate. If one
    isn't specified, the ``LATEST`` platform version is used. For more information, see
    `Fargate Platform Versions <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html>`_
    in the *Amazon Elastic
    Container Service Developer Guide*.
...
``awsvpc`` networking mode.
    ...
    If ``true``, the execute command functionality is turned on for all containers in
    ...
    def arn(self) -> str | None:
        ...
        This is the value of the :py:attr:`serviceArn` attribute.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`serviceName` attribute.
    ...
    def pk(self) -> OrderedDict[str, Any]:
        ...
        This can be used to get the service with the
        :py:meth:`botocraft.services.ecs.ServiceManager.get` method, or to do
...
class ClusterSetting(Boto3Model):
    ...
    This parameter is used to turn on CloudWatch Container Insights with enhanced
    observability or CloudWatch Container Insights for a cluster.
...
class Attachment(Boto3Model):
    ...
    Valid values are ``PRECREATED``, ``CREATED``, ``ATTACHING``, ``ATTACHED``,
...
class ClusterServiceConnectDefaults(Boto3Model):
    ...
    After you set a default Service Connect namespace, any new services with Service
    Connect turned on that are created in the cluster are added as client services in
...
class Cluster(TagsDictMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = ECSTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ClusterManager
    clusterName: str
    """
    ...
    For more information about the ARN format, see `Amazon Resource Name (ARN) <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-account-settings.html#ecs-resource-
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`clusterArn` attribute.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`clusterName` attribute.
...
class PortMapping(Boto3Model):
    ...
    ``host``, host ports must either be undefined or match the container port in the
    port mapping.
    ...
    port assignments are visible in the ``networkBindings`` section of
    `DescribeTasks <https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_DescribeTasks.html>`_
    API responses.
    """
    ...
    This parameter is the name that you use in the ``serviceConnectConfiguration`` and
    the ``vpcLatticeConfigurations`` of a service. The name can include up to 64
...
class ContainerRestartPolicy(Boto3Model):
    ...
    A container can be restarted only once every ``restartAttemptPeriod`` seconds. If a
    container isn't able to run for this time period and exits early, it will not be
    restarted. You can set a minimum ``restartAttemptPeriod`` of 60 seconds and a
    maximum ``restartAttemptPeriod`` of 1800 seconds. By default, a container must run
...
class EnvironmentFile(Boto3Model):
    ...
    a container definition, they take
    precedence over the variables contained within an environment file. If multiple
    environment files are specified that
    contain the same variable, they're processed from the top down. We recommend that
    you use unique variable names. For
...
class KernelCapabilities(Boto3Model):
    ...
    parameters. For information about the latest behavior, see `Docker Compose: order of
        cap_drop and
    ...
    * The default is to first drop the capabilities specified in the ``drop`` request
    ...
    This parameter maps to ``CapAdd`` in the docker container create command and the
...
class Device(Boto3Model):
    ...
    By default, the container has permissions for ``read``, ``write``, and ``mknod`` for
    the device.
    """
...
class LinuxParameters(Boto3Model):
    ...
    This parameter maps to ``Devices`` in the docker container create command and the
    ...
    This parameter maps to the ``--init`` option to docker run. This parameter requires
    ...
    instance, log in to your container instance
    ...
    value is not specified for ``maxSwap`` then this parameter is ignored. This
...
class ContainerDependency(Boto3Model):
    ...
    agent to use container
    dependencies. However, we recommend using the latest container agent version. For
    information about checking your agent
    ...
    Container Service Developer Guide*. If you're using an Amazon ECS-optimized Linux
    AMI, your instance needs at least
    version 1.26.0-1 of the ``ecs-init`` package. If your container instances are
    launched from version ``20190301`` or
    ...
    * Windows platform version ``1.0.0`` or later.
    ...
    AmazonECS/latest/developerguide/example_task_definitions.html#example_task_definition-containerdependency>`_
    in the
    *Amazon Elastic Container Service Developer Guide*.
    """
...
class Ulimit(Boto3Model):
    ...
    Fargate overrides. The ``nofile`` resource limit sets a restriction on the number of
    open files that a container can use. The default ``nofile`` soft limit is  ``65535``
...
class HealthCheck(Boto3Model):
    ...
    Docker health checks that exist in the container image (such as those specified in a
    parent image or from
    ...
    * ``UNKNOWN``-The container health check is being evaluated, there's no container
    health check defined, or Amazon ECS
    ...
    health checker status of essential
    ...
    * If Container1 is ``UNHEALTHY`` and Container2 is ``UNKNOWN``, and Container3 is
    ``UNKNOWN``, the task health is
      ``UNHEALTHY``.
    * If Container1 is ``UNHEALTHY`` and Container2 is ``UNKNOWN``, and Container3 is
    ``HEALTHY``, the task health is
      ``UNHEALTHY``.
    ...
    * If Container1 is ``HEALTHY`` and Container2 is ``HEALTHY``, and Container3 is
    ...
    lifecycle regardless of its health
    status. For tasks that are part of a service, if the task reports as unhealthy then
    the task will be stopped and the
    ...
    2. The unhealthy task will be stopped, and during the stopping process, it will go
    through the following states:

    * ``DEACTIVATING`` - In this state, Amazon ECS performs additional steps before
    stopping the task. For example, for
      tasks that are part of services configured to use Elastic Load Balancing target
      groups, target groups will be
    ...
    * ``STOPPED`` - The task has been completely stopped.
    ...
    operation, and the new task will go through
    ...
    * ``ACTIVATING`` - In this state, Amazon ECS pulls container images, creates
    containers, configures task networking,
    ...
    * If the Amazon ECS container agent becomes disconnected from the Amazon ECS
    service, this won't cause a container to
      transition to an ``UNHEALTHY`` status. This is by design, to ensure that
      containers remain running during agent restarts
      or temporary unavailability. The health check status is the "last heard from"
      response from the Amazon ECS agent, so if
      the container was considered ``HEALTHY`` prior to the disconnect, that status will
      remain until the agent reconnects and
      another health check occurs. There are no assumptions made about the status of the
      container health checks.
    * Container health checks require version ``1.17.0`` or greater of the Amazon ECS
    container agent. For more information,
    ...
    * Container health checks aren't supported for tasks that are part of a service
    ...
    You may specify between 5 and 300 seconds. The default value is 30 seconds. This
    ...
    You may specify between 2 and 60 seconds. The default value is 5. This value applies
    ...
    You may specify between 1 and 10 retries. The default value is 3. This value applies
    only when you specify a ``command``.
    """
...
class SystemControl(Boto3Model):
    ...
    This parameter maps to ``Sysctls`` in the docker container create command and the
    ...
    for multiple containers in a single
    task that also uses either the ``awsvpc`` or ``host`` network mode. Doing this has
    the following disadvantages:

    * For tasks that use the ``awsvpc`` network mode including Fargate, if you set
    ``systemControls`` for any container, it
      applies to all containers in the task. If you set different ``systemControls`` for
      multiple containers in a single task,
    ...
    * For tasks that use the ``task`` IPC mode, IPC namespace ``systemControls`` values
    apply to all containers within a
      task.
    ...
    are using platform version ``1.4.0``
...
class FirelensConfiguration(Boto3Model):
    ...
    This field is optional and can be used to specify a custom configuration file or to
    add additional metadata, such as the task, task definition, cluster, and container
    instance
    details to the log event. If specified, the syntax to use is
    ``"options":{"enable-ecs-log-
...
class ContainerDefinition(Boto3Model):
    ...
    hyphens are allowed. This parameter maps to ``name`` in the docker container create
    command and the ``--name`` option to docker run.
    """
    image: str
    """
    ...
    Docker Hub registry are available. Other repositories are specified with either
    ``repository-url/image:tag``  or
    ``repository-url/image@digest`` . For images using tags (repository-url/image:tag),
    up to 255 characters total are
    allowed, including letters (uppercase and lowercase), numbers, hyphens, underscores,
    colons, periods, forward slashes,
    and number signs (#). For images using digests (repository-url/image@digest), the
    255 character limit applies only to
    the repository URL and image name (everything before the @ sign). The only supported
    hash function is sha256, and the
    hash value after sha256: must be exactly 64 characters (only letters A-F, a-f, and
        numbers 0-9 are allowed). This
    parameter maps to ``Image`` in the docker container create command and the ``IMAGE``
    ...
    This parameter maps to ``CpuShares`` in the docker container create command and the
    ...
    ``Memory`` in the docker container create command and the ``--memory`` option to
    docker run.
    """
    ...
    This parameter is only supported if the network mode of a task definition is
    ``bridge``. The ``name:internalName`` construct is analogous to ``name:alias`` in
    Docker links. Up to 255 letters (uppercase and lowercase), numbers, underscores, and
    hyphens are allowed.. This parameter maps to ``Links`` in the docker container
    create command and the ``--link`` option to docker run.
    """
    ...
    *Amazon Elastic Container Service Developer Guide*.
    ...
    This parameter maps to ``Cmd`` in the docker container create command and the
    ``COMMAND`` parameter to docker run. If there are multiple arguments, each argument
    ...
    This parameter maps to ``Env`` in the docker container create command and the
    ...
    This parameter maps to ``VolumesFrom`` in the docker container create command and
    ...
    a dependency on containerB reaching a ``COMPLETE``, ``SUCCESS``, or ``HEALTHY``
    status. If a ``startTimeout`` value is specified for containerB and it doesn't reach
    the desired status within that time then containerA gives up and not start. This
    ...
    By default, the value is ``enabled``. If you set the value for a container as
    ``disabled``, Amazon ECS will not resolve the provided container image tag to a
    digest and will use the original image URI specified in the container definition for
    deployment. For more information about container image resolution, see
    ...
    ``ReadonlyRootfs`` in the docker container create command and the ``--read-only``
    ...
    This parameter maps to ``Dns`` in the docker container create command and the
    ...
    This parameter maps to ``Tty`` in the docker container create command and the
    ...
    This parameter maps to ``Labels`` in the docker container create command and the
    ``--label`` option to docker run. This parameter requires version 1.18 of the Docker
    Remote API or
    greater on your container instance. To check the Docker Remote API version on your
    container instance, log in to your
    ...
    If a ``ulimit`` value is specified in a task definition, it overrides the default
    values set by Docker. This parameter maps to ``Ulimits`` in the docker container
    create command and the ``--ulimit`` option to docker run. Valid naming values are
    displayed in the
    `Ulimit <https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_Ulimit.html>`_
    data type.
    """
    ...
    This parameter maps to
    ``HealthCheck`` in the docker container create command and the ``HEALTHCHECK``
    parameter of docker run.
    """
...
class Attribute(Boto3Model):
    ...
    (uppercase and lowercase), numbers, hyphens (-), underscores (_), forward slashes
    ...
    The ``value`` must contain between 1 and 128 characters. It can contain letters
    (uppercase and lowercase), numbers, hyphens (-), underscores (_), periods (.), at
    signs (@), forward slashes (/), back slashes (), colons (:), or spaces. The value
...
class ECSProxyConfiguration(Boto3Model):
    """
    The configuration details for the App Mesh proxy.

    For tasks that use the EC2 launch type, the container instances require at least
    version 1.26.0 of the container agent and at least version 1.26.0-1 of the ``ecs-
    init`` package to use a proxy configuration. If your container instances are
    ...
    <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-optimized_AMI.html>`_
    """
...
class EphemeralStorage(Boto3Model):
    ...
    beyond the default amount, for tasks hosted on Fargate. For more information, see
    `Using data volumes
...
class TaskDefinition(TagsDictMixin, TaskDefinitionModelMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = ECSTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = TaskDefinitionManager
    ...
    The valid values are ``none``, ``bridge``, ``awsvpc``, and ``host``. If no network
    ...
    *Amazon Elastic Container Service Developer Guide*.
    ...
    The revision is a version number of a task definition in a family. When you register
    a task definition for the first time, the revision is ``1``. Each time that you
    register a new revision of a task definition in the same family, the revision value
    always increases by one. This is even if you deregistered previous revisions in this
    family.
    """
    ...
    The valid values are ``MANAGED_INSTANCES``, ``EC2``, ``FARGATE``, and ``EXTERNAL``.
    For more information, see
    `Amazon ECS launch types <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_types.html>`_
    in the *Amazon Elastic Container
    Service Developer Guide*.
    ...
    If you use the EC2 launch type, this field is optional. Any value can be used. If
    you use the Fargate launch type, this field is required. You must use one of the
    following values. The value that you choose determines your range of valid values
    ...
    The valid values are ``host`` or ``task``. On Fargate for Linux containers, the only
    valid value is ``task``. For example, monitoring sidecars might need ``pidMode`` to
    ...
    The valid values are ``host``, ``task``, or ``none``. If ``host`` is specified, then
    all containers within the tasks that specified the ``host`` IPC mode on the same
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`taskDefinitionArn` attribute.
    ...
    def deregister(self) -> "TaskDefinition":
        ...
        task definition can still scale up or down by modifying the service's desired
...
class Container(Boto3Model):
    ...
    The value is ``0`` if no value was specified in the container definition when the
...
class ContainerOverride(Boto3Model):
    ...
    to store the sensitive data. For more
...
class TaskEphemeralStorage(Boto3Model):
    ...
    The minimum supported value is ``20`` GiB and the maximum supported value is ``200``
    GiB.
    """
...
class Task(TagsDictMixin, ECSTaskModelMixin, PrimaryBoto3Model):
    """
    Details on a task in a cluster.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = ECSTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = TaskManager
    ...
    A platform version is only specified for tasks that use the Fargate launch type. If
    you didn't specify one, the ``LATEST`` platform version is used. For more
    information, see
    `Fargate Platform Versions <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html>`_
    in the *Amazon Elastic
    Container Service Developer Guide*.
    ...
    If ``true``, execute command functionality is turned on all the containers in the
    task.
    """
    ...
    It's determined by the health of the essential containers in the task. If all
    essential containers in the task are reporting as ``HEALTHY``, the task status also
    ...
    expressed as a string using GB (for example, ``1GB`` or ``1 GB``), it's converted to
    ...
    If an Amazon ECS service started the task, the ``startedBy`` parameter contains the
    ...
    counter is incremented. If you replicate your Amazon ECS task state with CloudWatch
    Events, you can compare the version of a task reported by the Amazon ECS API actions
...
class ContainerInstance(
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = ECSTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ContainerInstanceManager
    ...
    Every time a container instance experiences a change that triggers a CloudWatch
    event, the version counter is incremented. If you're replicating your Amazon ECS
    container instance state with CloudWatch Events, you can compare the version of a
    container instance reported by the Amazon ECS APIs with the version reported in
    CloudWatch Events for the container instance (inside the ``detail`` object) to
    ...
    the Amazon ECS container agent (at instance registration time) and any task
    containers that have reserved port mappings on the host (with the ``host`` or
    ``bridge`` network mode). Any port that's not specified here is available for new
    tasks.
    """
    ...
    An instance with an agent that may be unhealthy or stopped return ``false``. Only
...
operation.
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`containerInstanceArn` attribute.
...
class ContainerImage(Boto3Model):
    """
...
class ServiceRevisionLoadBalancer(Boto3Model):
    """
    ...
    """
class ResolvedConfiguration(Boto3Model):
    """
...
class ManagedLoadBalancer(Boto3Model):
    """
    ...
    """
class ManagedSecurityGroup(Boto3Model):
    """
...
class ManagedCertificate(Boto3Model):
    """
    ...
    """
class ManagedListener(Boto3Model):
    """
    ...
    """
class ManagedListenerRule(Boto3Model):
    """
...
class ManagedTargetGroup(Boto3Model):
    """
...
class ManagedIngressPath(Boto3Model):
    """
    ...
    """
class ManagedScalableTarget(Boto3Model):
    """
    ...
    """
class ManagedApplicationAutoScalingPolicy(Boto3Model):
    """
    ...
    """
class ManagedAutoScaling(Boto3Model):
    """
...
class ManagedMetricAlarm(Boto3Model):
    """
...
class ManagedLogGroup(Boto3Model):
    """
...
class ECSManagedResources(Boto3Model):
    """
...
class ServiceRevision(ReadonlyPrimaryBoto3Model):
    """
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ServiceRevisionManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`serviceRevisionArn` attribute.
...
class DeploymentLifecycleHookDetail(Boto3Model):
    """
    The details of a deployment lifecycle hook that is active during a service
    deployment.

    You can view lifecycle hook details by calling `DescribeServiceDeployments <https://docs.aws.amazon.com/AmazonECS/latest
    /APIReference/API_DescribeServiceDeployments.html>`_.
    """
    ...
    Use this value when calling ``ContinueServiceDeployment`` to continue or roll back a
    paused deployment.
    """
    ...
    For ``AWS_LAMBDA`` hooks, this is the Lambda function ARN. For ``PAUSE`` hooks, this
    field is not set.
    """

    status: "Literal['AWAITING_ACTION', 'IN_PROGRESS', 'SUCCEEDED', 'FAILED', 'TIMED_OUT'] | None" = None
    """
    The status of the lifecycle hook.

    Valid values depend on the hook type:
    """
    ...
    If the hook has not been completed by this time, Amazon ECS takes the timeout
    action.
    """

    timeoutAction: "Literal['ROLLBACK', 'CONTINUE'] | None" = None
    """
    The action Amazon ECS takes when the lifecycle hook times out.

    Valid values are ``CONTINUE`` and ``ROLLBACK``.
    """
...
class ServiceDeploymentCircuitBreaker(Boto3Model):
    ...
    Amazon ECS is not using the circuit breaker for service deployment failures when the
    status is ``DISABLED``.
    """
...
class ServiceDeploymentAlarms(Boto3Model):
    ...
    `How CloudWatch alarms detect Amazon ECS deployment failures <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/deployment-alarm-failure.html>`_
    in the Amazon ECS
    Developer Guide.
    """
...
class ServiceDeployment(ReadonlyPrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ServiceDeploymentManager
    ...
    lifecycleHookDetails: "builtins.list[DeploymentLifecycleHookDetail] | None" = Field(
        default_factory=list
    )
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`serviceDeploymentArn` attribute.
...
class DaemonCapacityProvider(Boto3Model):
    """
...
class DaemonRevisionDetail(Boto3Model):
    """
...
class Daemon(TagsDictMixin, PrimaryBoto3Model):
    """
    The detailed information about a daemon.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = ECSTag | None
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = DaemonManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`daemonArn` attribute.
...
class DaemonLinuxParameters(Boto3Model):
    """
...
class DaemonContainerDefinition(Boto3Model):
    """
    ...
    registry are available by default. Other repositories are specified with either
...
class DaemonTaskDefinition(TagsDictMixin, PrimaryBoto3Model):
    """
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = ECSTag | None
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = DaemonTaskDefinitionManager
    ...
    The revision is a version number of a daemon task definition in a family. When you
    register a daemon task definition for the first time, the revision is ``1``. Each
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`daemonTaskDefinitionArn` attribute.
...
class DaemonContainerImage(Boto3Model):
    """
...
class DaemonRevision(ReadonlyPrimaryBoto3Model):
    """
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = DaemonRevisionManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`daemonRevisionArn` attribute.
...
class DaemonDeployment(ReadonlyPrimaryBoto3Model):
    """
    A summary of a daemon deployment.
    """

    manager_class: ClassVar[ModelType[Boto3ModelManager]] = DaemonDeploymentManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`daemonDeploymentArn` attribute.
...
class ExpressGatewayServiceStatus(Boto3Model):
    """
...
class ExpressGatewayServiceNetworkConfiguration(Boto3Model):
    """
...
class ExpressGatewayServiceAwsLogsConfiguration(Boto3Model):
    """
    ...
    """
class ExpressGatewayRepositoryCredentials(Boto3Model):
    """
    ...
    credentials.
    """
class ExpressGatewayContainer(Boto3Model):
    """
...
class ExpressGatewayScalingTarget(Boto3Model):
    """
    Defines the auto-scaling configuration for an Express service.

    This determines how the service automatically adjusts the number of running tasks
...
class IngressPathSummary(Boto3Model):
    """
...
class ExpressGatewayServiceConfiguration(Boto3Model):
    """
...
class ExpressGatewayService(TagsDictMixin, PrimaryBoto3Model):
    """
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = ECSTag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ExpressGatewayServiceManager
...
class CreateManagedInstancesProviderConfiguration(Boto3Model):
    """
...
class CreateCapacityProviderResponse(Boto3Model):
...
class DescribeCapacityProvidersResponse(Boto3Model):
...
class AutoScalingGroupProviderUpdate(Boto3Model):
    """
...
class InstanceLaunchTemplateUpdate(Boto3Model):
    """
    The updated launch template configuration for Amazon ECS Managed Instances.

    You can modify the instance profile, network configuration, storage settings, and
...
class UpdateManagedInstancesProviderConfiguration(Boto3Model):
    """
...
class UpdateCapacityProviderResponse(Boto3Model):
    capacityProvider: "CapacityProvider | None" = None
    """
    Details about the capacity provider.
    """

class DeleteCapacityProviderResponse(Boto3Model):
    capacityProvider: "CapacityProvider | None" = None
    """
...
class ListServicesResponse(Boto3Model):
    ...
    When the results of a ``ListServices`` request exceed ``maxResults``, this value can
...
class ListClustersResponse(Boto3Model):
    ...
    When the results of a ``ListClusters`` request exceed ``maxResults``, this value can
    be used to retrieve the next page of results. This value is ``null`` when there are
    no more results to return.
    """
...
class ListTasksResponse(Boto3Model):
    ...
    When the results of a ``ListTasks`` request exceed ``maxResults``, this value can be
...
class TaskManagedEBSVolumeTerminationPolicy(Boto3Model):
    ...
    If a value of ``true`` is specified, Amazon ECS deletes the Amazon EBS volume on
...
class CreateTaskSetResponse(Boto3Model):
...
class DescribeTaskSetsResponse(Boto3Model):
...
class UpdateTaskSetResponse(Boto3Model):
    taskSet: "TaskSet | None" = None
    """
    Details about the task set.
    """

class DeleteTaskSetResponse(Boto3Model):
    taskSet: "TaskSet | None" = None
    """
    Details about the task set.
    """
...
class ListServiceDeploymentsResponse(Boto3Model):
    ...
    When the results of a ``ListServiceDeployments`` request exceed ``maxResults``, this
    value can be used to retrieve the next page of results. This value is null when
    there are no more results to return.
    """
...
class DescribeServiceRevisionsResponse(Boto3Model):
...
class DescribeDaemonResponse(Boto3Model):
...
class DescribeDaemonTaskDefinitionResponse(Boto3Model):
    daemonTaskDefinition: "DaemonTaskDefinition | None" = None
    """
    The full daemon task definition description.
    """

class DescribeDaemonRevisionsResponse(Boto3Model):
