...
from botocraft.service.tagging import Tag
...
class Cluster(Boto3Model):
    ...
    clusterArn: Optional[str] = Field(frozen=True)
    ...
    registeredContainerInstancesCount: Optional[int] = Field(frozen=True)
    #: The number of tasks in the cluster that are in the ``RUNNING`` state.
    runningTasksCount: Optional[int] = Field(frozen=True)
    #: The number of tasks in the cluster that are in the ``PENDING`` state.
    pendingTasksCount: Optional[int] = Field(frozen=True)
    #: The number of services that are running on the cluster in an ``ACTIVE`` state.
    #: You can view these services with ListServices.
    activeServicesCount: Optional[int] = Field(frozen=True)
    #: Additional information about your clusters that are separated by launch type.
    #: They include the following:
    statistics: Optional[List["KeyValuePair"]] = Field(frozen=True)
    ...
    attachmentsStatus: Optional[str] = Field(frozen=True)
...
class Service(Boto3Model):
    ...
    #: <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-account-
    #: settings.html#ecs-resource-ids>`_ in the *Amazon ECS Developer Guide*.
    serviceArn: Optional[str] = Field(frozen=True)
    ...
    desiredCount: int
    #: The number of tasks in the cluster that are in the ``RUNNING`` state.
    runningCount: Optional[int] = Field(frozen=True)
    #: The number of tasks in the cluster that are in the ``PENDING`` state.
    pendingCount: Optional[int] = Field(frozen=True)
    ...
    deployments: Optional[List["Deployment"]] = Field(frozen=True)
    ...
    #: displayed.
    events: Optional[List["ServiceEvent"]] = Field(frozen=True)
    ...
    createdBy: Optional[str] = Field(frozen=True)
...
class TaskDefinition(Boto3Model):
    ...
    taskDefinitionArn: Optional[str] = Field(frozen=True)
    ...
    #: family.
    revision: Optional[int] = Field(frozen=True)
    ...
    registeredBy: Optional[str] = Field(frozen=True)
...
class ClusterManager:
    ...
    def list(
        self, *, nextToken: Optional[str] = None, maxResults: Optional[int] = None
    ) -> List[Cluster]:
        _response = self.client.list_clusters(
            nextToken=nextToken, maxResults=maxResults
        )
        response = ListClustersResponse.model_construct(**_response)
...
class ServiceManager:
    ...
    def list(
        ...
        *,
        ...
        response = ListServicesResponse.model_construct(**_response)
...
class TaskDefinitionManager:
    ...
    def list(
        ...
        *,
        ...
        response = ListTaskDefinitionsResponse.model_construct(**_response)
