...
class Service(PrimaryBoto3Model):
    ...
    manager: Boto3ModelManager = ServiceManager()
...
class Cluster(PrimaryBoto3Model):
    ...
    manager: Boto3ModelManager = ClusterManager()
...
class TaskDefinition(PrimaryBoto3Model):
    ...
    manager: Boto3ModelManager = TaskDefinitionManager()
...
class ContainerInstance(ReadonlyPrimaryBoto3Model):
    ...
    manager: Boto3ModelManager = ContainerInstanceManager()
