...
class RepositoryManager(Boto3ModelManager):
    ...
    def get(
        ...
        *,
        ...
        Keyword Args:
            registryId: The Amazon Web Services account ID associated with the registry
                that contains the repositories to be
            ...
            include: Extra things to include in the response. Tags are expensive to
                ...
                API call, so you have to request them specifically. This is used only by
                the ````@repo_get_add_tags```` decorator,
        ...
        *,
        ...
        Keyword Args:
            ...
            repositoryNames: A list of repositories to describe. If this parameter is
                omitted, then all repositories in a
    ...
    def list_images(
        ...
        *,
        ...
        Keyword Args:
            registryId: The Amazon Web Services account ID associated with the registry
                that contains the repository in which to
                list images. If you do not specify a registry, the default registry is
                assumed.
    ...
    def get_images(
        ...
        *,
        ...
        """
        Use this method when you want to get just a few images from the repository.

        If you want to get all images, use the ````list_images```` method.
        ...
        Args:
            ...
            imageIds: A list of image ID references that correspond to images to
                describe. The format of the ``imageIds``
    ...
    def get_tags(self, resourceArn: str) -> "builtins.list[Tag]":
        """
        List the tags for an Amazon ECR resource.

        Args:
            resourceArn: The Amazon Resource Name (ARN) that identifies the resource for
                which to list the tags. Currently, the
        ...
        *,
        ...
        Keyword Args:
            ...
            maxResults: The maximum number of image scan results returned by
                ...
                1000. If this parameter is not used, then ``DescribeImageScanFindings``
...
class ImageScanningConfiguration(Boto3Model):
    ...
    not specified, it will default to ``false`` and images will not
...
class EncryptionConfiguration(Boto3Model):
    ...
    server-side encryption with Key Management Service key stored in Key Management
    Service (KMS) to encrypt your images. For more information, see
    `Amazon ECR encryption at rest <https://docs.aws.amazon.com/AmazonECR/latest/userguide/encryption-at-rest.html>`_
    in the *Amazon
...
class Repository(TagsDictMixin, RepositoryMixin, PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = RepositoryManager
    ...
    The ARN contains the ``arn:aws:ecr`` namespace, followed by the region of the
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`repositoryName` attribute.
    ...
    def arn(self) -> str | None:
        ...
        This is the value of the :py:attr:`repositoryArn` attribute.
...
class ECRImage(ECRImageMixin, ReadonlyPrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ECRImageManager
...
class ListImagesFilter(Boto3Model):
    ...
    Valid values are ``ACTIVE``, ``ARCHIVED``, and ``ACTIVATING``. If not specified,
...
class ListImagesResponse(Boto3Model):
    ...
    When the results of a ``ListImages`` request exceed ``maxResults``, this value can
