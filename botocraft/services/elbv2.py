...
class Listener(Boto3Model):
    """
    Information about a listener.
    """

    #: The Amazon Resource Name (ARN) of the listener.
    ListenerArn: Optional[str] = Field(frozen=True)
...
class LoadBalancer(Boto3Model):
    ...
    #: The Amazon Resource Name (ARN) of the load balancer.
    LoadBalancerArn: Optional[str] = Field(frozen=True)
    #: The public DNS name of the load balancer.
    DNSName: Optional[str] = Field(frozen=True)
    #: The ID of the Amazon Route 53 hosted zone associated with the load balancer.
    CanonicalHostedZoneId: Optional[str] = Field(frozen=True)
    #: The date and time the load balancer was created.
    CreatedTime: Optional[datetime] = Field(frozen=True)
    ...
    VpcId: Optional[str] = Field(frozen=True)
    #: The state of the load balancer.
    State: Optional["LoadBalancerState"] = Field(frozen=True)
    #: The type of load balancer.
    Type: Literal["application", "network", "gateway"]
    #: The subnets for the load balancer.
    AvailabilityZones: Optional[List["AvailabilityZone"]] = Field(frozen=True)
...
class TargetGroup(Boto3Model):
    """
    Information about a target group.
    """

    #: The Amazon Resource Name (ARN) of the target group.
    TargetGroupArn: Optional[str] = Field(frozen=True)
...
class ListenerManager:
    ...
    def delete(self, ListenerArn: str) -> None:
        self.client.delete_listener(ListenerArn=ListenerArn)
    ...
    def get(
        ...
        *,
        ...
        if response.Listeners:
            return response.Listeners[0]  # type: ignore # pylint: disable=unsubscriptable-object
        return None
...
class LoadBalancerManager:
    ...
    def delete(self, LoadBalancerArn: str) -> None:
        self.client.delete_load_balancer(LoadBalancerArn=LoadBalancerArn)
    ...
    def get(
        ...
        *,
        ...
        if response.LoadBalancers:
            return response.LoadBalancers[0]  # type: ignore # pylint: disable=unsubscriptable-object
        return None
...
class RuleManager:
    ...
    def delete(self, RuleArn: str) -> None:
        self.client.delete_rule(RuleArn=RuleArn)
    ...
    def get(
        ...
        *,
        ...
        if response.Rules:
            return response.Rules[0]  # type: ignore # pylint: disable=unsubscriptable-object
        return None
    ...
    def list(
        ...
        *,
        ...
        _response = self.client.describe_rules(
            ListenerArn=ListenerArn, RuleArns=RuleArns, Marker=Marker, PageSize=PageSize
        )
        response = DescribeRulesOutput.model_construct(**_response)
...
class TargetGroupManager:
    ...
    def delete(self, TargetGroupArn: str) -> None:
        self.client.delete_target_group(TargetGroupArn=TargetGroupArn)
    ...
    def get(
        ...
        *,
        ...
        if response.TargetGroups:
            return response.TargetGroups[0]  # type: ignore # pylint: disable=unsubscriptable-object
        return None
