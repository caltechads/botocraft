...
class InstanceSecondaryInterface(Boto3Model):
    ...
    """
    PrivateIpAddresses: List["InstanceSecondaryInterfacePrivateIpAddress"] | None = (
        None
    )
    """
...
class Instance(TagsDictMixin, InstanceModelMixin, PrimaryBoto3Model):
    ...
    """
    SecondaryInterfaces: List["InstanceSecondaryInterface"] | None = None
    """
...
class LaunchTemplateInstanceSecondaryInterfaceSpecification(Boto3Model):
    ...
    """
    PrivateIpAddresses: List["SecondaryInterfacePrivateIpAddressSpecification"] | None = None
    """
...
class ResponseLaunchTemplateData(Boto3Model):
    ...
    instance.
    """
    SecondaryInterfaces: List["LaunchTemplateInstanceSecondaryInterfaceSpecification"] | None = None
    """
...
class EC2ProcessorInfo(Boto3Model):
    ...
    """
    SupportedFeatures: List[Literal["amd-sev-snp", "nested-virtualization"]] | None = None
    """
...
class EC2EbsInfo(Boto3Model):
    ...
    """
    EbsCards: List["EbsCardInfo"] | None = None
    """
...
class EC2NetworkInfo(Boto3Model):
    ...
    """
    ConnectionTrackingConfiguration: DefaultConnectionTrackingConfiguration | None = None
    """
...
class InstanceSecondaryInterfaceSpecificationRequest(Boto3Model):
    ...
    The device index for the secondary interface attachment.
    """
    PrivateIpAddresses: List["InstanceSecondaryInterfacePrivateIpAddressRequest"] | None = None
    """
    The private IPv4 addresses to assign to the secondary interface.
    """
    PrivateIpAddressCount: int | None = None
...
class LaunchTemplateInstanceSecondaryInterfaceSpecificationRequest(Boto3Model):
    ...
    The device index for the secondary interface attachment.
    """
    PrivateIpAddresses: List["SecondaryInterfacePrivateIpAddressSpecificationRequest"] | None = None
    """
    The private IPv4 addresses to assign to the secondary interface.
    """
    PrivateIpAddressCount: int | None = None
...
class RequestLaunchTemplateData(Boto3Model):
    ...
    """
    SecondaryInterfaces: List["LaunchTemplateInstanceSecondaryInterfaceSpecificationRequest"] | None = None
    """
