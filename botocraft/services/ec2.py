...
from botocraft.mixins.ec2 import SecurityGroupMixin
...
class VpcManager(ReadonlyBoto3ModelManager):
    ...
    def get(self, VpcId: str, *, DryRun: bool = False) -> Optional["Vpc"]:
        ...
        """
        args = dict(VpcIds=self.serialize([VpcId]), DryRun=self.serialize(DryRun))
        _response = self.client.describe_vpcs(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeVpcsResult.model_construct(**_response)
    ...
    def dns_hostnames(self, VpcId: str) -> bool:
        ...
        response = DescribeVpcAttributeResult.model_construct(**_response)
    ...
    def get(self, SubnetId: str, *, DryRun: bool = False) -> Optional["Subnet"]:
        ...
        Keyword Args:
            DryRun: Checks whether you have the required permissions for the action,
                ...
                Otherwise, it is ``UnauthorizedOperation``.
        """
        args = dict(SubnetIds=self.serialize([SubnetId]), DryRun=self.serialize(DryRun))
        _response = self.client.describe_subnets(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeSubnetsResult.model_construct(**_response)
...
class SecurityGroupManager(SecurityGroupMixin, Boto3ModelManager):
    service_name: str = "ec2"
    ...
    def create(self, model: "SecurityGroup", DryRun: bool = False) -> str:
        ...
        args = dict(
            ...
            TagSpecifications=self.serialize(
                [{"ResourceType": "security-group", "Tags": model.Tags}]
            ),
            DryRun=self.serialize(DryRun),
        )
        ...
        response = CreateSecurityGroupResult.model_construct(**_response)
    ...
    def delete(self, GroupId: str, *, DryRun: bool = False) -> None:
        ...
        Keyword Args:
            DryRun: Checks whether you have the required permissions for the action,
                ...
                Otherwise, it is ``UnauthorizedOperation``.
        """
        args = dict(GroupId=self.serialize(GroupId), DryRun=self.serialize(DryRun))
        self.client.delete_security_group(
            **{k: v for k, v in args.items() if v is not None}
        )

    def get(
        self, *, GroupId: Optional[str] = None, DryRun: bool = False
        ...
        Keyword Args:
            ...
            DryRun: Checks whether you have the required permissions for the action,
                ...
                Otherwise, it is ``UnauthorizedOperation``.
        """
        args = dict(GroupIds=self.serialize([GroupId]), DryRun=self.serialize(DryRun))
        _response = self.client.describe_security_groups(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeSecurityGroupsResult.model_construct(**_response)
    ...
    def revoke_ingress(
        ...
        response = RevokeSecurityGroupIngressResult.model_construct(**_response)
    ...
    def authorize_ingress(
        ...
        *,
        ...
        response = AuthorizeSecurityGroupIngressResult.model_construct(**_response)
...
class InstanceManager(ReadonlyBoto3ModelManager):
    ...
    def create(
        ...
        response = Reservation.model_construct(**_response)
    ...
    def get(self, InstanceId: str, *, DryRun: bool = False) -> Optional["Reservation"]:
        ...
        response = DescribeInstancesResult.model_construct(**_response)
...
class SecurityGroup(PrimaryBoto3Model):
    """
...
class EC2InstancePlacement(Boto3Model):
    """
...
class Instance(PrimaryBoto3Model):
    ...
    #: The location where the instance launched, if applicable.
    Placement: Optional[EC2InstancePlacement] = None
