...
class VpcManager(ReadonlyBoto3ModelManager):
    ...
    def get(self, VpcId: str, *, DryRun: bool = False) -> "Vpc | None":
        """
        Describes your VPCs.

        The default is to describe all your VPCs. Alternatively, you can specify
        specific VPC IDs or filter the results to include only the VPCs that match
        specific criteria.
        ...
        Keyword Args:
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
    ...
    def list(
        ...
        *,
        ...
        VpcIds: "builtins.list[str] | None" = None,
...
class SubnetManager(ReadonlyBoto3ModelManager):
    ...
    def get(self, SubnetId: str, *, DryRun: bool = False) -> "Subnet | None":
        """
        Describes your subnets.

        The default is to describe all your subnets. Alternatively, you can specify
        specific subnet IDs or filter the results to include only the subnets that match
        specific criteria.
    ...
    def list(
        ...
        *,
        Filters: "builtins.list[Filter] | None" = None,
        SubnetIds: "builtins.list[str] | None" = None,
        DryRun: "bool | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes your subnets.
...
class SecurityGroupManager(EC2TagsManagerMixin, Boto3ModelManager):
    ...
    def get(self, GroupId: str, *, DryRun: bool = False) -> "SecurityGroup | None":
        """
    ...
    def list(
        self,
        *,
        GroupIds: "builtins.list[str] | None" = None,
        GroupNames: "builtins.list[str] | None" = None,
        DryRun: bool = False,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        ...
        Keyword Args:
            ...
            GroupNames: [Default VPC] The names of the security groups. You can specify
                either the security group name or the
                security group ID.
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
            ...
            Filters: The filters. If using multiple filters for rules, the results
                include security groups for which any
    ...
    def revoke_ingress(
        self,
        GroupId: str,
        IpPermissions: "builtins.list[IpPermission]",
        *,
        DryRun: bool = False,
    ) -> bool | None:
        """
        ...
        Args:
            ...
            IpPermissions: The sets of IP permissions. You can't specify a source
                security group and a CIDR IP address range in
    ...
    def revoke_egress(
        ...
        *,
        ...
        Args:
            GroupId: The ID of the security group.
            IpPermissions: The sets of IP permissions. You can't specify a destination
                security group and a CIDR IP address
        ...
        _response = self.client.revoke_security_group_egress(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = RevokeSecurityGroupEgressResult(**_response)
    ...
    def authorize_egress(
        ...
        *,
        ...
        _response = self.client.authorize_security_group_egress(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = AuthorizeSecurityGroupEgressResult(**_response)
...
class NetworkAclManager(EC2TagsManagerMixin, Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            ClientToken: Unique, case-sensitive identifier that you provide to ensure
                the idempotency of the request. For more
    ...
    def get(self, NetworkAclId: str, *, DryRun: bool = False) -> "NetworkAcl | None":
        """
        Describes your network ACLs.

        The default is to describe all your network ACLs. Alternatively, you can specify
        specific network ACL IDs or filter the results to include only the network ACLs
    ...
    def list(
        ...
        *,
        DryRun: bool = False,
        NetworkAclIds: "builtins.list[str] | None" = None,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes your network ACLs.
    ...
    def create_entry(
        ...
        *,
        ...
        out
        of a subnet associated with the ACL, we process the entries in the ACL according
        to the rule numbers, in ascending
        order. Each network ACL has a set of ingress rules and a separate set of egress
        rules.

        Args:
            NetworkAclId: The ID of the network ACL.
            RuleNumber: The rule number for the entry (for example, 100). ACL entries
                are processed in ascending order by rule
                number.
            Protocol: The protocol number. A value of "-1" means all protocols. If you
                specify "-1" or a protocol number other
                than "6" (TCP), "17" (UDP), or "1" (ICMP), traffic on all ports is
                allowed, regardless of any ports or ICMP types or
                codes that you specify. If you specify protocol "58" (ICMPv6) and
                specify an IPv4 CIDR block, traffic for all ICMP
                types and codes allowed, regardless of any that you specify. If you
                specify protocol "58" (ICMPv6) and specify an
                IPv6 CIDR block, you must specify an ICMP type and code.
            RuleAction: Indicates whether to allow or deny the traffic that matches the
                rule.
            Egress: Indicates whether this is an egress rule (rule is applied to traffic
                leaving the subnet).
        ...
        Keyword Args:
            DryRun: Checks whether you have the required permissions for the action,
                ...
                error response is ``DryRunOperation``.
                Otherwise, it is ``UnauthorizedOperation``.
            CidrBlock: The IPv4 network range to allow or deny, in CIDR notation (for
                example ``172.16.0.0/24``). We modify the
            ...
            IcmpTypeCode: ICMP protocol: The ICMP or ICMPv6 type and code. Required if
                specifying protocol 1 (ICMP) or protocol
                58 (ICMPv6) with an IPv6 CIDR block.
            PortRange: TCP or UDP protocols: The range of ports the rule applies to.
                Required if specifying protocol 6 (TCP) or
                17 (UDP).
        """
        args: dict[str, Any] = dict(
            NetworkAclId=self.serialize(NetworkAclId),
            RuleNumber=self.serialize(RuleNumber),
            Protocol=self.serialize(Protocol),
            RuleAction=self.serialize(RuleAction),
            Egress=self.serialize(Egress),
            DryRun=self.serialize(DryRun),
            CidrBlock=self.serialize(CidrBlock),
            Ipv6CidrBlock=self.serialize(Ipv6CidrBlock),
            IcmpTypeCode=self.serialize(IcmpTypeCode),
            PortRange=self.serialize(PortRange),
        )
    ...
    def replace_entry(
        ...
        *,
        ...
        For more information, see `Network ACLs <https://docs.aws.amazon.com/vpc/latest/userguide/vpc-network-acls.html>`_ in the *Amazon VPC User Guide*.
        ...
        self.client.replace_network_acl_entry(
            **{k: v for k, v in args.items() if v is not None}
        )

    def delete_entry(
        self, NetworkAclId: str, RuleNumber: int, Egress: bool, *, DryRun: bool = False
    ) -> None:
        """
...
class AMIManager(EC2TagsManagerMixin, AMIManagerMixin, Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            SnapshotLocation: Only supported for instances in Local Zones. If the source
                instance is not in a Local Zone, omit
                this parameter.
            NoReboot: Indicates whether or not the instance should be automatically
                rebooted before creating the image. Specify
    ...
    def delete(
        ...
        *,
        ...
        A deregistered AMI can't be used to launch new instances.
                Args:
                    ImageId: The ID of the AMI.

                Keyword Args:
                    DeleteAssociatedSnapshots: Specifies whether to delete the snapshots
                        associated with the AMI during deregistration.
                    DryRun: Checks whether you have the required permissions for the
                        action, without actually making the request, and
                        provides an error response. If you have the required
    ...
    def get(
        ...
        ImageId: str,
        *,
        ExecutableUsers: "builtins.list[str] | None" = None,
        ...
        Keyword Args:
            ExecutableUsers: Scopes the images by users with explicit launch
                permissions. Specify an Amazon Web Services account
            ...
            Owners: Scopes the results to images with the specified owners. You can
                specify a combination of Amazon Web Services
                account IDs, ``self``, ``amazon``, ``aws-backup-vault``, and
    ...
    def list(
        ...
        *,
        ExecutableUsers: "builtins.list[str] | None" = None,
        ImageIds: "builtins.list[str] | None" = None,
        Owners: "builtins.list[str] | None" = None,
        IncludeDeprecated: "bool | None" = None,
        IncludeDisabled: "bool | None" = None,
        DryRun: bool = False,
    ...
    def copy(
        ...
        *,
        ...
        TagSpecifications: "builtins.list[TagSpecification] | None" = None,
        ...
        You must specify the source AMI ID and both the source and destination
        locations. The copy operation must be initiated in the destination Region.

        Args:
            ClientToken: Unique, case-sensitive identifier you provide to ensure
                idempotency of the request. For more
        ...
        Keyword Args:
            ...
            KmsKeyId: The identifier of the symmetric Key Management Service (KMS) KMS
                key to use when creating encrypted
                volumes. If this parameter is not specified, your Amazon Web Services
                managed KMS key for Amazon EBS is used. If you
                specify a KMS key, you must also set the encrypted state to ``true``.
            DestinationOutpostArn: The Amazon Resource Name (ARN) of the Outpost for the
                new AMI.
            CopyImageTags: Specifies whether to copy your user-defined AMI tags to the
                new AMI.
            TagSpecifications: The tags to apply to the new AMI and new snapshots. You
                can tag the AMI, the snapshots, or both.
                ...
                the new snapshots.
            SnapshotCopyCompletionDurationMinutes: Specify a completion duration, in 15
                minute increments, to initiate a time-
                based AMI copy. The specified completion duration applies to each of the
                snapshots associated with the AMI. Each
                snapshot associated with the AMI will be completed within the specified
                completion duration, with copy throughput
                automatically adjusted for each snapshot based on its size to meet the
                timing target.
            DestinationAvailabilityZone: The Local Zone for the new AMI (for example,
                ``cn-north-1-pkx-1a``).
            DestinationAvailabilityZoneId: The ID of the Local Zone for the new AMI (for
                example, ``cnn1-pkx1-az1``).
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
                error response is ``DryRunOperation``.
    ...
    def enable_deregistration_protection(
        ...
        When deregistration protection is enabled, the AMI can't be deregistered.
                ...
                Keyword Args:
                    WithCooldown: If ``true``, enforces deregistration protection for 24
                        hours after deregistration protection is
                        disabled.
                    DryRun: Checks whether you have the required permissions for the
                        action, without actually making the request, and
                        provides an error response. If you have the required
...
class InstanceManager(EC2TagsManagerMixin, Boto3ModelManager):
    ...
    def create(
        ...
        Ipv6Addresses: "builtins.list[InstanceIpv6Address] | None" = None,
        SecurityGroupIds: "builtins.list[str] | None" = None,
        UserData: "str | None" = None,
        ElasticGpuSpecification: "builtins.list[ElasticGpuSpecification] | None" = None,
        ElasticInferenceAccelerators: "builtins.list[ElasticInferenceAccelerator] | None" = None,
        LaunchTemplate: "EC2LaunchTemplateSpecification | None" = None,
        InstanceMarketOptions: "InstanceMarketOptionsRequest | None" = None,
        CreditSpecification: "CreditSpecificationRequest | None" = None,
        LicenseSpecifications: "builtins.list[LicenseConfigurationRequest] | None" = None,
        ...
        Args:
            ...
            MaxCount: The maximum number of instances to launch. If you specify a value
                that is more capacity than Amazon EC2
                can launch in the target Availability Zone, Amazon EC2 launches the
                largest possible number of instances above the
                specified minimum count.
            MinCount: The minimum number of instances to launch. If you specify a value
                that is more capacity than Amazon EC2
                can provide in the target Availability Zone, Amazon EC2 does not launch
                any instances.

        Keyword Args:
            DisableApiTermination: Indicates whether termination protection is enabled
                for the instance. The default is
                ``false``, which means that you can terminate the instance using the
                Amazon EC2 console, command line tools, or API.
                You can enable termination protection when you launch an instance, while
                the instance is running, or while the
                instance is stopped.
            DisableApiStop: Indicates whether an instance is enabled for stop
                protection. For more information, see `Enable stop
            ...
            InstanceInitiatedShutdownBehavior: Indicates whether an instance stops or
                terminates when you initiate shutdown from
                the instance (using the operating system command for system shutdown).
            Ipv6AddressCount: The number of IPv6 addresses to associate with the primary
                network interface. Amazon EC2 chooses
                the IPv6 addresses from the range of your subnet. You cannot specify
                this option and the option to assign specific
                IPv6 addresses in the same request. You can specify this option if
                you've specified a minimum number of instances to
                launch.
            Ipv6Addresses: The IPv6 addresses from the range of the subnet to associate
                with the primary network interface. You
                cannot specify this option and the option to assign a number of IPv6
                addresses in the same request. You cannot
            ...
            UserData: The user data to make available to the instance. User data must be
                base64-encoded. Depending on the tool
                or SDK that you're using, the base64-encoding might be performed for
                you. For more information, see `Run commands at
            ...
            LaunchTemplate: The launch template. Any additional parameters that you
                specify for the new instance overwrite the
            ...
            CreditSpecification: The credit option for CPU usage of the burstable
                performance instance. Valid values are
            ...
            EnablePrimaryIpv6: If you’re launching an instance into a dual-stack or
                IPv6-only subnet, you can enable assigning a
                primary IPv6 address. A primary IPv6 address is an IPv6 GUA address
                associated with an ENI that you have enabled to
                use a primary IPv6 address. Use this option if an instance relies on its
                IPv6 address not changing. When you launch
                the instance, Amazon Web Services will automatically assign an IPv6
                address associated with the ENI attached to your
                instance to be the primary IPv6 address. Once you enable an IPv6 GUA
                address to be a primary IPv6, you cannot
                disable it. When you enable an IPv6 GUA address to be a primary IPv6,
                the first IPv6 GUA will be made the primary
                IPv6 address until the instance is terminated or the network interface
                is detached. If you have multiple IPv6
                addresses associated with an ENI attached to your instance and you
                enable a primary IPv6 address, the first IPv6 GUA
        ...
        args = dict(
            ...
            SecondaryInterfaces=data.get("SecondaryInterfaces"),
            DryRun=data.get("DryRun"),
        ...
        return cast("builtins.list[Instance]", response.Instances[0])
    ...
    def get(
        ...
        InstanceId: str,
        *,
        IncludeManagedResources: "bool | None" = None,
        DryRun: bool = False,
    ) -> "Reservation | None":
        """
        ...
        Keyword Args:
            IncludeManagedResources: Indicates whether to include managed resources in
                the output. If this parameter is set to
                ``true``, the output includes resources that are managed by Amazon Web
                Services services, even if managed resource
        ...
        """
        args: dict[str, Any] = dict(
            InstanceIds=self.serialize([InstanceId]),
            IncludeManagedResources=self.serialize(IncludeManagedResources),
            DryRun=self.serialize(DryRun),
        )
    ...
    def list(
        self,
        *,
        InstanceIds: "builtins.list[str] | None" = None,
        IncludeManagedResources: "bool | None" = None,
        DryRun: bool = False,
        Filters: "builtins.list[Filter] | None" = None,
    ...
    def start(
        self,
        InstanceIds: "builtins.list[str]",
        *,
        AdditionalInfo: "str | None" = None,
        DryRun: bool = False,
    ) -> "builtins.list[InstanceStateChange] | None":
        """
        ...
        results: "builtins.list[InstanceStateChange] | None" = None
        if response is not None:
            results = response.StartingInstances

        self.sessionize(results)
        return cast("builtins.list[InstanceStateChange] | None", results)
    ...
    def stop(
        ...
        *,
        ...
        You can restart your instance at any time using the `StartInstances <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_StartInstances.html>`_ API. For more
        ...
        Keyword Args:
            Hibernate: Hibernates the instance if the instance was enabled for
                hibernation at launch. If the instance cannot
                hibernate successfully, a normal shutdown occurs. For more information,
            ...
            SkipOsShutdown: Specifies whether to bypass the graceful OS shutdown process
            ...
            Force: Forces the instance to stop. The instance will first attempt a
                graceful shutdown, which includes flushing
                file system caches and metadata. If the graceful shutdown fails to
                complete within the timeout period, the instance
                shuts down forcibly without flushing the file system caches and
                metadata.
        """
        args: dict[str, Any] = dict(
            InstanceIds=self.serialize(InstanceIds),
    ...
    def reboot(
        self, InstanceIds: "builtins.list[str]", *, DryRun: bool = False
    ) -> "None":
        """
    ...
    def terminate(
        ...
        *,
        ...
        This operation is `idempotent <https://docs.aws.amazon.com/ec2/latest/devguide/ec2-api-idempotency.html>`_; if you terminate an instance
        ...
        Keyword Args:
            Force: Forces the instances to terminate. The instance will first attempt a
                graceful shutdown, which includes
                flushing file system caches and metadata. If the graceful shutdown fails
                to complete within the timeout period, the
    ...
    def modify_instance_type(
        ...
        *,
        SourceDestCheck: "AttributeBooleanValue | None" = None,
        EnclaveOptions: "EnclaveOptionsRequest | None" = None,
        DisableApiStop: "AttributeBooleanValue | None" = None,
        DryRun: bool = False,
        Attribute: "Literal['instanceType', 'kernel', 'ramdisk', 'userData', 'disableApiTermination', 'instanceInitiatedShutdownBehavior', 'rootDeviceName', 'blockDeviceMapping', 'productCodes', 'sourceDestCheck', 'groupSet', 'ebsOptimized', 'sriovNetSupport', 'enaSupport', 'enclaveOptions', 'disableApiStop'] | None" = None,
        Value: "str | None" = None,
        BlockDeviceMappings: "builtins.list[InstanceBlockDeviceMappingSpecification] | None" = None,
        DisableApiTermination: "AttributeBooleanValue | None" = None,
        Kernel: "AttributeValue | None" = None,
        Ramdisk: "AttributeValue | None" = None,
        UserData: "SecureBlobAttributeValue | None" = None,
        InstanceInitiatedShutdownBehavior: "AttributeValue | None" = None,
        Groups: "builtins.list[str] | None" = None,
        EbsOptimized: "AttributeBooleanValue | None" = None,
        SriovNetSupport: "AttributeValue | None" = None,
        EnaSupport: "AttributeBooleanValue | None" = None,
    ) -> None:
        """
        ...
        You can specify only one attribute at a time.
                Args:
                    ...
                    InstanceType: Changes the instance type to the specified value. For
                        more information, see `Instance types
                        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html>`_ in the *Amazon EC2 User Guide*. If the
                        instance type is not valid, the error returned is
                        ``InvalidInstanceAttributeValue``.

                Keyword Args:
                    SourceDestCheck: Enable or disable source/destination checks, which
                        ensure that the instance is either the source or
                        the destination of any traffic that it receives. If the value is
                        ``true``, source/destination checks are enabled;
                        otherwise, they are disabled. The default value is ``true``. You
                        must disable source/destination checks if the
                        instance runs services such as network address translation,
                        routing, or firewalls.
                    EnclaveOptions: Enables or disables the instance for Amazon Web
                        Services Nitro Enclaves. For more information, see
                        the `Amazon Web Services Nitro Enclaves User Guide <https://docs.aws.amazon.com/enclaves/latest/user/nitro-
                        enclave.html>`_.
                    DisableApiStop: Indicates whether an instance is enabled for stop
                        protection. For more information, see `Enable stop
                        protection for your instance <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-stop-protection.html>`_.
                    DryRun: Checks whether you have the required permissions for the
                        operation, without actually making the request, and
                        provides an error response. If you have the required
                        permissions, the error response is ``DryRunOperation``.
                        Otherwise, it is ``UnauthorizedOperation``.
                    ...
                    BlockDeviceMappings: Modifies the ``DeleteOnTermination`` attribute
                        for volumes that are currently attached. The
                        volume must be owned by the caller. If no value is specified for
                        ``DeleteOnTermination``, the default is ``true``
                        and the volume is deleted when the instance is terminated. You
                        can't modify the ``DeleteOnTermination`` attribute
                        for volumes that are attached to Amazon Web Services-managed
                        resources.
                    DisableApiTermination: Enable or disable termination protection for
                        the instance. If the value is ``true``, you
                        can't terminate the instance using the Amazon EC2 console,
                        command line interface, or API. You can't enable
                        termination protection for Spot Instances.
                    Kernel: Changes the instance's kernel to the specified value. We
                        recommend that you use PV-GRUB instead of kernels
                        and RAM disks. For more information, see `PV- GRUB
                        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UserProvidedKernels.html>`_.
                    Ramdisk: Changes the instance's RAM disk to the specified value. We
                        recommend that you use PV-GRUB instead of
                        kernels and RAM disks. For more information, see `PV- GRUB
                        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/UserProvidedKernels.html>`_.
                    UserData: Changes the instance's user data to the specified value.
                        User data must be base64-encoded. Depending on
                        the tool or SDK that you're using, the base64-encoding might be
                        performed for you. For more information, see `Work
                        with instance user data <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instancedata-add-user-data.html>`_.
                    InstanceInitiatedShutdownBehavior: Specifies whether an instance
                        stops or terminates when you initiate shutdown from
                        the instance (using the operating system command for system
                        shutdown).
                    Groups: Replaces the security groups of the instance with the
                        specified security groups. You must specify the ID of
                        at least one security group, even if it's just the default
                        security group for the VPC.
                    EbsOptimized: Specifies whether the instance is optimized for Amazon
                        EBS I/O. This optimization provides dedicated
                        throughput to Amazon EBS and an optimized configuration stack to
                        provide optimal EBS I/O performance. This
                        optimization isn't available with all instance types. Additional
                        usage charges apply when using an EBS Optimized
                        instance.
                    SriovNetSupport: Set to ``simple`` to enable enhanced networking
                        with the Intel 82599 Virtual Function interface for
                        the instance.
                    EnaSupport: Set to ``true`` to enable enhanced networking with ENA
                        for the instance.
        """
        args: dict[str, Any] = dict(
            InstanceId=self.serialize(InstanceId),
            SourceDestCheck=self.serialize(SourceDestCheck),
            EnclaveOptions=self.serialize(EnclaveOptions),
            DisableApiStop=self.serialize(DisableApiStop),
            DryRun=self.serialize(DryRun),
            Attribute=self.serialize(Attribute),
            Value=self.serialize(Value),
            BlockDeviceMappings=self.serialize(BlockDeviceMappings),
            DisableApiTermination=self.serialize(DisableApiTermination),
            InstanceType=self.serialize(InstanceType),
            Kernel=self.serialize(Kernel),
            Ramdisk=self.serialize(Ramdisk),
            UserData=self.serialize(UserData),
            InstanceInitiatedShutdownBehavior=self.serialize(
                InstanceInitiatedShutdownBehavior
            ),
            Groups=self.serialize(Groups),
            EbsOptimized=self.serialize(EbsOptimized),
            SriovNetSupport=self.serialize(SriovNetSupport),
            EnaSupport=self.serialize(EnaSupport),
        )
        self.client.modify_instance_attribute(
            **{k: v for k, v in args.items() if v is not None}
        )

    def modify_source_dest_check(
        self,
        ...
        *,
        ...
        BlockDeviceMappings: "builtins.list[InstanceBlockDeviceMappingSpecification] | None" = None,
        DisableApiTermination: "AttributeBooleanValue | None" = None,
        InstanceType: "AttributeValue | None" = None,
        Kernel: "AttributeValue | None" = None,
        Ramdisk: "AttributeValue | None" = None,
        UserData: "SecureBlobAttributeValue | None" = None,
        InstanceInitiatedShutdownBehavior: "AttributeValue | None" = None,
    ...
    def modify_disable_api_termination(
        self,
        InstanceId: str,
...
class LaunchTemplateManager(EC2TagsManagerMixin, Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            ClientToken: Unique, case-sensitive identifier you provide to ensure the
                idempotency of the request. If a client
                token isn't specified, a randomly generated token is used in the request
    ...
    def list(
        ...
        *,
        DryRun: bool = False,
        LaunchTemplateIds: "builtins.list[str] | None" = None,
        LaunchTemplateNames: "builtins.list[str] | None" = None,
        Filters: "builtins.list[Filter] | None" = None,
        IncludeManagedResources: "bool | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
...
class LaunchTemplateVersionManager(Boto3ModelManager):
    ...
    def create(
        ...
        You must specify an existing launch template, either by name or ID. You can
        determine whether the new version inherits parameters from a source version, and
        ...
        Keyword Args:
            ...
            SourceVersion: The version of the launch template on which to base the new
                version. Snapshots applied to the block
            ...
            ResolveAlias: If ``true``, and if a Systems Manager parameter is specified
                for ``ImageId``, the AMI ID is displayed
                in the response for ``imageID``. For more information, see `Use a
    ...
    def list(
        ...
        *,
        ...
        LaunchTemplateName: "str | None" = None,
        Versions: "builtins.list[str] | None" = None,
        MinVersion: "str | None" = None,
        MaxVersion: "str | None" = None,
        Filters: "builtins.list[Filter] | None" = None,
        ResolveAlias: "bool | None" = None,
        ...
        Keyword Args:
            ...
            Versions: One or more versions of the launch template. Valid values depend
                on whether you are describing a specified
...
class NetworkInterfaceManager(EC2TagsManagerMixin, Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            Ipv4PrefixCount: The number of IPv4 prefixes that Amazon Web Services
                automatically assigns to the network
                interface.
            Ipv6PrefixCount: The number of IPv6 prefixes that Amazon Web Services
                automatically assigns to the network
                interface.
            ClientToken: Unique, case-sensitive identifier that you provide to ensure
                the idempotency of the request. For more
            ...
            EnablePrimaryIpv6: If you’re creating a network interface in a dual-stack or
                IPv6-only subnet, you have the option
                to assign a primary IPv6 IP address. A primary IPv6 address is an IPv6
                GUA address associated with an ENI that you
                have enabled to use a primary IPv6 address. Use this option if the
                instance that this ENI will be attached to relies
                on its IPv6 address not changing. Amazon Web Services will automatically
                assign an IPv6 address associated with the
                ENI attached to your instance to be the primary IPv6 address. Once you
                enable an IPv6 GUA address to be a primary
                IPv6, you cannot disable it. When you enable an IPv6 GUA address to be a
                primary IPv6, the first IPv6 GUA will be
                made the primary IPv6 address until the instance is terminated or the
                network interface is detached. If you have
                multiple IPv6 addresses associated with an ENI attached to your instance
                and you enable a primary IPv6 address, the
                first IPv6 GUA address associated with the ENI becomes the primary IPv6
                address.
            ConnectionTrackingSpecification: A connection tracking specification for the
                network interface.
            SecondaryPrivateIpAddressCount: The number of secondary private IPv4
                addresses to assign to a network interface.
                When you specify a number of secondary IPv4 addresses, Amazon EC2
                selects these IP addresses within the subnet's
            ...
            Ipv6AddressCount: The number of IPv6 addresses to assign to a network
                interface. Amazon EC2 automatically selects
    ...
    def list(
        ...
        *,
        IncludeManagedResources: "bool | None" = None,
        DryRun: bool = False,
        NetworkInterfaceIds: "builtins.list[str] | None" = None,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes the specified network interfaces or all your network interfaces.
    ...
    def attach(
        ...
        *,
        ...
        Keyword Args:
            NetworkCardIndex: The index of the network card. Some instance types support
                multiple network cards. The primary
                network interface must be assigned to network card index 0. The default
                is network card index 0.
            EnaSrdSpecification: Configures ENA Express for the network interface that
                this action attaches to the instance.
        ...
        You can specify only one attribute at a time.
                ...
                Keyword Args:
                    DryRun: Checks whether you have the required permissions for the
                        ...
                        permissions, the error response is ``DryRunOperation``.
                        Otherwise, it is ``UnauthorizedOperation``.
                    SourceDestCheck: The source/destination checking attribute. Resets
                        the value to ``true``.
        """
        args: dict[str, Any] = dict(
            NetworkInterfaceId=self.serialize(NetworkInterfaceId),
    ...
    def permissions(
        self,
        *,
        NetworkInterfacePermissionIds: "builtins.list[str] | None" = None,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> "builtins.list[NetworkInterfacePermission]":
        """
        ...
        results: "builtins.list[NetworkInterfacePermission]" = []
        ...
        self.sessionize(results)
        return cast("builtins.list[NetworkInterfacePermission]", results)

    def assign_private_ips(
        self,
        NetworkInterfaceId: str,
        *,
        Ipv4Prefixes: "builtins.list[str] | None" = None,
        Ipv4PrefixCount: "int | None" = None,
        PrivateIpAddresses: "builtins.list[str] | None" = None,
        SecondaryPrivateIpAddressCount: "int | None" = None,
        AllowReassignment: "bool | None" = None,
        ...
        Keyword Args:
            Ipv4Prefixes: One or more IPv4 prefixes assigned to the network interface.
                You can't use this option if you use the
                ``Ipv4PrefixCount`` option.
            Ipv4PrefixCount: The number of IPv4 prefixes that Amazon Web Services
                automatically assigns to the network
                interface. You can't use this option if you use the ``Ipv4 Prefixes``
                option.
            PrivateIpAddresses: The IP addresses to be assigned as a secondary private
                IP address to the network interface. You
                can't specify this parameter when also specifying a number of secondary
                IP addresses.
            SecondaryPrivateIpAddressCount: The number of secondary IP addresses to
                assign to the network interface. You can't
                specify this parameter when also specifying private IP addresses.
            AllowReassignment: Indicates whether to allow an IP address that is already
                assigned to another network interface or
                instance to be reassigned to the specified network interface.
        """
        args: dict[str, Any] = dict(
            NetworkInterfaceId=self.serialize(NetworkInterfaceId),
            Ipv4Prefixes=self.serialize(Ipv4Prefixes),
            Ipv4PrefixCount=self.serialize(Ipv4PrefixCount),
            PrivateIpAddresses=self.serialize(PrivateIpAddresses),
            SecondaryPrivateIpAddressCount=self.serialize(
                SecondaryPrivateIpAddressCount
            ),
            AllowReassignment=self.serialize(AllowReassignment),
        )
        _response = self.client.assign_private_ip_addresses(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = AssignPrivateIpAddressesResult(**_response)

        results: "AssignPrivateIpAddressesResult" = None
        if response is not None:
            results = response

        self.sessionize(results)
        return cast("AssignPrivateIpAddressesResult", results)
    ...
    def unassign_private_ips(
        ...
        *,
        ...
        Keyword Args:
            ...
            PrivateIpAddresses: The secondary private IP addresses to unassign from the
                network interface. You can specify this
    ...
    def modify(
        ...
        *,
        ...
        AssociatedSubnetIds: "builtins.list[str] | None" = None,
        DryRun: bool = False,
        ...
        Keyword Args:
            EnaSrdSpecification: Updates the ENA Express configuration for the network
                interface that’s attached to the
                instance.
            EnablePrimaryIpv6: If you’re modifying a network interface in a dual-stack
                or IPv6-only subnet, you have the option
                to assign a primary IPv6 IP address. A primary IPv6 address is an IPv6
                GUA address associated with an ENI that you
                have enabled to use a primary IPv6 address. Use this option if the
                instance that this ENI will be attached to relies
            ...
            AssociatePublicIpAddress: Indicates whether to assign a public IPv4 address
                to a network interface. This option can
                be enabled for any network interface but will only apply to the primary
                network interface (eth0).
            AssociatedSubnetIds: A list of subnet IDs to associate with the network
                interface.
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
            ...
            SourceDestCheck: Enable or disable source/destination checks, which ensure
                that the instance is either the source or
                the destination of any traffic that it receives. If the value is
                ``true``, source/destination checks are enabled;
                otherwise, they are disabled. The default value is ``true``. You must
                disable source/destination checks if the
                instance runs services such as network address translation, routing, or
                firewalls.
            Groups: Changes the security groups for the network interface. The new set
                of groups you specify replaces the
                current set. You must specify at least one group, even if it's just the
                default security group in the VPC. You must
                specify the ID of the security group, not the name.
            Attachment: Information about the interface attachment. If modifying the
                ``delete on termination`` attribute, you
        ...
        args: dict[str, Any] = dict(
            ...
            AssociatePublicIpAddress=self.serialize(AssociatePublicIpAddress),
            AssociatedSubnetIds=self.serialize(AssociatedSubnetIds),
            DryRun=self.serialize(DryRun),
            Description=self.serialize(Description),
            SourceDestCheck=self.serialize(SourceDestCheck),
            Groups=self.serialize(Groups),
            Attachment=self.serialize(Attachment),
        )
...
class EC2InstanceTypeManager(ReadonlyBoto3ModelManager):
    ...
    def get(
        ...
        *,
        DryRun: bool = False,
        Filters: "builtins.list[Filter] | None" = None,
        IncludeUnsupportedInRegion: "bool | None" = None,
    ) -> "EC2InstanceType | None":
        """
        Describes the specified instance types.

        By default, all instance types for the current Region are described.
        Alternatively, you can filter the results. To include instance types that are
        not supported in the current Region, set
        ...
        Keyword Args:
            ...
            IncludeUnsupportedInRegion: If ``true``, the response includes instance
                types that are not supported in the current
                Region, in addition to the supported types. Default: ``false``.
        """
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun),
            InstanceTypes=self.serialize([InstanceType]),
            Filters=self.serialize(Filters),
            IncludeUnsupportedInRegion=self.serialize(IncludeUnsupportedInRegion),
        )
...
class SnapshotManager(EC2TagsManagerMixin, Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            Location: Only supported for volumes in Local Zones. If the source volume is
                not in a Local Zone, omit this
                parameter.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
    ...
    def get(
        ...
        SnapshotId: str,
        *,
        OwnerIds: "builtins.list[str] | None" = None,
        RestorableByUserIds: "builtins.list[str] | None" = None,
        DryRun: bool = False,
    ) -> "Snapshot | None":
        """
        ...
        Keyword Args:
            OwnerIds: Scopes the results to snapshots with the specified owners. You can
                specify a combination of Amazon Web
                Services account IDs, ``self``, and ``amazon``.
            RestorableByUserIds: The IDs of the Amazon Web Services accounts that can
    ...
    def list(
        ...
        *,
        OwnerIds: "builtins.list[str] | None" = None,
        RestorableByUserIds: "builtins.list[str] | None" = None,
        SnapshotIds: "builtins.list[str] | None" = None,
        DryRun: bool = False,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
    ...
    def enable_block_public_access(
        ...
        *,
        ...
        Args:
            State: The mode in which to enable block public access for snapshots for the
    ...
    def lock(
        ...
        *,
        ...
        Args:
            ...
            LockMode: The mode in which to lock the snapshot. Specify one of the
                following:
        ...
        Keyword Args:
            DryRun: Checks whether you have the required permissions for the action,
                ...
                error response is ``DryRunOperation``.
                Otherwise, it is ``UnauthorizedOperation``.
            CoolOffPeriod: The cooling-off period during which you can unlock the
                snapshot or modify the lock settings after
                locking the snapshot in compliance mode, in hours. After the cooling-off
                period expires, you can't unlock or delete
                the snapshot, decrease the lock duration, or change the lock mode. You
                can increase the lock duration after the
                cooling-off period expires.
            LockDuration: The period of time for which to lock the snapshot, in days.
                The snapshot lock will automatically
                expire after this period lapses.
            ExpirationDate: The date and time at which the snapshot lock is to
                automatically expire, in the UTC time zone
    ...
    def list_locked(
        ...
        *,
        ...
        SnapshotIds: "builtins.list[str] | None" = None,
        DryRun: bool = False,
    ) -> "builtins.list[LockedSnapshotsInfo]":
        """
        Describes the lock status for a snapshot.

        Keyword Args:
            Filters: The filters.
            MaxResults: The maximum number of items to return for this request. To get
                the next page of items, make another
            ...
            NextToken: The token returned from a previous paginated request. Pagination
                continues from the end of the items
        ...
        results: "builtins.list[LockedSnapshotsInfo]" = None
        if response is not None:
            results = response.Snapshots

        self.sessionize(results)
        return cast("builtins.list[LockedSnapshotsInfo]", results)
        ...
        *,
        ...
        Keyword Args:
            ...
            DestinationOutpostArn: The Amazon Resource Name (ARN) of the Outpost to
                which to copy the snapshot.
            DestinationRegion: The destination Region to use in the ``PresignedUrl``
                parameter of a snapshot copy operation.
                This parameter is only valid for specifying the destination Region in a
                ``PresignedUrl`` parameter, where it is
                required.
            Encrypted: To encrypt a copy of an unencrypted snapshot if encryption by
                default is not enabled, enable encryption
                using this parameter. Otherwise, omit this parameter. Copies of
                encrypted snapshots are encrypted, even if you omit
                this parameter and encryption by default is not enabled. You cannot set
                this parameter to false. For more
                information, see `Amazon EBS encryption <https://docs.aws.amazon.com/ebs/latest/userguide/ebs-encryption.html>`_ in
                the *Amazon EBS User Guide*.
            KmsKeyId: The identifier of the KMS key to use for Amazon EBS encryption. If
                this parameter is not specified, your
                KMS key for Amazon EBS is used. If ``KmsKeyId`` is specified, the
                encrypted state must be ``true``.
            PresignedUrl: When you copy an encrypted source snapshot using the Amazon
                EC2 Query API, you must supply a pre-
                signed URL. This parameter is optional for unencrypted snapshots. For
                more information, see `Query requests
            ...
            CompletionDurationMinutes: Not supported when copying snapshots to or from
                Local Zones or Outposts.
            DestinationAvailabilityZone: The Local Zone, for example,
                ``cn-north-1-pkx-1a`` to which to copy the snapshot.
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
                error response is ``DryRunOperation``.
...
class KeyPairManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"

    def create(
        self, model: "KeyPair", KeyFormat: "Literal['pem', 'ppk'] | None" = None
    ) -> "KeyPair":
        """
        ...
        a file. The private key is returned as an unencrypted PEM
        encoded PKCS#1 private key or an unencrypted PPK formatted private key for use
        with PuTTY. If a key with the specified
        name already exists, Amazon EC2 returns an error.

        Args:
            model: The :py:class:`KeyPair` to create.
        ...
        args = dict(
            ...
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "key-pair"))
            ),
            KeyFormat=self.serialize(KeyFormat),
            DryRun=data.get("DryRun"),
        )
        _response = self.client.create_key_pair(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = KeyPair(**_response)

        self.sessionize(response)
        return cast("KeyPair", response)

    def get(
        self, KeyPairId: str, *, IncludePublicKey: bool = True, DryRun: bool = False
    ) -> "KeyPair | None":
        """
        ...
        Keyword Args:
            IncludePublicKey: If ``true``, the public key material is included in the
                response.
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
        ...
        """
        args: dict[str, Any] = dict(
            KeyPairIds=self.serialize([KeyPairId]),
            IncludePublicKey=self.serialize(IncludePublicKey),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.describe_key_pairs(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeKeyPairsResult(**_response)

        if response and response.KeyPairs:
            self.sessionize(response.KeyPairs[0])
    ...
    def list(
        self,
        *,
        KeyNames: "builtins.list[str] | None" = None,
        KeyPairIds: "builtins.list[str] | None" = None,
        ...
        """
        args: dict[str, Any] = dict(
            KeyNames=self.serialize(KeyNames),
            KeyPairIds=self.serialize(KeyPairIds),
            IncludePublicKey=self.serialize(IncludePublicKey),
            DryRun=self.serialize(DryRun),
            Filters=self.serialize(Filters),
        )
        ...
        response = DescribeKeyPairsResult(**_response)
        if response and response.KeyPairs:
            self.sessionize(response.KeyPairs)
            return PrimaryBoto3ModelQuerySet(response.KeyPairs)
        return PrimaryBoto3ModelQuerySet([])

    def delete(self, KeyPairId: str, *, DryRun: bool = False) -> "KeyPair":
        """
        ...
        """
        args: dict[str, Any] = dict(
            KeyPairId=self.serialize(KeyPairId), DryRun=self.serialize(DryRun)
        )
        _response = self.client.delete_key_pair(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DeleteKeyPairResult(**_response)
        return response
    ...
    def import_key_pair(
        ...
        *,
        ...
        Keyword Args:
            Tags: The tags to apply to the imported key pair.
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
                error response is ``DryRunOperation``.
        ...
        """
        args: dict[str, Any] = dict(
            KeyName=self.serialize(KeyName),
            PublicKeyMaterial=self.serialize(PublicKeyMaterial),
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(Tags, "key-pair"))
            ),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.import_key_pair(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ImportKeyPairResult(**_response)

        results: "ImportKeyPairResult" = None
        if response is not None:
            results = response

        self.sessionize(results)
        return cast("ImportKeyPairResult", results)


class PlacementGroupManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"

    def create(self, model: "PlacementGroup") -> "PlacementGroup":
        """
        ...
        Args:
            model: The :py:class:`PlacementGroup` to create.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
            PartitionCount=data.get("PartitionCount"),
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "placement-group"))
            ),
            SpreadLevel=data.get("SpreadLevel"),
            LinkedGroupId=data.get("LinkedGroupId"),
            Operator=data.get("Operator"),
            DryRun=data.get("DryRun"),
            GroupName=data.get("GroupName"),
            Strategy=data.get("Strategy"),
        )
        _response = self.client.create_placement_group(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreatePlacementGroupResult(**_response)

        self.sessionize(response.PlacementGroupInstance)
        return cast("PlacementGroup", response.PlacementGroupInstance)

    def get(self, GroupName: str, *, DryRun: bool = False) -> "PlacementGroup | None":
        """
        ...
        """
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun), GroupNames=self.serialize([GroupName])
        )
        _response = self.client.describe_placement_groups(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribePlacementGroupsResult(**_response)

        if response and response.PlacementGroups:
            self.sessionize(response.PlacementGroups[0])
            return response.PlacementGroups[0]
        return None
    ...
    def list(
        ...
        *,
        ...
        response = DescribePlacementGroupsResult(**_response)
        if response and response.PlacementGroups:
            self.sessionize(response.PlacementGroups)
            return PrimaryBoto3ModelQuerySet(response.PlacementGroups)
        return PrimaryBoto3ModelQuerySet([])

    def delete(self, GroupName: str, *, DryRun: bool = False) -> None:
        """
        Deletes the specified placement group.

        You must terminate all instances in the placement group before you can delete
        the placement group. For more information, see `Placement
        groups <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html>`_ in the *Amazon EC2 User Guide*.
        ...
        """
        args: dict[str, Any] = dict(
            GroupName=self.serialize(GroupName), DryRun=self.serialize(DryRun)
        )
        self.client.delete_placement_group(
            **{k: v for k, v in args.items() if v is not None}
        )


class DhcpOptionsManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"

    def create(self, model: "DhcpOptions") -> "DhcpOptions":
        """
        Creates a custom set of DHCP options.

        After you create a DHCP option set, you associate it with a VPC. After you
        associate a DHCP option set with a VPC, all existing and newly launched
        instances in the VPC use this set of DHCP
        options.

        Args:
            model: The :py:class:`DhcpOptions` to create.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
            DhcpConfigurations=data.get("DhcpConfigurations"),
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "dhcp-options"))
            ),
            DryRun=data.get("DryRun"),
        )
        _response = self.client.create_dhcp_options(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateDhcpOptionsResult(**_response)

        self.sessionize(response.DhcpOptionsInstance)
        return cast("DhcpOptions", response.DhcpOptionsInstance)

    def get(self, DhcpOptionsId: str, *, DryRun: bool = False) -> "DhcpOptions | None":
        """
        Describes your DHCP option sets.

        The default is to describe all your DHCP option sets. Alternatively, you can
        specify specific DHCP option set IDs or filter the results to include only the
        DHCP option sets that match specific criteria.
        ...
        """
        args: dict[str, Any] = dict(
            DhcpOptionsIds=self.serialize([DhcpOptionsId]),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.describe_dhcp_options(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeDhcpOptionsResult(**_response)

        if response and response.DhcpOptions:
            self.sessionize(response.DhcpOptions[0])
    ...
    def list(
        self,
        *,
        DhcpOptionsIds: "builtins.list[str] | None" = None,
        DryRun: bool = False,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        ...
        args: dict[str, Any] = dict(
            DhcpOptionsIds=self.serialize(DhcpOptionsIds),
            DryRun=self.serialize(DryRun),
            Filters=self.serialize(Filters),
        )
        response_iterator = paginator.paginate(
        ...
        for _response in response_iterator:
            ...
            if "ResponseMetadata" in _response:
                del _response["ResponseMetadata"]
            response = DescribeDhcpOptionsResult(**_response)
            if response.DhcpOptions:
                results.extend(response.DhcpOptions)
            else:
                if getattr(response, "NextToken", None):
                    continue
                break
    ...
    def delete(self, DhcpOptionsId: str, *, DryRun: bool = False) -> None:
        """
        ...
        or the default set of options with
        the VPC.
        ...
        """
        args: dict[str, Any] = dict(
            DhcpOptionsId=self.serialize(DhcpOptionsId), DryRun=self.serialize(DryRun)
        )
...
class CustomerGatewayManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"

    def create(self, model: "CustomerGateway") -> "CustomerGateway":
        """
        ...
        Args:
            model: The :py:class:`CustomerGateway` to create.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
            Type=data.get("Type"),
            BgpAsn=data.get("BgpAsn"),
            PublicIp=data.get("IpAddress"),
            CertificateArn=data.get("CertificateArn"),
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "customer-gateway"))
            ),
            DeviceName=data.get("DeviceName"),
            BgpAsnExtended=data.get("BgpAsnExtended"),
            DryRun=data.get("DryRun"),
        )
        _response = self.client.create_customer_gateway(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateCustomerGatewayResult(**_response)

        self.sessionize(response.CustomerGatewayInstance)
        return cast("CustomerGateway", response.CustomerGatewayInstance)

    def get(
        self, CustomerGatewayId: str, *, DryRun: bool = False
    ) -> "CustomerGateway | None":
        """
        ...
        """
        args: dict[str, Any] = dict(
            CustomerGatewayIds=self.serialize([CustomerGatewayId]),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.describe_customer_gateways(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeCustomerGatewaysResult(**_response)

        if response and response.CustomerGateways:
            self.sessionize(response.CustomerGateways[0])
    ...
    def list(
        self,
        *,
        CustomerGatewayIds: "builtins.list[str] | None" = None,
        Filters: "builtins.list[Filter] | None" = None,
        DryRun: bool = False,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        ...
        """
        args: dict[str, Any] = dict(
            CustomerGatewayIds=self.serialize(CustomerGatewayIds),
            Filters=self.serialize(Filters),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.describe_customer_gateways(
        ...
        response = DescribeCustomerGatewaysResult(**_response)
        if response and response.CustomerGateways:
            self.sessionize(response.CustomerGateways)
            return PrimaryBoto3ModelQuerySet(response.CustomerGateways)
        return PrimaryBoto3ModelQuerySet([])

    def delete(self, CustomerGatewayId: str, *, DryRun: bool = False) -> None:
        """
        ...
        """
        args: dict[str, Any] = dict(
            CustomerGatewayId=self.serialize(CustomerGatewayId),
            DryRun=self.serialize(DryRun),
        )
        self.client.delete_customer_gateway(
            **{k: v for k, v in args.items() if v is not None}
        )


class VpnGatewayManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"

    def create(self, model: "VpnGateway") -> "VpnGateway":
        """
        ...
        Args:
            model: The :py:class:`VpnGateway` to create.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
            Type=data.get("Type"),
            ...
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "vpn-gateway"))
            ),
            AmazonSideAsn=data.get("AmazonSideAsn"),
            DryRun=data.get("DryRun"),
        )
        _response = self.client.create_vpn_gateway(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateVpnGatewayResult(**_response)

        self.sessionize(response.VpnGatewayInstance)
        return cast("VpnGateway", response.VpnGatewayInstance)

    def get(self, VpnGatewayId: str, *, DryRun: bool = False) -> "VpnGateway | None":
        """
        ...
        """
        args: dict[str, Any] = dict(
            VpnGatewayIds=self.serialize([VpnGatewayId]), DryRun=self.serialize(DryRun)
        )
        _response = self.client.describe_vpn_gateways(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeVpnGatewaysResult(**_response)

        if response and response.VpnGateways:
            self.sessionize(response.VpnGateways[0])
    ...
    def list(
        ...
        *,
        Filters: "builtins.list[Filter] | None" = None,
        VpnGatewayIds: "builtins.list[str] | None" = None,
        DryRun: bool = False,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes one or more of your virtual private gateways.
        ...
        args: dict[str, Any] = dict(
            Filters=self.serialize(Filters),
            VpnGatewayIds=self.serialize(VpnGatewayIds),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.describe_vpn_gateways(
            **{k: v for k, v in args.items() if v is not None}
        ...
        response = DescribeVpnGatewaysResult(**_response)
        if response and response.VpnGateways:
            self.sessionize(response.VpnGateways)
            return PrimaryBoto3ModelQuerySet(response.VpnGateways)
        return PrimaryBoto3ModelQuerySet([])

    def delete(self, VpnGatewayId: str, *, DryRun: bool = False) -> None:
        """
        ...
        recreate the VPN connection between your
        ...
        """
        args: dict[str, Any] = dict(
            VpnGatewayId=self.serialize(VpnGatewayId), DryRun=self.serialize(DryRun)
        )
    ...
    def attach(
        self, VpcId: str, VpnGatewayId: str, *, DryRun: bool = False
    ) -> "EC2VpcAttachment":
        """
        ...
        args: dict[str, Any] = dict(
            VpcId=self.serialize(VpcId),
            VpnGatewayId=self.serialize(VpnGatewayId),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.attach_vpn_gateway(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = AttachVpnGatewayResult(**_response)

        results: "EC2VpcAttachment" = None
        if response is not None:
            results = response.VpcAttachment

        self.sessionize(results)
        return cast("EC2VpcAttachment", results)

    def detach(self, VpcId: str, VpnGatewayId: str, *, DryRun: bool = False) -> None:
        """
...
class InternetGatewayManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"

    def create(self, model: "InternetGateway") -> "InternetGateway":
        """
        ...
        Args:
            model: The :py:class:`InternetGateway` to create.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "internet-gateway"))
            ),
            DryRun=data.get("DryRun"),
        )
        _response = self.client.create_internet_gateway(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateInternetGatewayResult(**_response)

        self.sessionize(response.InternetGatewayInstance)
        return cast("InternetGateway", response.InternetGatewayInstance)

    def get(
        self, InternetGatewayId: str, *, DryRun: bool = False
    ) -> "InternetGateway | None":
        """
        Describes your internet gateways.

        The default is to describe all your internet gateways. Alternatively, you can
        specify specific internet gateway IDs or filter the results to include only the
        internet gateways that match specific criteria.
        ...
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun),
            InternetGatewayIds=self.serialize([InternetGatewayId]),
        )
        _response = self.client.describe_internet_gateways(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeInternetGatewaysResult(**_response)

        if response and response.InternetGateways:
            self.sessionize(response.InternetGateways[0])
    ...
    def list(
        ...
        *,
        DryRun: bool = False,
        InternetGatewayIds: "builtins.list[str] | None" = None,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes your internet gateways.
        ...
        Keyword Args:
            DryRun: Checks whether you have the required permissions for the action,
                ...
                error response is ``DryRunOperation``.
                Otherwise, it is ``UnauthorizedOperation``.
            InternetGatewayIds: The IDs of the internet gateways.
            Filters: The filters.
        """
        paginator = self.client.get_paginator("describe_internet_gateways")
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun),
            InternetGatewayIds=self.serialize(InternetGatewayIds),
            Filters=self.serialize(Filters),
        )
        response_iterator = paginator.paginate(
            **{k: v for k, v in args.items() if v is not None}
        ...
        for _response in response_iterator:
            ...
            if response.InternetGateways:
                results.extend(response.InternetGateways)
            else:
                if getattr(response, "NextToken", None):
                    continue
                break
    ...
    def delete(self, InternetGatewayId: str, *, DryRun: bool = False) -> None:
        """
        ...
        """
        args: dict[str, Any] = dict(
            InternetGatewayId=self.serialize(InternetGatewayId),
            DryRun=self.serialize(DryRun),
        )
    ...
    def attach(
        self, InternetGatewayId: str, VpcId: str, *, DryRun: bool = False
    ) -> None:
        """
        Attaches an internet gateway or a virtual private gateway to a VPC, enabling
        connectivity between the internet and the
        VPC. For more information, see `Internet
        gateways <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Internet_Gateway.html>`_ in the *Amazon VPC User Guide*.
...
class VolumeManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"

    def create(self, model: "Volume", ClientToken: "str | None" = None) -> "Volume":
        """
        Creates an EBS volume that can be attached to an instance in the same
        Availability Zone.

        Args:
            model: The :py:class:`Volume` to create.

        Keyword Args:
            ClientToken: Unique, case-sensitive identifier that you provide to ensure
                the idempotency of the request. For more
                information, see `Ensure Idempotency <https://docs.aws.amazon.com/ec2/latest/devguide/ec2-api-idempotency.html>`_.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
            AvailabilityZone=data.get("AvailabilityZone"),
            AvailabilityZoneId=data.get("AvailabilityZoneId"),
            ...
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "volume"))
            ),
            MultiAttachEnabled=data.get("MultiAttachEnabled"),
            Throughput=data.get("Throughput"),
            ClientToken=self.serialize(ClientToken),
            VolumeInitializationRate=data.get("VolumeInitializationRate"),
            Operator=data.get("Operator"),
            DryRun=data.get("DryRun"),
        )
        _response = self.client.create_volume(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = Volume(**_response)

        self.sessionize(response)
        return cast("Volume", response)
    ...
    def get(
        ...
        *,
        ...
        """
        args: dict[str, Any] = dict(
            VolumeIds=self.serialize([VolumeId]),
            IncludeManagedResources=self.serialize(IncludeManagedResources),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.describe_volumes(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeVolumesResult(**_response)

        if response and response.Volumes:
            self.sessionize(response.Volumes[0])
    ...
    def list(
        self,
        *,
        VolumeIds: "builtins.list[str] | None" = None,
        IncludeManagedResources: "bool | None" = None,
        DryRun: bool = False,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        ...
        Keyword Args:
            VolumeIds: The volume IDs. If not specified, then all volumes are included
                in the response.
            IncludeManagedResources: Indicates whether to include managed resources in
                the output. If this parameter is set to
                ``true``, the output includes resources that are managed by Amazon Web
        ...
        args: dict[str, Any] = dict(
            VolumeIds=self.serialize(VolumeIds),
            IncludeManagedResources=self.serialize(IncludeManagedResources),
            DryRun=self.serialize(DryRun),
            Filters=self.serialize(Filters),
        )
    ...
    def delete(self, VolumeId: str, *, DryRun: bool = False) -> None:
        """
        ...
        """
        args: dict[str, Any] = dict(
            VolumeId=self.serialize(VolumeId), DryRun=self.serialize(DryRun)
        )
        self.client.delete_volume(**{k: v for k, v in args.items() if v is not None})

    def update(
        self, model: "Volume", DryRun: "bool | None" = None
        ...
        might be able to apply these changes without
        stopping the instance or detaching the volume from it. For more information
        about modifying EBS volumes, see `Amazon EBS
        Elastic Volumes <https://docs.aws.amazon.com/ebs/latest/userguide/ebs-modify-volume.html>`_ in the *Amazon EBS User
        Guide*.

        Args:
            model: The :py:class:`Volume` to update.
        ...
        _response = self.client.modify_volume(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ModifyVolumeResult(**_response)

        self.sessionize(response.VolumeModification)
        return cast("EC2VolumeModification", response.VolumeModification)
    ...
    def attach(
        ...
        *,
        ...
        Args:
            ...
            InstanceId: The ID of the instance.
            VolumeId: The ID of the EBS volume. The volume and instance must be within
                the same Availability Zone.

        Keyword Args:
            EbsCardIndex: The index of the EBS card. Some instance types support
                multiple EBS cards. The default EBS card index
                is 0.
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
        ...
        """
        args: dict[str, Any] = dict(
            Device=self.serialize(Device),
            InstanceId=self.serialize(InstanceId),
            VolumeId=self.serialize(VolumeId),
            EbsCardIndex=self.serialize(EbsCardIndex),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.attach_volume(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = VolumeAttachment(**_response)

        results: "VolumeAttachment" = None
        if response is not None:
            results = response

        self.sessionize(results)
        return cast("VolumeAttachment", results)
    ...
    def detach(
        ...
        *,
        ...
        stuck in the ``busy`` state while
        detaching. If this happens, detachment can be delayed indefinitely until you
        unmount the volume, force detachment,
        reboot the instance, or all three. If an EBS volume is the root device of an
        instance, it can't be detached while the
        ...
        Keyword Args:
            ...
            Force: Forces detachment if the previous detachment attempt did not occur
                cleanly (for example, logging into an
                instance, unmounting the volume, and detaching normally). This option
                can lead to data loss or a corrupted file
                system. Use this option only as a last resort to detach a volume from a
                failed instance. The instance won't have an
                opportunity to flush file system caches or file system metadata. If you
                use this option, you must perform file
                system check and repair procedures.
            InstanceId: The ID of the instance. If you are detaching a Multi-Attach
                enabled volume, you must specify an instance
                ID.
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
        ...
        _response = self.client.detach_volume(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = VolumeAttachment(**_response)
...
class RouteTableManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"

    def create(
        self, model: "RouteTable", ClientToken: "str | None" = None
    ) -> "RouteTable":
        """
        ...
        Args:
            model: The :py:class:`RouteTable` to create.
        ...
        args = dict(
            VpcId=data.get("VpcId"),
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "route-table"))
            ),
            ClientToken=self.serialize(ClientToken),
            DryRun=data.get("DryRun"),
        )
        _response = self.client.create_route_table(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateRouteTableResult(**_response)

        self.sessionize(response.RouteTableInstance)
        return cast("RouteTable", response.RouteTableInstance)

    def get(self, RouteTableId: str, *, DryRun: bool = False) -> "RouteTable | None":
        """
        Describes your route tables.

        The default is to describe all your route tables. Alternatively, you can specify
        specific route table IDs or filter the results to include only the route tables
        that match specific criteria.
        ...
        """
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun), RouteTableIds=self.serialize([RouteTableId])
        )
        _response = self.client.describe_route_tables(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeRouteTablesResult(**_response)

        if response and response.RouteTables:
            self.sessionize(response.RouteTables[0])
    ...
    def list(
        ...
        *,
        DryRun: bool = False,
        RouteTableIds: "builtins.list[str] | None" = None,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes your route tables.
        ...
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun),
            RouteTableIds=self.serialize(RouteTableIds),
            Filters=self.serialize(Filters),
        )
        response_iterator = paginator.paginate(
            **{k: v for k, v in args.items() if v is not None}
        ...
        for _response in response_iterator:
            ...
            if response.RouteTables:
                results.extend(response.RouteTables)
            else:
                if getattr(response, "NextToken", None):
                    continue
                break
    ...
    def delete(self, RouteTableId: str, *, DryRun: bool = False) -> None:
        """
        ...
        """
        args: dict[str, Any] = dict(
            RouteTableId=self.serialize(RouteTableId), DryRun=self.serialize(DryRun)
        )
    ...
    def create_route(
        ...
        *,
        ...
        Keyword Args:
            DestinationPrefixListId: The ID of a prefix list used for the destination
                match.
            ...
            DryRun: Checks whether you have the required permissions for the action,
                ...
                error response is ``DryRunOperation``.
                Otherwise, it is ``UnauthorizedOperation``.
            DestinationCidrBlock: The IPv4 CIDR address block used for the destination
                match. Routing decisions are based on the
            ...
            DestinationIpv6CidrBlock: The IPv6 CIDR block used for the destination
                match. Routing decisions are based on the
                most specific match.
            EgressOnlyInternetGatewayId: [IPv6 traffic only] The ID of an egress-only
                internet gateway.
            InstanceId: The ID of a NAT instance in your VPC. The operation fails if you
                specify an instance ID unless exactly
        ...
        """
        args: dict[str, Any] = dict(
            RouteTableId=self.serialize(RouteTableId),
            DestinationPrefixListId=self.serialize(DestinationPrefixListId),
            VpcEndpointId=self.serialize(VpcEndpointId),
            TransitGatewayId=self.serialize(TransitGatewayId),
            LocalGatewayId=self.serialize(LocalGatewayId),
            CarrierGatewayId=self.serialize(CarrierGatewayId),
            CoreNetworkArn=self.serialize(CoreNetworkArn),
            OdbNetworkArn=self.serialize(OdbNetworkArn),
            DryRun=self.serialize(DryRun),
            DestinationCidrBlock=self.serialize(DestinationCidrBlock),
            GatewayId=self.serialize(GatewayId),
            DestinationIpv6CidrBlock=self.serialize(DestinationIpv6CidrBlock),
            EgressOnlyInternetGatewayId=self.serialize(EgressOnlyInternetGatewayId),
            InstanceId=self.serialize(InstanceId),
            NetworkInterfaceId=self.serialize(NetworkInterfaceId),
            VpcPeeringConnectionId=self.serialize(VpcPeeringConnectionId),
            NatGatewayId=self.serialize(NatGatewayId),
        )
        _response = self.client.create_route(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateRouteResult(**_response)
        ...
        *,
        ...
        Keyword Args:
            ...
            DestinationCidrBlock: The IPv4 CIDR range for the route. The value you
                specify must match the CIDR for the route
                exactly.
            DestinationIpv6CidrBlock: The IPv6 CIDR range for the route. The value you
                specify must match the CIDR for the route
                exactly.
        """
        args: dict[str, Any] = dict(
        ...
        self.client.delete_route(**{k: v for k, v in args.items() if v is not None})
    ...
    def replace_route(
        ...
        *,
        ...
        Keyword Args:
            ...
            VpcEndpointId: The ID of a VPC endpoint. Supported for Gateway Load Balancer
                endpoints only.
            LocalTarget: Specifies whether to reset the local route to its default
                target (``local``).
            TransitGatewayId: The ID of a transit gateway.
            LocalGatewayId: The ID of the local gateway.
            ...
            DryRun: Checks whether you have the required permissions for the action,
                ...
                Otherwise, it is ``UnauthorizedOperation``.
            DestinationCidrBlock: The IPv4 CIDR address block used for the destination
                match. The value that you provide must
            ...
            DestinationIpv6CidrBlock: The IPv6 CIDR address block used for the
                destination match. The value that you provide
        ...
        args: dict[str, Any] = dict(
            ...
            DestinationPrefixListId=self.serialize(DestinationPrefixListId),
            VpcEndpointId=self.serialize(VpcEndpointId),
            LocalTarget=self.serialize(LocalTarget),
            TransitGatewayId=self.serialize(TransitGatewayId),
            LocalGatewayId=self.serialize(LocalGatewayId),
            CarrierGatewayId=self.serialize(CarrierGatewayId),
            CoreNetworkArn=self.serialize(CoreNetworkArn),
        ...
        self.client.replace_route(**{k: v for k, v in args.items() if v is not None})
    ...
    def associate(
        ...
        *,
        ...
        Keyword Args:
            ...
            PublicIpv4Pool: The ID of a public IPv4 pool. A public IPv4 pool is a pool
                of IPv4 addresses that you've brought to
                Amazon Web Services with BYOIP.
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
                error response is ``DryRunOperation``.
        ...
        args: dict[str, Any] = dict(
            RouteTableId=self.serialize(RouteTableId),
            GatewayId=self.serialize(GatewayId),
            PublicIpv4Pool=self.serialize(PublicIpv4Pool),
            DryRun=self.serialize(DryRun),
            SubnetId=self.serialize(SubnetId),
        )
        _response = self.client.associate_route_table(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = AssociateRouteTableResult(**_response)

        results: "AssociateRouteTableResult" = None
        if response is not None:
            results = response

        self.sessionize(results)
        return cast("AssociateRouteTableResult", results)

    def disassociate(self, AssociationId: str, *, DryRun: bool = False) -> None:
        """
        Disassociates a subnet or gateway from a route table.

        Args:
            AssociationId: The association ID representing the current association
                between the route table and subnet or
                gateway.
        ...
        """
        args: dict[str, Any] = dict(
            AssociationId=self.serialize(AssociationId), DryRun=self.serialize(DryRun)
        )
...
class NatGatewayManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"
    ...
    def create(
        ...
        model: "NatGateway",
        ClientToken: "str | None" = None,
        AvailabilityZoneAddresses: "builtins.list[AvailabilityZoneAddress] | None" = None,
        PrivateIpAddress: "str | None" = None,
        SecondaryAllocationIds: "builtins.list[str] | None" = None,
        SecondaryPrivateIpAddresses: "builtins.list[str] | None" = None,
        SecondaryPrivateIpAddressCount: "int | None" = None,
    ) -> "NatGateway":
        """
        ...
        public NAT gateway or a private NAT
        gateway.

        Args:
            model: The :py:class:`NatGateway` to create.

        Keyword Args:
            ClientToken: Unique, case-sensitive identifier that you provide to ensure
                the idempotency of the request. For more
                information, see `Ensuring idempotency <https://docs.aws.amazon.com/ec2/latest/devguide/ec2-api-idempotency.html>`_.
            AvailabilityZoneAddresses: For regional NAT gateways only: Specifies which
                Availability Zones you want the NAT
                gateway to support and the Elastic IP addresses (EIPs) to use in each
                AZ. The regional NAT gateway uses these EIPs
                to handle outbound NAT traffic from their respective AZs. If not
                specified, the NAT gateway will automatically
                expand to new AZs and associate EIPs upon detection of an elastic
                network interface. If you specify this parameter,
                auto-expansion is disabled and you must manually manage AZ coverage.
            PrivateIpAddress: The private IPv4 address to assign to the NAT gateway. If
                you don't provide an address, a private
                IPv4 address will be automatically assigned.
            SecondaryAllocationIds: Secondary EIP allocation IDs. For more information,
                see `Create a NAT gateway
                <https://docs.aws.amazon.com/vpc/latest/userguide/nat-gateway-working-with.html>`_ in the *Amazon VPC User Guide*.
            SecondaryPrivateIpAddresses: Secondary private IPv4 addresses. For more
                information about secondary addresses, see
                `Create a NAT gateway <https://docs.aws.amazon.com/vpc/latest/userguide/nat-gateway-working-with.html>`_ in the
                *Amazon VPC User Guide*.
            SecondaryPrivateIpAddressCount: `Private NAT gateway only] The number of
                secondary private IPv4 addresses you want
                to assign to the NAT gateway. For more information about secondary
        ...
        args = dict(
            ...
            SubnetId=data.get("SubnetId"),
            VpcId=data.get("VpcId"),
            AvailabilityZoneAddresses=self.serialize(AvailabilityZoneAddresses),
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "natgateway"))
            ),
            ConnectivityType=data.get("ConnectivityType"),
            PrivateIpAddress=self.serialize(PrivateIpAddress),
            SecondaryAllocationIds=self.serialize(SecondaryAllocationIds),
            SecondaryPrivateIpAddresses=self.serialize(SecondaryPrivateIpAddresses),
            SecondaryPrivateIpAddressCount=self.serialize(
                SecondaryPrivateIpAddressCount
            ),
        )
        _response = self.client.create_nat_gateway(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateNatGatewayResult(**_response)

        self.sessionize(response.NatGatewayInstance)
        return cast("NatGateway", response.NatGatewayInstance)
    ...
    def get(
        ...
        *,
        DryRun: bool = False,
        Filter: "builtins.list[Filter] | None" = None,
    ) -> "NatGateway | None":
        """
        Describes your NAT gateways.

        The default is to describe all your NAT gateways. Alternatively, you can specify
        specific NAT gateway IDs or filter the results to include only the NAT gateways
        that match specific criteria.
        ...
        args: dict[str, Any] = dict(
            ...
            NatGatewayIds=self.serialize([NatGatewayId]),
        )
        _response = self.client.describe_nat_gateways(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeNatGatewaysResult(**_response)

        if response and response.NatGateways:
            self.sessionize(response.NatGateways[0])
    ...
    def list(
        ...
        *,
        DryRun: bool = False,
        Filter: "builtins.list[Filter] | None" = None,
        NatGatewayIds: "builtins.list[str] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes your NAT gateways.
        ...
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun),
            Filter=self.serialize(Filter),
            NatGatewayIds=self.serialize(NatGatewayIds),
        )
        response_iterator = paginator.paginate(
            **{k: v for k, v in args.items() if v is not None}
        )
    ...
    def delete(self, NatGatewayId: str, *, DryRun: bool = False) -> "NatGateway":
        """
        ...
        any NAT gateway routes in your route
        tables.
        ...
        """
        args: dict[str, Any] = dict(
            NatGatewayId=self.serialize(NatGatewayId), DryRun=self.serialize(DryRun)
        )
        _response = self.client.delete_nat_gateway(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DeleteNatGatewayResult(**_response)
        return response

    def associate_address(
        self,
        NatGatewayId: str,
        AllocationIds: "builtins.list[str]",
        *,
        PrivateIpAddresses: "builtins.list[str] | None" = None,
        DryRun: bool = False,
        ...
        For more information, see `Work with NAT gateways <https://docs.aws.amazon.com/vpc/latest/userguide/nat-gateway-working-with.html>`_ in the *Amazon
        VPC User Guide*.

        Args:
            NatGatewayId: The ID of the NAT gateway.
            AllocationIds: The allocation IDs of EIPs that you want to associate with
                your NAT gateway.

        Keyword Args:
            PrivateIpAddresses: The private IPv4 addresses that you want to assign to
                the NAT gateway.
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
                error response is ``DryRunOperation``.
                Otherwise, it is ``UnauthorizedOperation``.
            AvailabilityZone: For regional NAT gateways only: The Availability Zone
                where you want to associate an Elastic IP
                address (EIP). The regional NAT gateway uses a separate EIP in each AZ
                to handle outbound NAT traffic from that AZ.
            AvailabilityZoneId: For regional NAT gateways only: The ID of the
                Availability Zone where you want to associate an
                Elastic IP address (EIP). The regional NAT gateway uses a separate EIP
                in each AZ to handle outbound NAT traffic
                from that AZ. Use this instead of AvailabilityZone for consistent
                identification of AZs across Amazon Web Services
                Regions.
        """
        args: dict[str, Any] = dict(
            NatGatewayId=self.serialize(NatGatewayId),
            AllocationIds=self.serialize(AllocationIds),
            PrivateIpAddresses=self.serialize(PrivateIpAddresses),
            DryRun=self.serialize(DryRun),
            AvailabilityZone=self.serialize(AvailabilityZone),
            AvailabilityZoneId=self.serialize(AvailabilityZoneId),
        )
        _response = self.client.associate_nat_gateway_address(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = AssociateNatGatewayAddressResult(**_response)

        results: "AssociateNatGatewayAddressResult" = None
        if response is not None:
            results = response

        self.sessionize(results)
        return cast("AssociateNatGatewayAddressResult", results)

    def disassociate_address(
        self,
        NatGatewayId: str,
        AssociationIds: "builtins.list[str]",
        *,
        MaxDrainDurationSeconds: "int | None" = None,
        DryRun: bool = False,
    ) -> "DisassociateNatGatewayAddressResult":
        """
        Disassociates secondary Elastic IP addresses (EIPs) from a public NAT gateway.

        You cannot disassociate your primary EIP. For more information, see `Edit secondary IP address associations <https://docs.aws.amazon.com/vpc/latest/userguide/nat-
        gateway-working-with.html#nat-gateway-edit-secondary>`_ in the *Amazon VPC User
        Guide*.

        Args:
            NatGatewayId: The ID of the NAT gateway.
            AssociationIds: The association IDs of EIPs that have been associated with
                the NAT gateway.

        Keyword Args:
            MaxDrainDurationSeconds: The maximum amount of time to wait (in seconds)
                before forcibly releasing the IP addresses
        ...
        args: dict[str, Any] = dict(
            NatGatewayId=self.serialize(NatGatewayId),
            AssociationIds=self.serialize(AssociationIds),
            MaxDrainDurationSeconds=self.serialize(MaxDrainDurationSeconds),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.disassociate_nat_gateway_address(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DisassociateNatGatewayAddressResult(**_response)

        results: "DisassociateNatGatewayAddressResult" = None
        if response is not None:
            results = response

        self.sessionize(results)
        return cast("DisassociateNatGatewayAddressResult", results)


class VpcPeeringConnectionManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"

    def create(self, model: "VpcPeeringConnection") -> "VpcPeeringConnection":
        """
        ...
        Args:
            model: The :py:class:`VpcPeeringConnection` to create.
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
            VpcId=data.get("VpcId"),
            PeerRegion=data.get("PeerRegion"),
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "vpc-peering-connection"))
            ),
            DryRun=data.get("DryRun"),
            PeerVpcId=data.get("PeerVpcId"),
            PeerOwnerId=data.get("PeerOwnerId"),
        )
        _response = self.client.create_vpc_peering_connection(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateVpcPeeringConnectionResult(**_response)

        self.sessionize(response.VpcPeeringConnectionInstance)
        return cast("VpcPeeringConnection", response.VpcPeeringConnectionInstance)

    def get(
        self, VpcPeeringConnectionId: str, *, DryRun: bool = False
    ) -> "VpcPeeringConnection | None":
        """
        Describes your VPC peering connections.

        The default is to describe all your VPC peering connections. Alternatively, you
        can specify specific VPC peering connection IDs or filter the results to include
        only the VPC peering connections that
        ...
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun),
            VpcPeeringConnectionIds=self.serialize([VpcPeeringConnectionId]),
        )
        _response = self.client.describe_vpc_peering_connections(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeVpcPeeringConnectionsResult(**_response)

        if response and response.VpcPeeringConnections:
            self.sessionize(response.VpcPeeringConnections[0])
    ...
    def list(
        ...
        *,
        DryRun: bool = False,
        VpcPeeringConnectionIds: "builtins.list[str] | None" = None,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes your VPC peering connections.
        ...
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun),
            VpcPeeringConnectionIds=self.serialize(VpcPeeringConnectionIds),
            Filters=self.serialize(Filters),
        )
        response_iterator = paginator.paginate(
            **{k: v for k, v in args.items() if v is not None}
        ...
        for _response in response_iterator:
            ...
            if response.VpcPeeringConnections:
                results.extend(response.VpcPeeringConnections)
            else:
                if getattr(response, "NextToken", None):
                    continue
                break
    ...
    def accept(
        ...
        To accept a request, the VPC peering connection must be in the ``pending-
        acceptance`` state, and you must be the owner of the peer VPC. Use
        DescribeVpcPeeringConnections to view your
        ...
        _response = self.client.accept_vpc_peering_connection(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = AcceptVpcPeeringConnectionResult(**_response)

        results: "VpcPeeringConnection" = None
        if response is not None:
            results = response.VpcPeeringConnectionInstance

        self.sessionize(results)
        return cast("VpcPeeringConnection", results)

    def reject(self, VpcPeeringConnectionId: str, *, DryRun: bool = False) -> bool:
        """
        ...
        connection requests. To delete an active
        ...
        _response = self.client.reject_vpc_peering_connection(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = RejectVpcPeeringConnectionResult(**_response)
    ...
    def delete(
        ...
        the requester VPC can delete a VPC peering
        connection in the ``pending-acceptance`` state. You cannot delete a VPC peering
        connection that's in the ``failed`` or
        ``rejected`` state.
        ...
        _response = self.client.delete_vpc_peering_connection(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DeleteVpcPeeringConnectionResult(**_response)
        return response
    ...
    def modify_options(
        ...
        *,
        AccepterPeeringConnectionOptions: "PeeringConnectionOptionsRequest | None" = None,
        DryRun: bool = False,
        RequesterPeeringConnectionOptions: "PeeringConnectionOptionsRequest | None" = None,
        ...
        Keyword Args:
            AccepterPeeringConnectionOptions: The VPC peering connection options for the
                accepter VPC.
            DryRun: Checks whether you have the required permissions for the action,
                without actually making the request, and
                provides an error response. If you have the required permissions, the
                error response is ``DryRunOperation``.
                Otherwise, it is ``UnauthorizedOperation``.
            RequesterPeeringConnectionOptions: The VPC peering connection options for
                the requester VPC.
        """
        args: dict[str, Any] = dict(
            VpcPeeringConnectionId=self.serialize(VpcPeeringConnectionId),
            AccepterPeeringConnectionOptions=self.serialize(
                AccepterPeeringConnectionOptions
            ),
            DryRun=self.serialize(DryRun),
            RequesterPeeringConnectionOptions=self.serialize(
                RequesterPeeringConnectionOptions
            ),
        )
        _response = self.client.modify_vpc_peering_connection_options(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ModifyVpcPeeringConnectionOptionsResult(**_response)

        results: "ModifyVpcPeeringConnectionOptionsResult" = None
        if response is not None:
            results = response

        self.sessionize(results)
        return cast("ModifyVpcPeeringConnectionOptionsResult", results)


class EC2VpcEndpointManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"
    ...
    def create(
        ...
        SecurityGroupIds: "builtins.list[str] | None" = None,
        ClientToken: "str | None" = None,
        SubnetConfigurations: "builtins.list[SubnetConfiguration] | None" = None,
    ) -> "EC2VpcEndpoint":
        """
        ...
        Web Services, an Amazon Web Services Marketplace
        Partner, or another Amazon Web Services account. For more information, see the
        `Amazon Web Services PrivateLink User
        Guide <https://docs.aws.amazon.com/vpc/latest/privatelink/>`_.

        Args:
            model: The :py:class:`VpcEndpoint` to create.

        Keyword Args:
            SecurityGroupIds: (Interface endpoint) The IDs of the security groups to
                associate with the endpoint network
                interfaces. If this parameter is not specified, we use the default
                security group for the VPC.
            ClientToken: Unique, case-sensitive identifier that you provide to ensure
                the idempotency of the request. For more
                information, see `How to ensure idempotency <https://docs.aws.amazon.com/ec2/latest/devguide/ec2-api-
                idempotency.html>`_.
        ...
        args = dict(
            VpcId=data.get("VpcId"),
            DryRun=data.get("DryRun"),
            VpcEndpointType=data.get("VpcEndpointType"),
            ServiceName=data.get("ServiceName"),
            PolicyDocument=data.get("PolicyDocument"),
            RouteTableIds=data.get("RouteTableIds"),
            SubnetIds=data.get("SubnetIds"),
            SecurityGroupIds=self.serialize(SecurityGroupIds),
            IpAddressType=data.get("IpAddressType"),
            DnsOptions=data.get("DnsOptions"),
            ClientToken=self.serialize(ClientToken),
            PrivateDnsEnabled=data.get("PrivateDnsEnabled"),
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "vpc-endpoint"))
            ),
            SubnetConfigurations=self.serialize(SubnetConfigurations),
            ServiceNetworkArn=data.get("ServiceNetworkArn"),
            ResourceConfigurationArn=data.get("ResourceConfigurationArn"),
            ServiceRegion=data.get("ServiceRegion"),
        )
        _response = self.client.create_vpc_endpoint(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateVpcEndpointResult(**_response)

        self.sessionize(response.VpcEndpointInstance)
        return cast("EC2VpcEndpoint", response.VpcEndpointInstance)

    def get(
        self, VpcEndpointId: str, *, DryRun: bool = False
    ) -> "EC2VpcEndpoint | None":
        """
        Describes your VPC endpoints.

        The default is to describe all your VPC endpoints. Alternatively, you can
        specify specific VPC endpoint IDs or filter the results to include only the VPC
        ...
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun),
            VpcEndpointIds=self.serialize([VpcEndpointId]),
        )
        _response = self.client.describe_vpc_endpoints(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeVpcEndpointsResult(**_response)
    ...
    def list(
        ...
        *,
        DryRun: bool = False,
        VpcEndpointIds: "builtins.list[str] | None" = None,
        Filters: "builtins.list[Filter] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes your VPC endpoints.
        ...
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun),
            VpcEndpointIds=self.serialize(VpcEndpointIds),
            Filters=self.serialize(Filters),
        )
        response_iterator = paginator.paginate(
            **{k: v for k, v in args.items() if v is not None}
    ...
    def delete(
        ...
        _response = self.client.delete_vpc_endpoints(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DeleteVpcEndpointsResult(**_response)
        return response
    ...
    def modify(
        ...
        *,
        DryRun: bool = False,
        ResetPolicy: "bool | None" = None,
        PolicyDocument: "str | None" = None,
        AddRouteTableIds: "builtins.list[str] | None" = None,
        RemoveRouteTableIds: "builtins.list[str] | None" = None,
        AddSubnetIds: "builtins.list[str] | None" = None,
        RemoveSubnetIds: "builtins.list[str] | None" = None,
        AddSecurityGroupIds: "builtins.list[str] | None" = None,
        RemoveSecurityGroupIds: "builtins.list[str] | None" = None,
        IpAddressType: "Literal['ipv4', 'dualstack', 'ipv6'] | None" = None,
        DnsOptions: "DnsOptionsSpecification | None" = None,
        ...
        Keyword Args:
            ...
            ResetPolicy: (Gateway endpoint) Specify ``true`` to reset the policy
                document to the default policy. The default
                policy allows full access to the service.
            PolicyDocument: (Interface and gateway endpoints) A policy to attach to the
                endpoint that controls access to the
                service. The policy must be in valid JSON format.
            AddRouteTableIds: (Gateway endpoint) The IDs of the route tables to
                associate with the endpoint.
            RemoveRouteTableIds: (Gateway endpoint) The IDs of the route tables to
                disassociate from the endpoint.
            AddSubnetIds: (Interface and Gateway Load Balancer endpoints) The IDs of the
                subnets in which to serve the endpoint.
                For a Gateway Load Balancer endpoint, you can specify only one subnet.
            RemoveSubnetIds: (Interface endpoint) The IDs of the subnets from which to
                remove the endpoint.
            AddSecurityGroupIds: (Interface endpoint) The IDs of the security groups to
                associate with the endpoint network
                interfaces.
            RemoveSecurityGroupIds: (Interface endpoint) The IDs of the security groups
                to disassociate from the endpoint
                network interfaces.
            IpAddressType: The IP address type for the endpoint.
            DnsOptions: The DNS options for the endpoint.
            PrivateDnsEnabled: (Interface endpoint) Indicates whether a private hosted
                zone is associated with the VPC.
            SubnetConfigurations: The subnet configurations for the endpoint.
        """
        args: dict[str, Any] = dict(
            VpcEndpointId=self.serialize(VpcEndpointId),
            DryRun=self.serialize(DryRun),
            ResetPolicy=self.serialize(ResetPolicy),
            PolicyDocument=self.serialize(PolicyDocument),
            AddRouteTableIds=self.serialize(AddRouteTableIds),
            RemoveRouteTableIds=self.serialize(RemoveRouteTableIds),
            AddSubnetIds=self.serialize(AddSubnetIds),
            RemoveSubnetIds=self.serialize(RemoveSubnetIds),
            AddSecurityGroupIds=self.serialize(AddSecurityGroupIds),
            RemoveSecurityGroupIds=self.serialize(RemoveSecurityGroupIds),
            IpAddressType=self.serialize(IpAddressType),
            DnsOptions=self.serialize(DnsOptions),
            PrivateDnsEnabled=self.serialize(PrivateDnsEnabled),
            SubnetConfigurations=self.serialize(SubnetConfigurations),
        )
        _response = self.client.modify_vpc_endpoint(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ModifyVpcEndpointResult(**_response)
...
class VpnConnectionManager(EC2TagsManagerMixin, Boto3ModelManager):
    service_name: str = "ec2"

    def create(
        self, model: "VpnConnection", PreSharedKeyStorage: "str | None" = None
    ) -> "VpnConnection":
        """
        ...
        Args:
            model: The :py:class:`VpnConnection` to create.

        Keyword Args:
            PreSharedKeyStorage: Specifies the storage mode for the pre-shared key
                (PSK). Valid values are ``Standard``" (stored
                in the Site-to-Site VPN service) or ``SecretsManager`` (stored in Amazon
                Web Services Secrets Manager).
        """
        data = model.model_dump(exclude_none=True, by_alias=True)
        args = dict(
            CustomerGatewayId=data.get("CustomerGatewayId"),
            Type=data.get("Type"),
            VpnGatewayId=data.get("VpnGatewayId"),
            TransitGatewayId=data.get("TransitGatewayId"),
            VpnConcentratorId=data.get("VpnConcentratorId"),
            TagSpecifications=self.serialize(
                self.serialize(self.convert_tags(model.Tags, "vpn-connection"))
            ),
            PreSharedKeyStorage=self.serialize(PreSharedKeyStorage),
            DryRun=data.get("DryRun"),
            Options=data.get("Options"),
        )
        _response = self.client.create_vpn_connection(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateVpnConnectionResult(**_response)

        self.sessionize(response.VpnConnectionInstance)
        return cast("VpnConnection", response.VpnConnectionInstance)

    def get(
        self, VpnConnectionId: str, *, DryRun: bool = False
    ) -> "VpnConnection | None":
        """
        ...
        """
        args: dict[str, Any] = dict(
            VpnConnectionIds=self.serialize([VpnConnectionId]),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.describe_vpn_connections(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeVpnConnectionsResult(**_response)

        if response and response.VpnConnections:
            self.sessionize(response.VpnConnections[0])
    ...
    def list(
        ...
        *,
        Filters: "builtins.list[Filter] | None" = None,
        VpnConnectionIds: "builtins.list[str] | None" = None,
        DryRun: bool = False,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes one or more of your VPN connections.
        ...
        args: dict[str, Any] = dict(
            Filters=self.serialize(Filters),
            VpnConnectionIds=self.serialize(VpnConnectionIds),
            DryRun=self.serialize(DryRun),
        )
        _response = self.client.describe_vpn_connections(
            **{k: v for k, v in args.items() if v is not None}
        ...
        response = DescribeVpnConnectionsResult(**_response)
        if response and response.VpnConnections:
            self.sessionize(response.VpnConnections)
            return PrimaryBoto3ModelQuerySet(response.VpnConnections)
        return PrimaryBoto3ModelQuerySet([])

    def delete(self, VpnConnectionId: str, *, DryRun: bool = False) -> None:
        """
        ...
        """
        args: dict[str, Any] = dict(
            VpnConnectionId=self.serialize(VpnConnectionId),
            DryRun=self.serialize(DryRun),
        )
        self.client.delete_vpn_connection(
            **{k: v for k, v in args.items() if v is not None}
        )
        ...
        *,
        ...
        Keyword Args:
            ...
            CustomerGatewayId: The ID of the customer gateway at your end of the VPN
                connection.
            VpnGatewayId: The ID of the virtual private gateway at the Amazon Web
        ...
        _response = self.client.modify_vpn_connection(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = ModifyVpnConnectionResult(**_response)

        results: "VpnConnection" = None
        if response is not None:
            results = response.VpnConnectionInstance

        self.sessionize(results)
        return cast("VpnConnection", results)


class FlowLogManager(Boto3ModelManager):
    service_name: str = "ec2"
    ...
    def create(
        ...
        Args:
            model: The :py:class:`FlowLog` to create.
        ...
        args = dict(
            ...
            DryRun=data.get("DryRun"),
            ClientToken=self.serialize(ClientToken),
            DeliverLogsPermissionArn=data.get("DeliverLogsPermissionArn"),
            DeliverCrossAccountRole=data.get("DeliverCrossAccountRole"),
            LogGroupName=data.get("LogGroupName"),
            TrafficType=data.get("TrafficType"),
            LogDestinationType=data.get("LogDestinationType"),
            LogDestination=data.get("LogDestination"),
            LogFormat=data.get("LogFormat"),
            TagSpecifications=self.serialize(TagSpecifications),
            MaxAggregationInterval=data.get("MaxAggregationInterval"),
            DestinationOptions=data.get("DestinationOptions"),
        )
        _response = self.client.create_flow_logs(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = CreateFlowLogsResult(**_response)

        self.sessionize(response)
        return cast("CreateFlowLogsResult", response)

    def delete(self, FlowLogId: str, *, DryRun: bool = False) -> "DeleteFlowLogsResult":
        """
        ...
        """
        args: dict[str, Any] = dict(
            FlowLogIds=self.serialize([FlowLogId]), DryRun=self.serialize(DryRun)
        )
        _response = self.client.delete_flow_logs(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DeleteFlowLogsResult(**_response)
        return response

    def get(self, FlowLogId: str, *, DryRun: bool = False) -> "FlowLog | None":
        """
        ...
        """
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun), FlowLogIds=self.serialize([FlowLogId])
        )
        _response = self.client.describe_flow_logs(
            **{k: v for k, v in args.items() if v is not None}
        )
        response = DescribeFlowLogsResult(**_response)

        if response and response.FlowLogs:
            self.sessionize(response.FlowLogs[0])
            return response.FlowLogs[0]
        return None
    ...
    def list(
        ...
        *,
        DryRun: bool = False,
        Filter: "builtins.list[Filter] | None" = None,
        FlowLogIds: "builtins.list[str] | None" = None,
    ) -> PrimaryBoto3ModelQuerySet:
        """
        Describes one or more flow logs.
        ...
        args: dict[str, Any] = dict(
            DryRun=self.serialize(DryRun),
            Filter=self.serialize(Filter),
            FlowLogIds=self.serialize(FlowLogIds),
        )
        response_iterator = paginator.paginate(
            **{k: v for k, v in args.items() if v is not None}
        )
...
class VpcIpv6CidrBlockAssociation(Boto3Model):
    ...
    ``byoip`` or ``amazon`` indicates public IP address space allocated by Amazon or
    space that you have allocated with Bring your own IP (BYOIP). ``none`` indicates
    private space.
    """
...
class Vpc(TagsDictMixin, VpcModelMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = VpcManager
    CidrBlock: str
    """
    ...
    Ipv6CidrBlockAssociationSet: "builtins.list[VpcIpv6CidrBlockAssociation]" = Field(
    ...
    CidrBlockAssociationSet: "builtins.list[VpcCidrBlockAssociation]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`VpcId` attribute.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`self.tags["Name"] if "Name" in self.tags else
        None` attribute.
...
class Subnet(TagsDictMixin, SubnetModelMixin, PrimaryBoto3Model):
    ...
    """
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = SubnetManager
    ...
    Ipv6CidrBlockAssociationSet: "builtins.list[SubnetIpv6CidrBlockAssociation]" = (
    ...
    about Amazon EVS, see  `*Amazon Elastic VMware Service API
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`SubnetId` attribute.
    ...
    def arn(self) -> str | None:
        ...
        This is the value of the :py:attr:`SubnetArn` attribute.
...
Numbers <http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml>`_).
    ...
    UserIdGroupPairs: "builtins.list[UserIdGroupPair] | None" = Field(
    ...
    IpRanges: "builtins.list[IpRange] | None" = Field(default_factory=list)
    """
    The IPv4 address ranges.
    """

    Ipv6Ranges: "builtins.list[Ipv6Range] | None" = Field(default_factory=list)
    """
    The IPv6 address ranges.
    """
    PrefixListIds: "builtins.list[PrefixListId] | None" = Field(default_factory=list)
    """
    The prefix list IDs.
    """
...
class SecurityGroup(TagsDictMixin, SecurityGroupModelMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = SecurityGroupManager
    ...
    IpPermissions: "builtins.list[IpPermission] | None" = Field(default_factory=list)
    """
    The inbound rules associated with the security group.
    """

    IpPermissionsEgress: "builtins.list[IpPermission] | None" = Field(
        default_factory=list
    )
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`GroupId` attribute.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`GroupName` attribute.
...
class NetworkAcl(TagsDictMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = NetworkAclManager

    Associations: "builtins.list[NetworkAclAssociation]" = Field(
        default_factory=list, frozen=True
    )
    """
    Any associations between the network ACL and your subnets.
    """
    Entries: "builtins.list[NetworkAclEntry]" = Field(default_factory=list, frozen=True)
    """
    ...
    Tags: "builtins.list[Tag]" = Field(default_factory=list, frozen=True)
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`NetworkAclId` attribute.
...
class EbsBlockDevice(Boto3Model):
    ...
    For more information, see `Preserving Amazon EBS volumes on instance termination <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/terminating-
    ...
    For ``gp3``, ``io1``, and ``io2`` volumes, this represents the number of IOPS that
    ...
    `Amazon EBS encryption <https://docs.aws.amazon.com/ebs/latest/userguide/ebs-encryption.html#encryption-parameters>`_
    in the *Amazon
    EBS User Guide*.
    """
...
class AMI(TagsDictMixin, AMIModelMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = AMIManager
    ...
    The value is ``true`` if this image has public launch permissions or ``false`` if it
    ...
    ``usageOperation`` corresponds to the `lineitem/Operation
    <https://docs.aws.amazon.com/cur/latest/userguide/Lineitem-columns.html#Lineitem-
    details-O-Operation>`_ column on your Amazon Web Services Cost and Usage Report and
    in the
    `Amazon Web Services Price List API <https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/price-changes.html>`_.
    You can view these fields on the    **Instances** or **AMIs** pages in the Amazon
    EC2 console, or in the responses that are returned by the
    `DescribeImages <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeImages.html>`_
    command in the Amazon
    EC2 API, or the `describe-images <https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-images.html>`_ command in
    the CLI.
    """

    ProductCodes: "builtins.list[ProductCode]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    If the state is ``available``, the image is successfully registered and can be used
    ...
    *YYYY*-*MM*-*DD*T*HH*:*MM*:*SS*Z.
    ...
    Instances launched from this AMI will have ``HttpTokens`` automatically set to
    ...
    `Configure the AMI <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/configuring-IMDS-new-instances.html#configure-IMDS-new-
    instances-ami-configuration>`_ in the *Amazon EC2 User Guide*.
    """

    BlockDeviceMappings: "builtins.list[EC2BlockDeviceMapping] | None" = Field(
        default_factory=list
    )
    """
...
an EC2 instance. When the AMI is used to launch an instance, there is a 24-hour delay
before that usage is reported.
    ...
    If ``false`` and Allowed AMIs is set to ``enabled``, the AMI can't be discovered or
    used in the account. If ``false`` and Allowed AMIs is set to ``audit-mode``, the AMI
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`ImageId` attribute.
...
class OperatorResponse(Boto3Model):
    ...
    HiddenByDefault: "bool | None" = None
    """
...
class InstanceNetworkInterface(Boto3Model):
    ...
    Groups: "builtins.list[GroupIdentifier] | None" = Field(default_factory=list)
    """
    The security groups.
    """
    Ipv6Addresses: "builtins.list[InstanceIpv6Address] | None" = Field(
        default_factory=list
    )
    """
    ...
    PrivateIpAddresses: "builtins.list[InstancePrivateIpAddress] | None" = Field(
        default_factory=list
    )
    """
    ...
    Ipv4Prefixes: "builtins.list[InstanceIpv4Prefix] | None" = Field(
        default_factory=list
    )
    """
    ...
    Ipv6Prefixes: "builtins.list[InstanceIpv6Prefix] | None" = Field(
        default_factory=list
    )
    """
...
class EC2CpuOptions(Boto3Model):
    ...
    NestedVirtualization: "Literal['enabled', 'disabled'] | None" = None
    """
...
class CapacityReservationSpecificationResponse(Boto3Model):
    ...
    The action returns the ``capacityReservationPreference`` response element if the
    instance is configured to run in On-Demand capacity, or if it is configured in run
    in any ``open`` Capacity Reservation that has matching attributes (instance type,
    platform, Availability Zone). The action returns the ``capacityReservationTarget``
...
class InstanceMetadataOptionsResponse(Boto3Model):
    ...
    For more information, see
    `View tags for your EC2 instances using instance metadata <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/work-
    with-tags-in-IMDS.html>`_.
    """
...
class InstanceSecondaryInterfaceAttachment(Boto3Model):
    """
...
class InstanceSecondaryInterfacePrivateIpAddress(Boto3Model):
    """
    ...
    """
class InstanceSecondaryInterface(Boto3Model):
    """
    Describes a secondary interface attached to an instance.
    """

    Attachment: "InstanceSecondaryInterfaceAttachment | None" = None
    """
    ...
    """
    PrivateIpAddresses: "builtins.list[InstanceSecondaryInterfacePrivateIpAddress] | None" = Field(
        default_factory=list
    )
    """
    ...
    Status: "Literal['available', 'in-use'] | None" = None
    """
    ...
    InterfaceType: "Literal['secondary'] | None" = None
    """
...
class Instance(TagsDictMixin, InstanceModelMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = InstanceManager
    Tags: "builtins.list[Tag] | None" = Field(default_factory=list)
    """
    Any tags assigned to the instance.
    """

    Tunnels: "dict[str, builtins.list[dict[str, Any]]] | None" = Field(
    ...
    BlockDeviceMappings: "builtins.list[InstanceBlockDeviceMapping] | None" = Field(
        default_factory=list
    )
    """
    ...
    """
    ElasticGpuAssociations: "builtins.list[ElasticGpuAssociation]" = Field(
        default_factory=list, frozen=True
    )
    """
    Deprecated.
    ...
    ElasticInferenceAcceleratorAssociations: "builtins.list[ElasticInferenceAcceleratorAssociation]" = Field(
        default_factory=list, frozen=True
    )
    """
    Deprecated.
    ...
    NetworkInterfaces: "builtins.list[InstanceNetworkInterface] | None" = Field(
        default_factory=list
    )
    """
    ...
    """
    SecurityGroups: "builtins.list[GroupIdentifier] | None" = Field(
        default_factory=list
    )
    """
    ...
    Licenses: "builtins.list[LicenseConfiguration]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    If the value is ``uefi-preferred``, the AMI supports both UEFI and Legacy BIOS. The
    ...
    SecondaryInterfaces: "builtins.list[InstanceSecondaryInterface] | None" = Field(
        default_factory=list
    )
    """
    ...
    This name is not available until the instance enters the ``running`` state. This
    name is only available if you've enabled DNS hostnames for your VPC. The format of
    this name depends on the
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`InstanceId` attribute.
            ...
            pk = OrderedDict(
                {
                    "GroupIds": [
                        ...
                        for identifier in cast(
                            "builtins.list[GroupIdentifier]", self.SecurityGroups
                        )
                    ],
                }
            )
    ...
    @cached_property
    def instance_type(self) -> "EC2InstanceType | None":
        """
...
class LaunchTemplate(TagsDictMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = LaunchTemplateManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`LaunchTemplateId` attribute.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`LaunchTemplateName` attribute.
    ...
    @cached_property
    def default_version(self) -> "LaunchTemplateVersion | None":
        """
    ...
    @cached_property
    def latest_version(self) -> "LaunchTemplateVersion | None":
        """
...
class LaunchTemplateInstanceNetworkInterfaceSpecification(Boto3Model):
    ...
    Groups: "builtins.list[str] | None" = Field(default_factory=list)
    """
    ...
    PrivateIpAddresses: "builtins.list[PrivateIpAddressSpecification] | None" = Field(
        default_factory=list
    )
    """
    ...
    Ipv4Prefixes: "builtins.list[Ipv4PrefixSpecificationResponse] | None" = Field(
        default_factory=list
    )
    """
    One or more IPv4 prefixes assigned to the network interface.
    ...
    Ipv6Prefixes: "builtins.list[Ipv6PrefixSpecificationResponse] | None" = Field(
        default_factory=list
    )
    """
    One or more IPv6 prefixes assigned to the network interface.
...
class LaunchTemplateSpotMarketOptions(Boto3Model):
    ...
    price. If you do specify this parameter, it must be more than USD $0.001. Specifying
    a value below USD $0.001 will result in an ``InvalidParameterValue`` error message
...
class LaunchTemplateInstanceMetadataOptions(Boto3Model):
    ...
    For more information, see
    `View tags for your EC2 instances using instance metadata <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/work-with-tags-in-IMDS.html>`_.
    """
...
class CpuPerformanceFactor(Boto3Model):
    ...
    References: "builtins.list[PerformanceFactorReference] | None" = Field(
        default_factory=list
    )
    """
    Specify an instance family to use as the baseline reference for CPU performance.
...
class EC2BaselinePerformanceFactors(Boto3Model):
    ...
    factor. For example, specifying ``c6i`` would use the CPU performance of the ``c6i``
...
class LaunchTemplateInstanceRequirements(Boto3Model):
    ...
    * ``AllowedInstanceTypes`` - The instance types to include in the list. All other
    instance types are ignored, even if
    ...
    * ``ExcludedInstanceTypes`` - The instance types to exclude from the list, even if
    ...
    groups, EC2 Fleet, and Spot Fleet to
    ...
    type-selection.html>`_ in the *Amazon EC2 Auto Scaling User Guide*, and also
    ...
    CpuManufacturers: "builtins.list[Literal['intel', 'amd', 'amazon-web-services', 'apple']] | None" = Field(
        default_factory=list
    )
    """
    ...
    AcceleratorTypes: "builtins.list[Literal['gpu', 'fpga', 'inference', 'media']] | None" = Field(
        default_factory=list
    )
    """
    ...
    AcceleratorNames: "builtins.list[Literal['a100', 'inferentia', 'k520', 'k80', 'm60', 'radeon-pro-v520', 't4', 'vu9p', 'v100', 'a10g', 'h100', 't4g', 'l40s', 'l4', 'gaudi-hl-205', 'inferentia2', 'trainium', 'trainium2', 'u30']] | None" = Field(
        default_factory=list
    )
    """
    ...
    The instance family establishes the lowest acceptable level of performance. Amazon
    EC2 uses this baseline to guide instance type selection, but there is
    no guarantee that the selected instance types will always exceed the baseline for
    every application. Currently, this
    ...
    selection.html#ec2fleet-abis-performance-protection>`_ in the *Amazon EC2 User
    Guide*.
    """
...
class LaunchTemplateNetworkPerformanceOptions(Boto3Model):
    ...
    default option uses the standard bandwidth configuration for your instance type.
    """
class SecondaryInterfacePrivateIpAddressSpecification(Boto3Model):
    """
    ...
    The private IPv4 address.
    """
class LaunchTemplateInstanceSecondaryInterfaceSpecification(Boto3Model):
    """
    ...
    PrivateIpAddresses: "builtins.list[SecondaryInterfacePrivateIpAddressSpecification] | None" = Field(
        default_factory=list
    )
    """
    The private IPv4 addresses to assign to the secondary interface.
    """
    PrivateIpAddressCount: "int | None" = None
    """
...
class ResponseLaunchTemplateData(Boto3Model):
    ...
    BlockDeviceMappings: "builtins.list[LaunchTemplateBlockDeviceMapping] | None" = (
        Field(default_factory=list)
    )
    """
    The block device mappings.
    """
    NetworkInterfaces: "builtins.list[LaunchTemplateInstanceNetworkInterfaceSpecification] | None" = Field(
        default_factory=list
    )
    """
    ...
    TagSpecifications: "builtins.list[LaunchTemplateTagSpecification] | None" = Field(
        default_factory=list
    )
    """
    The tags that are applied to the resources that are created during instance launch.
    """
    ElasticGpuSpecifications: "builtins.list[ElasticGpuSpecificationResponse] | None" = Field(
        default_factory=list
    )
    """
    Deprecated.
    ...
    ElasticInferenceAccelerators: "builtins.list[LaunchTemplateElasticInferenceAcceleratorResponse] | None" = Field(
        default_factory=list
    )
    """
    Amazon Elastic Inference is no longer available.
    ...
    LicenseSpecifications: "builtins.list[LaunchTemplateLicenseConfiguration] | None" = Field(
        default_factory=list
    )
    """
    ...
    SecondaryInterfaces: "builtins.list[LaunchTemplateInstanceSecondaryInterfaceSpecification] | None" = Field(
        default_factory=list
    )
    """
...
class LaunchTemplateVersion(PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = LaunchTemplateVersionManager
    ...
    @cached_property
    def launch_template(self) -> "LaunchTemplate | None":
        """
...
class NetworkInterfaceIpv6Address(Boto3Model):
    ...
    network interface. For more information, see `EC2 instance hostnames, DNS names, and
    ...
    When you enable an IPv6 GUA address to be a primary IPv6, the first IPv6 GUA will be
    made the primary IPv6 address until the instance is
...
class NetworkInterface(PrimaryBoto3Model):
    ...
    Describes a network interface.
    """
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = NetworkInterfaceManager
    ...
    Ipv6Addresses: "builtins.list[NetworkInterfaceIpv6Address] | None" = Field(
        default_factory=list
    )
    """
    The IPv6 addresses associated with the network interface.
    ...
    PrivateIpAddresses: "builtins.list[NetworkInterfacePrivateIpAddress] | None" = (
        Field(default_factory=list)
    )
    """
    The private IPv4 addresses associated with the network interface.
    ...
    Ipv4Prefixes: "builtins.list[Ipv4PrefixSpecification] | None" = Field(
        default_factory=list
    )
    """
    ...
    Ipv6Prefixes: "builtins.list[Ipv6PrefixSpecification] | None" = Field(
        default_factory=list
    )
    """
    ...
    TagSet: "builtins.list[Tag]" = Field(default_factory=list, frozen=True)
    """
    ...
    If the value is ``true``, inbound traffic from the internet is dropped and you
    cannot assign an elastic IP address to the network interface. The network interface
    is reachable from peered VPCs and resources connected through a transit gateway,
    ...
    AssociatedSubnets: "builtins.list[str]" = Field(default_factory=list, frozen=True)
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`NetworkInterfaceId` attribute.
            ...
            pk = OrderedDict(
                {
                    "GroupIds": [
                        identifier.GroupId
                        for identifier in cast(
                            "builtins.list[GroupIdentifier]", self.Groups
                        )
                    ],
                }
            )
    ...
    def reset(
        ...
        Keyword Args:
            DryRun: Checks whether you have the required permissions for the action,
                ...
                error response is ``DryRunOperation``.
                Otherwise, it is ``UnauthorizedOperation``.
            SourceDestCheck: The source/destination checking attribute. Resets the value
                to ``true``.
        """
        return (
...
class EC2ProcessorInfo(Boto3Model):
    ...
    SupportedArchitectures: "builtins.list[Literal['i386', 'x86_64', 'arm64', 'x86_64_mac', 'arm64_mac']] | None" = Field(
        default_factory=list
    )
    """
    ...
    SupportedFeatures: "builtins.list[Literal['amd-sev-snp', 'nested-virtualization']] | None" = Field(
        default_factory=list
    )
    """
    Indicates whether the instance type supports AMD SEV-SNP.

    If the request returns ``amd-sev-snp``, AMD SEV-SNP is supported. Otherwise, it is
    not supported. For more information, see  `AMD SEV- SNP
    <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/sev-snp.html>`_.
    """
...
class EC2VCpuInfo(Boto3Model):
    ...
    ValidCores: "builtins.list[int] | None" = Field(default_factory=list)
    """
    The valid number of cores that can be configured for the instance type.
    """
    ValidThreadsPerCore: "builtins.list[int] | None" = Field(default_factory=list)
    """
...
class EC2InstanceStorageInfo(Boto3Model):
    ...
    Disks: "builtins.list[DiskInfo] | None" = Field(default_factory=list)
    """
...
class EC2EbsInfo(Boto3Model):
    ...
    in the *Amazon EC2 User Guide*.
    """
    MaximumEbsCards: "int | None" = None
    """
    Indicates the number of EBS cards supported by the instance type.
    """

    EbsCards: "builtins.list[EbsCardInfo] | None" = Field(default_factory=list)
    """
...
class NetworkCardInfo(Boto3Model):
    ...
    AdditionalFlexibleNetworkInterfaces: "int | None" = None
    """
    The number of additional network interfaces that can be attached to an instance when
    using flexible Elastic Network Adapter (ENA) queues.

    This number is in addition to the base number specified by
...
class DefaultConnectionTrackingConfiguration(Boto3Model):
    """
    Indicates default conntrack information for the instance type.
    ...
    DefaultTcpEstablishedTimeout: "int | None" = None
    """
    Default timeout (in seconds) for idle TCP connections in an established state.
    """

    DefaultUdpTimeout: "int | None" = None
    """
    Default timeout (in seconds) for idle UDP flows that have seen traffic only in a
    single direction or a single request- response transaction.
    """

    DefaultUdpStreamTimeout: "int | None" = None
    """
    Default timeout (in seconds) for idle UDP flows classified as streams which have
...
class EC2NetworkInfo(Boto3Model):
    ...
    """
    NetworkCards: "builtins.list[NetworkCardInfo] | None" = Field(default_factory=list)
    """
    ...
    BandwidthWeightings: "builtins.list[Literal['default', 'vpc-1', 'ebs-1']] | None" = Field(
        default_factory=list
    )
    """
...
class GpuDeviceInfo(Boto3Model):
    ...
    LogicalGpuCount: "int | None" = None
    """
    Total number of GPU devices of this type.
    """

    GpuPartitionSize: "float | None" = None
    """
    The size of each GPU as a fraction of a full GPU, between 0 (excluded) and 1
    (included).
    """

    Workloads: "builtins.list[str] | None" = Field(default_factory=list)
    """
...
class EC2GpuInfo(Boto3Model):
    ...
    Gpus: "builtins.list[GpuDeviceInfo] | None" = Field(default_factory=list)
    """
    Describes the GPU accelerators for the instance type.
    """
...
class EC2FpgaInfo(Boto3Model):
    ...
    Fpgas: "builtins.list[FpgaDeviceInfo] | None" = Field(default_factory=list)
    """
    Describes the FPGAs for the instance type.
    """
...
class EC2PlacementGroupInfo(Boto3Model):
    ...
    SupportedStrategies: "builtins.list[Literal['cluster', 'partition', 'spread']] | None" = Field(
        default_factory=list
    )
    """
...
class EC2InferenceAcceleratorInfo(Boto3Model):
    ...
    Accelerators: "builtins.list[InferenceDeviceInfo] | None" = Field(
        default_factory=list
    )
    """
    Describes the Inference accelerators for the instance type.
...
class EC2NitroTpmInfo(Boto3Model):
    ...
    SupportedVersions: "builtins.list[str] | None" = Field(default_factory=list)
    """
...
class EC2MediaAcceleratorInfo(Boto3Model):
    ...
    Accelerators: "builtins.list[MediaDeviceInfo] | None" = Field(default_factory=list)
    """
    Describes the media accelerators for the instance type.
    """
...
class EC2NeuronInfo(Boto3Model):
    ...
    NeuronDevices: "builtins.list[NeuronDeviceInfo] | None" = Field(
        default_factory=list
    )
    """
    Describes the neuron accelerators for the instance type.
...
class EC2InstanceType(ReadonlyPrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = EC2InstanceTypeManager
    ...
    SupportedUsageClasses: "builtins.list[Literal['spot', 'on-demand', 'capacity-block']] | None" = Field(
        default_factory=list
    )
    """
    ...
    Blocks.
    """
    SupportedRootDeviceTypes: "builtins.list[Literal['ebs', 'instance-store']] | None" = Field(
        default_factory=list
    )
    """
    ...
    SupportedVirtualizationTypes: "builtins.list[Literal['hvm', 'paravirtual']] | None" = Field(
        default_factory=list
    )
    """
    ...
    SupportedBootModes: "builtins.list[Literal['legacy-bios', 'uefi']] | None" = Field(
        default_factory=list
    )
    """
    ...
    *Amazon EC2 User Guide*.
    ...
    SupportedInRegion: "bool | None" = None
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`InstanceType` attribute.
...
class TagSpecification(TagsDictMixin, Boto3Model):
    ...
    action you're using might not support tagging all of these resource types. If you
    try to tag a resource type that is unsupported for the action you're using, you'll
    get an error.
    """
...
class Snapshot(TagsDictMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = SnapshotManager
    ...
    ``standard`` indicates that the snapshot is stored in the standard snapshot storage
    tier and that it is ready for use. ``archive`` indicates that the snapshot is
    ...
    For example, ``us-west-1a`` (Availability Zone) or ``us- west-2-lax-1a`` (Local
    Zone).
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`SnapshotId` attribute.
...
class KeyPair(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a key pair.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = KeyPairManager
    Tags: "builtins.list[Tag] | None" = Field(default_factory=list)
    """
    Any tags applied to the key pair.
    """

    KeyPairId: str = Field(default=None, frozen=True)
    """
    ...
    KeyFingerprint: str = Field(default=None, frozen=True)
    """
* For RSA key pairs, the key fingerprint is the SHA-1 digest of the DER encoded private
key.
    """

    KeyMaterial: str = Field(default=None, frozen=True)
    """
    An unencrypted PEM encoded RSA or ED25519 private key.
    """

    KeyType: Literal["rsa", "ed25519"] = Field(default=None, frozen=True)
    """
    The type of key pair.
    """

    PublicKey: str = Field(default=None, frozen=True)
    """
...
was created, in `ISO 8601 date-
time format <https://www.iso.org/iso-8601-date-and-time-format.html>`_, in the UTC time zone.
    """
    @property
    def pk(self) -> str | None:
        """
        ...
        This is the value of the :py:attr:`KeyPairId` attribute.
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`KeyName` attribute.
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`KeyPairId` attribute.
        """
        return hash(self.KeyPairId)


class PlacementGroup(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a placement group.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = PlacementGroupManager
    ...
    State: Literal["pending", "available", "deleting", "deleted"] = Field(
        default=None, frozen=True
    )
    """
    The state of the placement group.
    """
    Strategy: "Literal['cluster', 'spread', 'partition'] | None" = None
    """
    The placement strategy.
    """

    PartitionCount: "int | None" = None
    """
    The number of partitions.

    Valid only if **strategy** is set to ``partition``.
    """
    ...
    GroupArn: str = Field(default=None, frozen=True)
    """
    The Amazon Resource Name (ARN) of the placement group.
    """

    SpreadLevel: "Literal['host', 'rack'] | None" = None
    """
    ...
    *Only* Outpost placement groups can be spread across hosts.
    ...
    def arn(self) -> str | None:
        ...
        This is the value of the :py:attr:`GroupArn` attribute.
...
class AttributeValue(Boto3Model):
    """
...
class DhcpConfiguration(Boto3Model):
    """
    ...
    Values: "builtins.list[AttributeValue] | None" = Field(default_factory=list)
    """
    The values for the DHCP option.
    """

class DhcpOptions(TagsDictMixin, PrimaryBoto3Model):
    """
    The set of DHCP options.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = DhcpOptionsManager
    ...
    DhcpConfigurations: "builtins.list[DhcpConfiguration] | None" = Field(
        default_factory=list
    )
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`DhcpOptionsId` attribute.

        Returns:
            The primary key of the model instance.
        """
        return self.DhcpOptionsId
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`DhcpOptionsId` attribute.
        """
        return hash(self.DhcpOptionsId)
class CustomerGateway(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a customer gateway.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = CustomerGatewayManager

    IpAddress: "str | None" = None
    """
    The IP address for the customer gateway device's outside interface.

    The address must be static. If ``OutsideIpAddressType`` in your VPN connection
    options is set to ``PrivateIpv4``, you can use an RFC6598 or RFC1918 private IPv4
    address. If ``OutsideIpAddressType`` is set to ``PublicIpv4``, you can use a public
    IPv4 address. If ``OutsideIpAddressType`` is set to ``Ipv6``, you can use a public
    IPv6 address.
    """

    BgpAsn: int | None = None
    """
    The customer gateway device's Border Gateway Protocol (BGP) Autonomous System Number
    (ASN).
    """

    BgpAsnExtended: int | None = None
    """
    The customer gateway device's Border Gateway Protocol (BGP) Autonomous System Number
    (ASN).
    """
    ...
    CustomerGatewayId: str = Field(default=None, frozen=True)
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`CustomerGatewayId` attribute.

        Returns:
            The primary key of the model instance.
        """
        return self.CustomerGatewayId
    @property
    def name(self) -> str | None:
        """
        Return the name of the model.
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`CustomerGatewayId` attribute.
        """
        return hash(self.CustomerGatewayId)


class EC2VpcAttachment(Boto3Model):
    """
    ...
    The ID of the VPC.
    """
    State: "Literal['attaching', 'attached', 'detaching', 'detached'] | None" = None
    """
    The current state of the attachment.
    """

class VpnGateway(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a virtual private gateway.
    """
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = VpnGatewayManager

    Tags: "builtins.list[Tag] | None" = Field(default_factory=list)
    """
    Any tags assigned to the virtual private gateway.
    """
    AmazonSideAsn: "int | None" = None
    """
    The private Autonomous System Number (ASN) for the Amazon side of a BGP session.
    """

    VpnGatewayId: str = Field(default=None, frozen=True)
    """
    ...
    Type: "Literal['ipsec.1'] | None" = None
    """
    ...
    """
    VpcAttachments: "builtins.list[EC2VpcAttachment]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`VpnGatewayId` attribute.

        Returns:
            The primary key of the model instance.
        """
        return self.VpnGatewayId
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`VpnGatewayId` attribute.
        """
        return hash(self.VpnGatewayId)

class InternetGatewayAttachment(Boto3Model):
    """
    ...
    For an internet gateway, the state is ``available`` when attached to a VPC;
    ...
    The ID of the VPC.
    """
class InternetGateway(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes an internet gateway.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = InternetGatewayManager
    ...
    Attachments: "builtins.list[InternetGatewayAttachment]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    InternetGatewayId: str = Field(default=None, frozen=True)
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`InternetGatewayId` attribute.
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`InternetGatewayId` attribute.
        """
        return hash(self.InternetGatewayId)


class VolumeAttachment(Boto3Model):
    """
    ...
    InstanceOwningService: "str | None" = None
    """
    ...
    State: "Literal['attaching', 'attached', 'detaching', 'detached', 'busy'] | None" = None
    """
    ...
    The time stamp when the attachment initiated.
    """
class Volume(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a volume.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = VolumeManager
    ...
    SourceVolumeId: str = Field(default=None, frozen=True)
    """
    ...
    FastRestored: bool = Field(default=None, frozen=True)
    """
    ...
    """
    The Amazon EBS Provisioned Rate for Volume Initialization (volume initialization
    rate) specified for the volume during creation, in MiB/s.

    If no volume initialization rate was specified, the value is ``null``.
    """

    VolumeId: str = Field(default=None, frozen=True)
    """
    The ID of the volume.
    """
    ...
    Attachments: "builtins.list[VolumeAttachment]" = Field(
        default_factory=list, frozen=True
    )
    """
    This parameter is not returned by CreateVolume.
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`VolumeId` attribute.
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`VolumeId` attribute.
        """
        return hash(self.VolumeId)


class RouteTableAssociationState(Boto3Model):
    """
    Describes the state of an association between a route table and a subnet or gateway.
    """
    State: "Literal['associating', 'associated', 'disassociating', 'disassociated', 'failed'] | None" = None
    """
...
class RouteTableAssociation(Boto3Model):
    """
    ...
    """
    RouteTableAssociationId: "str | None" = None
    """
    The ID of the association.
    """
    ...
    A public IPv4 pool is a pool of IPv4 addresses that you've brought to Amazon Web
    Services with BYOIP.
    """

    AssociationState: "RouteTableAssociationState | None" = None
    """
    The state of the association.
    """
class PropagatingVgw(Boto3Model):
    """
...
class Route(Boto3Model):
    ...
    The ID of the network interface.
    """
    Origin: "Literal['CreateRouteTable', 'CreateRoute', 'EnableVgwRoutePropagation', 'Advertisement'] | None" = None
    """
    Describes how the route was created.
    """

    State: "Literal['active', 'blackhole', 'filtered'] | None" = None
    """
    The state of the route.

    The ``blackhole`` state indicates that the route's target isn't available (for
    example, the specified gateway isn't attached to the VPC, or the specified NAT
    ...
    IpAddress: "str | None" = None
    """
    The next hop IP address for routes propagated by VPC Route Server into VPC route
    tables.
    """

class RouteTable(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a route table.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = RouteTableManager
    ...
    Associations: "builtins.list[RouteTableAssociation]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    PropagatingVgws: "builtins.list[PropagatingVgw]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    RouteTableId: str = Field(default=None, frozen=True)
    """
    The ID of the route table.
    """

    Routes: "builtins.list[Route]" = Field(default_factory=list, frozen=True)
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`RouteTableId` attribute.
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`RouteTableId` attribute.
        """
        return hash(self.RouteTableId)


class NatGatewayAddress(Boto3Model):
    """
    ...
    Status: "Literal['assigning', 'unassigning', 'associating', 'disassociating', 'succeeded', 'failed'] | None" = None
    """
    The address status.
    """
    ...
    AvailabilityZoneId: "str | None" = None
    """
    The ID of the Availability Zone where this Elastic IP address (EIP) is being used to
    handle outbound NAT traffic.

    Use this instead of AvailabilityZone for consistent identification of AZs across
    Amazon Web Services Regions.
    """
class EC2ProvisionedBandwidth(Boto3Model):
    """
    Reserved.

    If you need to sustain traffic greater than the
    `documented limits <https://docs.aws.amazon.com/vpc/latest/userguide/amazon-vpc-limits.html#vpc-limits-gateways>`_,
    contact Amazon Web
    Services Support.
    """

    ProvisionTime: "datetime | None" = None
    """
    Reserved.
    """
...
class NatGatewayAttachedAppliance(Boto3Model):
    """
    ...
    Type: "Literal['network-firewall-proxy'] | None" = None
    """
    The type of appliance attached to the NAT Gateway.

    For network firewall proxy functionality, this will be "network- firewall-proxy".
    """
    ApplianceArn: "str | None" = None
    """
    ...
    VpcEndpointId: "str | None" = None
    """
    The VPC endpoint ID used to route traffic from application VPCs to the proxy for
    inspection and filtering.
    """

    AttachmentState: "Literal['attaching', 'attached', 'detaching', 'detached', 'attach-failed', 'detach-failed'] | None" = None
    """
    The current attachment state of the appliance.
    """

    ModificationState: "Literal['modifying', 'completed', 'failed'] | None" = None
    """
    ...
    """
class NatGateway(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a NAT gateway.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = NatGatewayManager
    ...
    DeleteTime: datetime = Field(default=None, frozen=True)
    """
    The date and time the NAT gateway was deleted, if applicable.
    """

    FailureCode: str = Field(default=None, frozen=True)
    """
    ...
    NatGatewayId: str = Field(default=None, frozen=True)
    """
    The ID of the NAT gateway.
    """

    ProvisionedBandwidth: EC2ProvisionedBandwidth = Field(default=None, frozen=True)
    """
    Reserved.
    ...
    State: Literal["pending", "failed", "available", "deleting", "deleted"] = Field(
        default=None, frozen=True
    )
    """
    ...
    ConnectivityType: "Literal['private', 'public'] | None" = None
    """
    Indicates whether the NAT gateway supports public or private connectivity.
    """

    AvailabilityMode: "Literal['zonal', 'regional'] | None" = None
    """
    Indicates whether this is a zonal (single-AZ) or regional (multi-AZ) NAT gateway.
    """

    AutoScalingIps: Literal["enabled", "disabled"] = Field(default=None, frozen=True)
    """
    ...
    AutoProvisionZones: Literal["enabled", "disabled"] = Field(
        default=None, frozen=True
    )
    """
    For regional NAT gateways only: Indicates whether Amazon Web Services automatically
    ...
    When enabled, the NAT gateway associates EIPs in all AZs where your VPC has subnets
    to handle outbound NAT traffic, expands to new AZs when you create subnets there,
    and retracts from AZs where you've removed all subnets. When disabled, you must
    manually manage which AZs the NAT gateway supports and their corresponding EIPs.
    """

    AttachedAppliances: "builtins.list[NatGatewayAttachedAppliance]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`NatGatewayId` attribute.
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`NatGatewayId` attribute.
        """
        return hash(self.NatGatewayId)

class Ipv6CidrBlock(Boto3Model):
    """
...
class EC2CidrBlockAssociation(Boto3Model):
    """
...
class VpcPeeringConnectionOptionsDescription(Boto3Model):
    """
    Describes the VPC peering connection options.
    """

    AllowDnsResolutionFromRemoteVpc: "bool | None" = None
    """
    ...
    AllowEgressFromLocalClassicLinkToRemoteVpc: "bool | None" = None
    """
    Deprecated.
    """

    AllowEgressFromLocalVpcToRemoteClassicLink: "bool | None" = None
    """
    Deprecated.
    """
class VpcPeeringConnectionVpcInfo(Boto3Model):
    """
    ...
    Ipv6CidrBlockSet: "builtins.list[Ipv6CidrBlock] | None" = Field(
        default_factory=list
    )
    """
    ...
    CidrBlockSet: "builtins.list[EC2CidrBlockAssociation] | None" = Field(
        default_factory=list
    )
    """
    ...
    PeeringOptions: "VpcPeeringConnectionOptionsDescription | None" = None
    """
...
class VpcPeeringConnectionStateReason(Boto3Model):
    """
    Describes the status of a VPC peering connection.
    """

    Code: "Literal['initiating-request', 'pending-acceptance', 'active', 'deleted', 'rejected', 'failed', 'expired', 'provisioning', 'deleting'] | None" = None
    """
...
class VpcPeeringConnection(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a VPC peering connection.
    """
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = VpcPeeringConnectionManager
    ...
    AccepterVpcInfo: VpcPeeringConnectionVpcInfo = Field(default=None, frozen=True)
    """
    Information about the accepter VPC.

    CIDR block information is only returned when describing an active VPC peering
    connection.
    """

    ExpirationTime: datetime = Field(default=None, frozen=True)
    """
    The time that an unaccepted VPC peering connection will expire.
    """

    RequesterVpcInfo: VpcPeeringConnectionVpcInfo = Field(default=None, frozen=True)
    """
    ...
    Status: VpcPeeringConnectionStateReason = Field(default=None, frozen=True)
    """
    The status of the VPC peering connection.
    """

    VpcPeeringConnectionId: str = Field(default=None, frozen=True)
    """
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`VpcPeeringConnectionId` attribute.
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`VpcPeeringConnectionId` attribute.
        """
        return hash(self.VpcPeeringConnectionId)


class SecurityGroupIdentifier(Boto3Model):
    """
    Describes a security group.
    """
...
class EC2DnsOptions(Boto3Model):
    """
    Describes the DNS options for an endpoint.
    """

    DnsRecordIpType: "Literal['ipv4', 'dualstack', 'ipv6', 'service-defined'] | None" = None
    """
    ...
    Only supported when private DNS is enabled and when the VPC endpoint type is
    ServiceNetwork or Resource.
    """

    PrivateDnsSpecifiedDomains: "builtins.list[str] | None" = Field(
        default_factory=list
    )
    """
    Indicates which of the private domains to create private hosted zones for and
    associate with the specified VPC.
...
class EC2LastError(Boto3Model):
    ...
    """
class SubnetIpPrefixes(Boto3Model):
    """
    ...
    IpPrefixes: "builtins.list[str] | None" = Field(default_factory=list)
    """
    Array of SubnetIpPrefixes objects.
    """
class EC2VpcEndpoint(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a VPC endpoint.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = EC2VpcEndpointManager
    Tags: "builtins.list[Tag] | None" = Field(default_factory=list)
    """
    The tags assigned to the endpoint.
    """

    VpcEndpointId: str = Field(default=None, frozen=True)
    """
    The ID of the endpoint.
    """
    VpcEndpointType: "Literal['Interface', 'Gateway', 'GatewayLoadBalancer', 'Resource', 'ServiceNetwork'] | None" = None
    """
    ...
    """
    RouteTableIds: "builtins.list[str] | None" = Field(default_factory=list)
    """
    ...
    Groups: "builtins.list[SecurityGroupIdentifier]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    DnsOptions: "EC2DnsOptions | None" = None
    """
    ...
    NetworkInterfaceIds: "builtins.list[str]" = Field(default_factory=list, frozen=True)
    """
    (Interface endpoint) The network interfaces for the endpoint.
    """

    DnsEntries: "builtins.list[DnsEntry]" = Field(default_factory=list, frozen=True)
    """
    (Interface endpoint) The DNS entries for the endpoint.
    """

    CreationTimestamp: datetime = Field(default=None, frozen=True)
    """
    ...
    LastError: EC2LastError = Field(default=None, frozen=True)
    """
    The last error that occurred for endpoint.
    """
    Ipv4Prefixes: "builtins.list[SubnetIpPrefixes]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    Ipv6Prefixes: "builtins.list[SubnetIpPrefixes]" = Field(
        default_factory=list, frozen=True
    )
    """
    Array of IPv6 prefixes.
    """
    FailureReason: str = Field(default=None, frozen=True)
    """
...
class Phase1EncryptionAlgorithmsListValue(Boto3Model):
    """
    ...
    """
class Phase2EncryptionAlgorithmsListValue(Boto3Model):
    """
...
class Phase1IntegrityAlgorithmsListValue(Boto3Model):
    """
...
class Phase2IntegrityAlgorithmsListValue(Boto3Model):
    """
...
class Phase1DHGroupNumbersListValue(Boto3Model):
    """
...
class Phase2DHGroupNumbersListValue(Boto3Model):
    """
...
class IKEVersionsListValue(Boto3Model):
    """
    ...
    The IKE version.
    """
class EC2CloudWatchLogOptions(Boto3Model):
    """
    ...
    """
    The output format for BGP logs sent to CloudWatch.

    Default format is ``json``.
    """

class VpnTunnelLogOptions(Boto3Model):
    """
    Options for logging VPN tunnel activity.
    """

    CloudWatchLogOptions: "EC2CloudWatchLogOptions | None" = None
    """
    Options for sending VPN tunnel logs to CloudWatch.
    """

class TunnelOption(Boto3Model):
    """
    ...
    TunnelInsideCidr: "str | None" = None
    """
    The range of inside IPv4 addresses for the tunnel.
    """

    TunnelInsideIpv6Cidr: "str | None" = None
    """
    ...
    Phase1LifetimeSeconds: "int | None" = None
    """
    The lifetime for phase 1 of the IKE negotiation, in seconds.
    """

    Phase2LifetimeSeconds: "int | None" = None
    """
    The lifetime for phase 2 of the IKE negotiation, in seconds.
    """

    RekeyMarginTimeSeconds: "int | None" = None
    """
    ...
    RekeyFuzzPercentage: "int | None" = None
    """
    The percentage of the rekey window determined by ``RekeyMarginTimeSeconds`` during
    which the rekey time is randomly selected.
    """

    ReplayWindowSize: "int | None" = None
    """
    The number of packets in an IKE replay window.
    """

    DpdTimeoutSeconds: "int | None" = None
    """
    The number of seconds after which a DPD timeout occurs.
    """

    DpdTimeoutAction: "str | None" = None
    """
    The action to take after a DPD timeout occurs.
    """

    Phase1EncryptionAlgorithms: "builtins.list[Phase1EncryptionAlgorithmsListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    Phase2EncryptionAlgorithms: "builtins.list[Phase2EncryptionAlgorithmsListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    Phase1IntegrityAlgorithms: "builtins.list[Phase1IntegrityAlgorithmsListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    Phase2IntegrityAlgorithms: "builtins.list[Phase2IntegrityAlgorithmsListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    Phase1DHGroupNumbers: "builtins.list[Phase1DHGroupNumbersListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    Phase2DHGroupNumbers: "builtins.list[Phase2DHGroupNumbersListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    IkeVersions: "builtins.list[IKEVersionsListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    StartupAction: "str | None" = None
    """
    The action to take when the establishing the VPN tunnels for a VPN connection.
    """

    LogOptions: "VpnTunnelLogOptions | None" = None
    """
    Options for logging VPN tunnel activity.
    """

    EnableTunnelLifecycleControl: "bool | None" = None
    """
    Status of tunnel endpoint lifecycle control feature.
    """

class VpnConnectionOptions(Boto3Model):
    """
    ...
    TunnelInsideIpVersion: "Literal['ipv4', 'ipv6'] | None" = None
    """
    Indicates whether the VPN tunnels process IPv4 or IPv6 traffic.
    """

    TunnelOptions: "builtins.list[TunnelOption] | None" = Field(default_factory=list)
    """
    Indicates the VPN tunnel options.
    """

    TunnelBandwidth: "Literal['standard', 'large'] | None" = None
    """
    The configured bandwidth for the VPN tunnel.

    Represents the current throughput capacity setting for the tunnel connection.
    ``standard`` tunnel bandwidth supports up to 1.25 Gbps per tunnel while ``large``
...
class VpnStaticRoute(Boto3Model):
    """
    ...
    Source: "Literal['Static'] | None" = None
    """
    Indicates how the routes were provided.
    """
    State: "Literal['pending', 'available', 'deleting', 'deleted'] | None" = None
    """
    The current state of the static route.
    """
class VgwTelemetry(Boto3Model):
    """
    Describes telemetry for a VPN tunnel.
    """

    AcceptedRouteCount: "int | None" = None
    """
    ...
    This field is updated when changes in IKE (Phase 1), IPSec (Phase 2), or BGP status
    are detected.
    """
...
VpnConnectionVgwTelemetry = VgwTelemetry


class VpnConnection(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a VPN connection.
    """

    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = VpnConnectionManager
    ...
    Category: str = Field(default=None, frozen=True)
    """
    The category of the VPN connection.

    A value of ``VPN`` indicates an Amazon Web Services VPN connection. A value of
    ...
    CoreNetworkArn: str = Field(default=None, frozen=True)
    """
    The ARN of the core network.
    """

    CoreNetworkAttachmentArn: str = Field(default=None, frozen=True)
    """
    The ARN of the core network attachment.
    """

    GatewayAssociationState: Literal[
    ...
    Options: "VpnConnectionOptions | None" = None
    """
    The VPN connection options.
    """

    Routes: "builtins.list[VpnStaticRoute]" = Field(default_factory=list, frozen=True)
    """
    The static routes associated with the VPN connection.
    """
    VgwTelemetry: "builtins.list[VpnConnectionVgwTelemetry]" = Field(
        default_factory=list, frozen=True
    )
    """
    ...
    """
    CustomerGatewayConfiguration: str = Field(default=None, frozen=True)
    """
    The configuration information for the VPN connection's customer gateway (in the
    native XML format).

    This element is always present in the CreateVpnConnection response; however, it's
    present in the DescribeVpnConnections response only if the VPN connection is in the
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`VpnConnectionId` attribute.

        Returns:
            The primary key of the model instance.
        """
        return self.VpnConnectionId
    @property
    def name(self) -> str | None:
        """
        Return the name of the model.
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`VpnConnectionId` attribute.
        """
        return hash(self.VpnConnectionId)

class DestinationOptionsResponse(Boto3Model):
    """
    Describes the destination options for a flow log.
    """

    FileFormat: "Literal['plain-text', 'parquet'] | None" = None
    """
...
class FlowLog(TagsDictMixin, PrimaryBoto3Model):
    """
    Describes a flow log.
    """
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = FlowLogManager
    ...
    DeliverLogsErrorMessage: str = Field(default=None, frozen=True)
    """
    Information about the error that occurred.

    ``Rate limited`` indicates that CloudWatch Logs throttling has been applied for one
    or more network interfaces, or that you've reached the limit on the number of log
    groups that you can create. ``Access error`` indicates that the IAM role associated
    with the flow log does not have sufficient permissions to publish to CloudWatch
    Logs. ``Unknown error`` indicates an internal error.
    """

    DeliverLogsPermissionArn: "str | None" = None
    """
    ...
    accounts.
    """
    DeliverLogsStatus: str = Field(default=None, frozen=True)
    """
    The status of the logs delivery (``SUCCESS`` | ``FAILED``).
    """

    FlowLogId: str = Field(default=None, frozen=True)
    """
    The ID of the flow log.
    """

    FlowLogStatus: str = Field(default=None, frozen=True)
    """
    ...
    ResourceId: str = Field(default=None, frozen=True)
    """
    The ID of the resource being monitored.
    """

    TrafficType: "Literal['ACCEPT', 'REJECT', 'ALL'] | None" = None
    """
    The type of traffic captured for the flow log.
    """

    LogDestinationType: "Literal['cloud-watch-logs', 's3', 'kinesis-data-firehose'] | None" = None
    """
    ...
    MaxAggregationInterval: "int | None" = None
    """
    The maximum interval of time, in seconds, during which a flow of packets is captured
    and aggregated into a flow log record.
    """

    DestinationOptions: "DestinationOptionsResponse | None" = None
    """
    The destination options.
    """

    ResourceIds: "builtins.list[str] | None" = Field(default_factory=list)
    ResourceType: (
        Literal[
            "VPC",
            "Subnet",
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`FlowLogId` attribute.

        Returns:
            The primary key of the model instance.
        """
        return self.FlowLogId
    @property
    def name(self) -> str | None:
        """
        Return the name of the model.
    ...
    def __hash__(self) -> int:
        ...
        This is the value of the
        :py:attr:`FlowLogId` attribute.
        """
        return hash(self.FlowLogId)
# =======================
...
class DescribeVpcsResult(Boto3Model):
    ...
    Vpcs: "builtins.list[Vpc] | None" = Field(default_factory=list)
    """
...
class DescribeVpcAttributeResult(Boto3Model):
    ...
    If this attribute is ``true``, instances in the VPC get DNS hostnames; otherwise,
    they do not.
    """
    ...
    If this attribute is ``true``, the Amazon DNS server resolves DNS hostnames for your
...
class DescribeSubnetsResult(Boto3Model):
    ...
    Subnets: "builtins.list[Subnet] | None" = Field(default_factory=list)
    """
...
class DescribeSecurityGroupsResult(Boto3Model):
    ...
    SecurityGroups: "builtins.list[SecurityGroup] | None" = Field(default_factory=list)
    """
...
class RevokeSecurityGroupIngressResult(Boto3Model):
    ...
    UnknownIpPermissions: "builtins.list[IpPermission] | None" = Field(
        default_factory=list
    )
    """
    The inbound rules that were unknown to the service.

    In some cases, ``unknownIpPermissionSet`` might be in a different format from the
    request parameter.
    """

    RevokedSecurityGroupRules: "builtins.list[RevokedSecurityGroupRule] | None" = Field(
        default_factory=list
    )
    """
...
class AuthorizeSecurityGroupIngressResult(Boto3Model):
    ...
    Returns ``true`` if the request succeeds; otherwise, returns an error.
    """
    SecurityGroupRules: "builtins.list[SecurityGroupRule] | None" = Field(
        default_factory=list
    )
    """
    Information about the inbound (ingress) security group rules that were added.
    """
class RevokeSecurityGroupEgressResult(Boto3Model):
    Return: "bool | None" = None
    """
    Returns ``true`` if the request succeeds; otherwise, returns an error.
    """
...
class AuthorizeSecurityGroupEgressResult(Boto3Model):
    Return: "bool | None" = None
    """
    Returns ``true`` if the request succeeds; otherwise, returns an error.
    """
...
class DescribeNetworkAclsResult(Boto3Model):
    NetworkAcls: "builtins.list[NetworkAcl] | None" = Field(default_factory=list)
    """
...
class DeregisterImageResult(Boto3Model):
    ...
    DeleteSnapshotResults: "builtins.list[DeleteSnapshotReturnCode] | None" = Field(
        default_factory=list
    )
    """
...
class DescribeImagesResult(Boto3Model):
    ...
    This value is ``null`` when there are no more items to return.
    """
    Images: "builtins.list[AMI] | None" = Field(default_factory=list)
    """
...
class SpotMarketOptions(Boto3Model):
    ...
    For
    `RunInstances <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances>`_,
...
class CapacityReservationSpecification(Boto3Model):
    ...
    Use the ``CapacityReservationPreference`` parameter to configure the instance to run
    as an On-Demand Instance, to run in any ``open`` Capacity Reservation that has
...
class InstanceSecondaryInterfacePrivateIpAddressRequest(Boto3Model):
    """
...
class InstanceSecondaryInterfaceSpecificationRequest(Boto3Model):
    """
    ...
    PrivateIpAddresses: "builtins.list[InstanceSecondaryInterfacePrivateIpAddressRequest] | None" = Field(
        default_factory=list
    )
    """
    The private IPv4 addresses to assign to the secondary interface.
    ...
    The network card must support secondary interfaces.
    """
...
class EnaSrdUdpSpecificationRequest(Boto3Model):
    ...
    To ensure that UDP traffic can use ENA Express when you launch an instance, you must
    also set **EnaSrdEnabled** in the **EnaSrdSpecificationRequest** to ``true``.
    """
...
class InstanceNetworkInterfaceSpecification(Boto3Model):
    ...
    You can specify ``true`` only if creating a new network interface when launching an
    instance.
    """
    Description: "str | None" = None
    """
    ...
    You can’t specify this parameter and also specify a secondary private IP address
    ...
    Ipv4Prefixes: "builtins.list[Ipv4PrefixSpecificationRequest] | None" = Field(
        default_factory=list
    )
    """
    ...
    Ipv6Prefixes: "builtins.list[Ipv6PrefixSpecificationRequest] | None" = Field(
        default_factory=list
    )
    """
...
class Reservation(Boto3Model):
    ...
    Instances: "builtins.list[Instance] | None" = Field(default_factory=list)
    """
    The instances.
    """
...
class DescribeInstancesResult(Boto3Model):
    ...
    Reservations: "builtins.list[Reservation] | None" = Field(default_factory=list)
    """
...
class StartInstancesResult(Boto3Model):
    StartingInstances: "builtins.list[InstanceStateChange] | None" = Field(
        default_factory=list
    )
    """
...
class StopInstancesResult(Boto3Model):
    StoppingInstances: "builtins.list[InstanceStateChange] | None" = Field(
        default_factory=list
    )
    """
...
class TerminateInstancesResult(Boto3Model):
    TerminatingInstances: "builtins.list[InstanceStateChange] | None" = Field(
        default_factory=list
    )
    """
...
class EbsInstanceBlockDeviceSpecification(Boto3Model):
    """
    ...
    Indicates whether the volume is deleted on instance termination.
    """
class InstanceBlockDeviceMappingSpecification(Boto3Model):
    """
    ...
    """
class SecureBlobAttributeValue(Boto3Model):
...
class LaunchTemplateInstanceNetworkInterfaceSpecificationRequest(Boto3Model):
    ...
    The primary network interface has a device index of 0. Each network interface is of
    type ``interface``, you must specify a device index. If you create a launch template
    that includes secondary network interfaces but not a primary network interface, then
    you must add a primary network interface as a launch parameter when you launch an
    ...
    Ipv6Addresses: "builtins.list[InstanceIpv6AddressRequest] | None" = Field(
        default_factory=list
    )
    """
...
class LaunchTemplatePlacementRequest(Boto3Model):
    ...
    If you specify a host resource group ARN, omit the **Tenancy** parameter or set it
    to ``host``.
    """
...
class LaunchTemplateCapacityReservationSpecificationRequest(Boto3Model):
    ...
    You can specify only one option at a time. Use the ``CapacityReservationPreference``
    parameter to configure the instance to run in On-Demand capacity or to run in any
...
class CpuPerformanceFactorRequest(Boto3Model):
    ...
    References: "builtins.list[PerformanceFactorReferenceRequest] | None" = Field(
        default_factory=list
    )
    """
    Specify an instance family to use as the baseline reference for CPU performance.
...
class InstanceRequirementsRequest(Boto3Model):
    ...
    * ``ExcludedInstanceTypes`` - The instance types to exclude from the list, even if
    ...
    For more information, see `Specify attributes for instance type selection for EC2
    Fleet or Spot
...
class SecondaryInterfacePrivateIpAddressSpecificationRequest(Boto3Model):
    """
...
class LaunchTemplateInstanceSecondaryInterfaceSpecificationRequest(Boto3Model):
    """
    ...
    PrivateIpAddresses: "builtins.list[SecondaryInterfacePrivateIpAddressSpecificationRequest] | None" = Field(
        default_factory=list
    )
    """
    The private IPv4 addresses to assign to the secondary interface.
...
class RequestLaunchTemplateData(Boto3Model):
    ...
    """
    BlockDeviceMappings: "builtins.list[LaunchTemplateBlockDeviceMappingRequest] | None" = Field(
        default_factory=list
    )
    """
    ...
    NetworkInterfaces: "builtins.list[LaunchTemplateInstanceNetworkInterfaceSpecificationRequest] | None" = Field(
        default_factory=list
    )
    """
    The network interfaces for the instance.
    ...
    The default is ``false``, which means that you can terminate the instance using the
    Amazon EC2 console, command line tools, or API. You can enable termination
    protection when you launch an instance, while the instance is running, or while the
    instance is stopped.
    """
    ...
    TagSpecifications: "builtins.list[LaunchTemplateTagSpecificationRequest] | None" = (
        Field(default_factory=list)
    )
    """
    ...
    ElasticGpuSpecifications: "builtins.list[ElasticGpuSpecification] | None" = Field(
        default_factory=list
    )
    """
    Deprecated.
    ...
    ElasticInferenceAccelerators: "builtins.list[LaunchTemplateElasticInferenceAccelerator] | None" = Field(
        default_factory=list
    )
    """
    Amazon Elastic Inference is no longer available.
    ...
    LicenseSpecifications: "builtins.list[LaunchTemplateLicenseConfigurationRequest] | None" = Field(
        default_factory=list
    )
    """
    The license configurations.
    ...
    SecondaryInterfaces: "builtins.list[LaunchTemplateInstanceSecondaryInterfaceSpecificationRequest] | None" = Field(
        default_factory=list
    )
    """
...
class ValidationWarning(Boto3Model):
    ...
    Errors: "builtins.list[ValidationError] | None" = Field(default_factory=list)
    """
...
class DescribeLaunchTemplatesResult(Boto3Model):
    LaunchTemplates: "builtins.list[LaunchTemplate] | None" = Field(
        default_factory=list
    )
    """
...
class DeleteLaunchTemplateVersionsResult(Boto3Model):
    SuccessfullyDeletedLaunchTemplateVersions: "builtins.list[DeleteLaunchTemplateVersionsResponseSuccessItem] | None" = Field(
        default_factory=list
    )
    """
    ...
    UnsuccessfullyDeletedLaunchTemplateVersions: "builtins.list[DeleteLaunchTemplateVersionsResponseErrorItem] | None" = Field(
        default_factory=list
    )
    """
...
class DescribeLaunchTemplateVersionsResult(Boto3Model):
    LaunchTemplateVersions: "builtins.list[LaunchTemplateVersion] | None" = Field(
        default_factory=list
    )
    """
...
class DescribeNetworkInterfacePermissionsResult(Boto3Model):
    ...
    NetworkInterfacePermissions: "builtins.list[NetworkInterfacePermission] | None" = (
        Field(default_factory=list)
    )
    """
...
class AssignedPrivateIpAddress(Boto3Model):
    """
...
class AssignPrivateIpAddressesResult(Boto3Model):
    NetworkInterfaceId: "str | None" = None
    """
    The ID of the network interface.
    """

    AssignedPrivateIpAddresses: "builtins.list[AssignedPrivateIpAddress] | None" = (
        Field(default_factory=list)
    )
    """
    ...
    AssignedIpv4Prefixes: "builtins.list[Ipv4PrefixSpecification] | None" = Field(
        default_factory=list
    )
    """
    The IPv4 prefixes that are assigned to the network interface.
...
class NetworkInterfaceAttachmentChanges(Boto3Model):
    """
    Describes an attachment change.
    """

    DefaultEnaQueueCount: "bool | None" = None
    """
...
class DescribeInstanceTypesResult(Boto3Model):
    InstanceTypes: "builtins.list[EC2InstanceType] | None" = Field(default_factory=list)
    """
    The instance type.
    """
...
class DescribeSnapshotsResult(Boto3Model):
    ...
    Snapshots: "builtins.list[Snapshot] | None" = Field(default_factory=list)
    """
...
class DescribeLockedSnapshotsResult(Boto3Model):
    Snapshots: "builtins.list[LockedSnapshotsInfo] | None" = Field(default_factory=list)
    """
    Information about the snapshots.
    """
...
class KeyPairInfo(TagsDictMixin, Boto3Model):
    """
    Describes a key pair.
    """
    ...
    The ID of the key pair.
    """
    KeyType: "Literal['rsa', 'ed25519'] | None" = None
    """
    The type of key pair.
    """
...
class DescribeKeyPairsResult(Boto3Model):
    KeyPairs: "builtins.list[KeyPairInfo] | None" = Field(default_factory=list)
    """
    Information about the key pairs.
    """

class DeleteKeyPairResult(Boto3Model):
    Return: "bool | None" = None
    """
...
class ImportKeyPairResult(TagsDictMixin, Boto3Model):
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    KeyFingerprint: "str | None" = None
    """
...
class CreatePlacementGroupResult(Boto3Model):
    PlacementGroupInstance: PlacementGroup = Field(default=None, alias="PlacementGroup")
    """
    Information about the placement group.
    """

class DescribePlacementGroupsResult(Boto3Model):
    PlacementGroups: "builtins.list[PlacementGroup] | None" = Field(
        default_factory=list
    )
    """
...
class NewDhcpConfiguration(Boto3Model):
    """
    Describes a DHCP configuration option.
    """
...
class CreateDhcpOptionsResult(Boto3Model):
    DhcpOptionsInstance: DhcpOptions = Field(default=None, alias="DhcpOptions")
    """
    A set of DHCP options.
    """
DescribeDhcpOptionsResultDhcpOptions = DhcpOptions


class DescribeDhcpOptionsResult(Boto3Model):
    NextToken: "str | None" = None
    """
    The token to include in another request to get the next page of items.
    ...
    DhcpOptions: "builtins.list[DescribeDhcpOptionsResultDhcpOptions] | None" = Field(
        default_factory=list
    )
    """
...
class CreateCustomerGatewayResult(Boto3Model):
    """
    Contains the output of CreateCustomerGateway.
    """

    CustomerGatewayInstance: CustomerGateway = Field(
        default=None, alias="CustomerGateway"
    )
    """
    Information about the customer gateway.
    """
class DescribeCustomerGatewaysResult(Boto3Model):
    """
    Contains the output of DescribeCustomerGateways.
    """

    CustomerGateways: "builtins.list[CustomerGateway] | None" = Field(
        default_factory=list
    )
    """
...
class CreateVpnGatewayResult(Boto3Model):
    """
    Contains the output of CreateVpnGateway.
    """

    VpnGatewayInstance: VpnGateway = Field(default=None, alias="VpnGateway")
    """
    Information about the virtual private gateway.
    """

class DescribeVpnGatewaysResult(Boto3Model):
    """
    Contains the output of DescribeVpnGateways.
    """

    VpnGateways: "builtins.list[VpnGateway] | None" = Field(default_factory=list)
    """
    Information about one or more virtual private gateways.
    """

class AttachVpnGatewayResult(Boto3Model):
    """
    Contains the output of AttachVpnGateway.
    """

    VpcAttachment: "EC2VpcAttachment | None" = None
    """
    Information about the attachment.
    """

class CreateInternetGatewayResult(Boto3Model):
    InternetGatewayInstance: InternetGateway = Field(
...
class DescribeInternetGatewaysResult(Boto3Model):
    InternetGateways: "builtins.list[InternetGateway] | None" = Field(
        default_factory=list
    )
    """
...
class DescribeVolumesResult(Boto3Model):
    NextToken: "str | None" = None
    """
    The token to include in another request to get the next page of items.
...
class EC2VolumeModification(Boto3Model):
    """
    ...
    ModificationState: "Literal['modifying', 'optimizing', 'completed', 'failed'] | None" = None
    """
    ...
    TargetIops: "int | None" = None
    """
    The target IOPS rate of the volume.
    """

    TargetVolumeType: "Literal['standard', 'io1', 'io2', 'gp2', 'sc1', 'st1', 'gp3'] | None" = None
    """
    The target EBS volume type of the volume.
    """

    TargetThroughput: "int | None" = None
    """
    The target throughput of the volume, in MiB/s.
    """

    TargetMultiAttachEnabled: "bool | None" = None
    """
    ...
    OriginalIops: "int | None" = None
    """
    The original IOPS rate of the volume.
    """

    OriginalVolumeType: "Literal['standard', 'io1', 'io2', 'gp2', 'sc1', 'st1', 'gp3'] | None" = None
    """
    The original EBS volume type of the volume.
    """

    OriginalThroughput: "int | None" = None
    """
    The original throughput of the volume, in MiB/s.
    """

    OriginalMultiAttachEnabled: "bool | None" = None
    """
...
class ModifyVolumeResult(Boto3Model):
    VolumeModification: "EC2VolumeModification | None" = None
    """
    Information about the volume modification.
    """

class CreateRouteTableResult(Boto3Model):
    RouteTableInstance: RouteTable = Field(default=None, alias="RouteTable")
    """
...
class DescribeRouteTablesResult(Boto3Model):
    """
    Contains the output of DescribeRouteTables.
    """

    RouteTables: "builtins.list[RouteTable] | None" = Field(default_factory=list)
    """
...
class CreateRouteResult(Boto3Model):
    Return: "bool | None" = None
    """
    Returns ``true`` if the request succeeds; otherwise, it returns an error.
    """

class AssociateRouteTableResult(Boto3Model):
    AssociationId: "str | None" = None
    """
    The route table association ID.

    This ID is required for disassociating the route table.
    """
    AssociationState: "RouteTableAssociationState | None" = None
    """
    The state of the association.
...
class AvailabilityZoneAddress(Boto3Model):
    """
    For regional NAT gateways only: The configuration specifying which Elastic IP
    address (EIP) to use for handling outbound NAT traffic from a specific Availability
    Zone.

    A regional NAT gateway is a single NAT Gateway that works across multiple
    availability zones (AZs) in your VPC,
    providing redundancy, scalability and availability across all the AZs in a Region.

    For more information, see `Regional NAT gateways for automatic multi-AZ
    expansion <https://docs.aws.amazon.com/vpc/latest/userguide/nat-gateways-regional.html>`_ in the *Amazon VPC User Guide*.
    """

    AvailabilityZone: "str | None" = None
    """
    For regional NAT gateways only: The Availability Zone where this specific NAT
    gateway configuration will be active.

    Each AZ in a regional NAT gateway has its own configuration to handle outbound NAT
    ...
    NAT gateway configuration will be active.

    Each AZ in a regional NAT gateway has its own configuration to handle outbound NAT
    traffic from that AZ. Use this instead of AvailabilityZone for consistent
    identification of AZs across Amazon Web Services Regions.
    """
    AllocationIds: "builtins.list[str] | None" = Field(default_factory=list)
    """
    ...
    """
class CreateNatGatewayResult(Boto3Model):
    NatGatewayInstance: NatGateway = Field(default=None, alias="NatGateway")
    """
...
class DescribeNatGatewaysResult(Boto3Model):
    NatGateways: "builtins.list[NatGateway] | None" = Field(default_factory=list)
    """
...
class DeleteNatGatewayResult(Boto3Model):
    NatGatewayId: "str | None" = None
    """
    The ID of the NAT gateway.
    """
class AssociateNatGatewayAddressResult(Boto3Model):
    NatGatewayId: "str | None" = None
    """
    The ID of the NAT gateway.
    """

    NatGatewayAddresses: "builtins.list[NatGatewayAddress] | None" = Field(
        default_factory=list
    )
    """
    The IP addresses.
...
class DisassociateNatGatewayAddressResult(Boto3Model):
    NatGatewayId: "str | None" = None
    """
    The ID of the NAT gateway.
    """
...
class CreateVpcPeeringConnectionResult(Boto3Model):
    VpcPeeringConnectionInstance: VpcPeeringConnection = Field(
...
class DescribeVpcPeeringConnectionsResult(Boto3Model):
    VpcPeeringConnections: "builtins.list[VpcPeeringConnection] | None" = Field(
        default_factory=list
    )
    """
...
class AcceptVpcPeeringConnectionResult(Boto3Model):
    VpcPeeringConnectionInstance: VpcPeeringConnection = Field(
        default=None, alias="VpcPeeringConnection"
    )
    """
...
class RejectVpcPeeringConnectionResult(Boto3Model):
    Return: "bool | None" = None
    """
    Returns ``true`` if the request succeeds; otherwise, it returns an error.
    """

class DeleteVpcPeeringConnectionResult(Boto3Model):
    Return: "bool | None" = None
    """
    Returns ``true`` if the request succeeds; otherwise, it returns an error.
    """

class PeeringConnectionOptionsRequest(Boto3Model):
    """
...
class PeeringConnectionOptions(Boto3Model):
    """
    Describes the VPC peering connection options.
    """
    AllowDnsResolutionFromRemoteVpc: "bool | None" = None
...
class ModifyVpcPeeringConnectionOptionsResult(Boto3Model):
    AccepterPeeringConnectionOptions: "PeeringConnectionOptions | None" = None
    """
    Information about the VPC peering connection options for the accepter VPC.
    """

    RequesterPeeringConnectionOptions: "PeeringConnectionOptions | None" = None
    """
    Information about the VPC peering connection options for the requester VPC.
    """

class SubnetConfiguration(Boto3Model):
    """
    ...
    """
class DnsOptionsSpecification(Boto3Model):
    """
    Describes the DNS options for an endpoint.
    """
    ...
    endpoints. It routes traffic that originates from the VPC to the gateway endpoint
...
class CreateVpcEndpointResult(Boto3Model):
    VpcEndpointInstance: EC2VpcEndpoint = Field(default=None, alias="VpcEndpoint")
    """
...
class DescribeVpcEndpointsResult(Boto3Model):
    VpcEndpoints: "builtins.list[EC2VpcEndpoint] | None" = Field(default_factory=list)
    """
...
class UnsuccessfulItemError(Boto3Model):
    """
    Information about the error that occurred.
...
class UnsuccessfulItem(Boto3Model):
    """
    Information about items that were not successfully processed in a batch call.
    """

    Error: "UnsuccessfulItemError | None" = None
    """
    Information about the error.
    """
...
class DeleteVpcEndpointsResult(Boto3Model):
    Unsuccessful: "builtins.list[UnsuccessfulItem] | None" = Field(default_factory=list)
    """
    Information about the VPC endpoints that were not successfully deleted.
    """

class ModifyVpcEndpointResult(Boto3Model):
    Return: "bool | None" = None
    """
    Returns ``true`` if the request succeeds; otherwise, it returns an error.
    """

class Phase1EncryptionAlgorithmsRequestListValue(Boto3Model):
    """
...
class Phase2EncryptionAlgorithmsRequestListValue(Boto3Model):
    """
...
class Phase1IntegrityAlgorithmsRequestListValue(Boto3Model):
    """
...
class Phase2IntegrityAlgorithmsRequestListValue(Boto3Model):
    """
...
class Phase1DHGroupNumbersRequestListValue(Boto3Model):
    """
...
class Phase2DHGroupNumbersRequestListValue(Boto3Model):
    """
...
class IKEVersionsRequestListValue(Boto3Model):
    """
...
class CloudWatchLogOptionsSpecification(Boto3Model):
    """
    Options for sending VPN tunnel logs to CloudWatch.
    """
...
class VpnTunnelLogOptionsSpecification(Boto3Model):
    """
    Options for logging VPN tunnel activity.
    """

    CloudWatchLogOptions: "CloudWatchLogOptionsSpecification | None" = None
    """
    Options for sending VPN tunnel logs to CloudWatch.
    """

class VpnTunnelOptionsSpecification(Boto3Model):
    """
    ...
    Any specified CIDR blocks must be unique across all VPN connections that use the
    ...
    Specify ``restart`` to restart the IKE initiation. Specify ``clear`` to end the IKE
    session.
    """

    Phase1EncryptionAlgorithms: "builtins.list[Phase1EncryptionAlgorithmsRequestListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    Phase2EncryptionAlgorithms: "builtins.list[Phase2EncryptionAlgorithmsRequestListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    Phase1IntegrityAlgorithms: "builtins.list[Phase1IntegrityAlgorithmsRequestListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    Phase2IntegrityAlgorithms: "builtins.list[Phase2IntegrityAlgorithmsRequestListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    Phase1DHGroupNumbers: "builtins.list[Phase1DHGroupNumbersRequestListValue] | None" = Field(
        default_factory=list
    )
    """
    ...
    Phase2DHGroupNumbers: "builtins.list[Phase2DHGroupNumbersRequestListValue] | None" = Field(
        default_factory=list
    )
    """
    One or more Diffie-Hellman group numbers that are permitted for the VPN tunnel for
    ...
    IKEVersions: "builtins.list[IKEVersionsRequestListValue] | None" = Field(
        default_factory=list
    )
    """
    The IKE versions that are permitted for the VPN tunnel.
    ...
    By default, your customer gateway device must initiate the IKE negotiation and bring
    up the tunnel. Specify ``start`` for Amazon Web Services to initiate the IKE
    negotiation.
    """

    LogOptions: "VpnTunnelLogOptionsSpecification | None" = None
    """
    Options for logging VPN tunnel activity.
    """
...
class VpnConnectionOptionsSpecification(Boto3Model):
    """
    Describes VPN connection options.
    """
    ...
    TunnelOptions: "builtins.list[VpnTunnelOptionsSpecification] | None" = Field(
        default_factory=list
    )
    """
    ...
    OutsideIpAddressType: "str | None" = None
    """
    The type of IP address assigned to the outside interface of the customer gateway
    device.
    """
    ...
    ``standard`` supports up to 1.25 Gbps per tunnel, while ``large`` supports up to 5
    Gbps per tunnel. The default value is ``standard``. Existing VPN connections without
    a bandwidth setting will automatically default to ``standard``.
    """
    ...
    If you are creating a VPN connection for a device that does not support BGP, you
    must specify ``true``. Use CreateVpnConnectionRoute to create a static route.
    """

class CreateVpnConnectionResult(Boto3Model):
    """
    Contains the output of CreateVpnConnection.
    """

    VpnConnectionInstance: VpnConnection = Field(default=None, alias="VpnConnection")
    """
    Information about the VPN connection.
    """

class DescribeVpnConnectionsResult(Boto3Model):
    """
    Contains the output of DescribeVpnConnections.
    """

    VpnConnections: "builtins.list[VpnConnection] | None" = Field(default_factory=list)
    """
    Information about one or more VPN connections.
    """

class ModifyVpnConnectionResult(Boto3Model):
    VpnConnectionInstance: VpnConnection = Field(default=None, alias="VpnConnection")
    """
    Information about the VPN connection.
    """

class CreateFlowLogsResult(Boto3Model):
    ClientToken: "str | None" = None
    """
    Unique, case-sensitive identifier that you provide to ensure the idempotency of the
    request.
    ...
    FlowLogIds: "builtins.list[str] | None" = Field(default_factory=list)
    """
...
class DestinationOptionsRequest(Boto3Model):
    """
    Describes the destination options for a flow log.
    """
...
class DeleteFlowLogsResult(Boto3Model):
    Unsuccessful: "builtins.list[UnsuccessfulItem] | None" = Field(default_factory=list)
    """
    Information about the flow logs that could not be deleted successfully.
    """

class DescribeFlowLogsResult(Boto3Model):
    FlowLogs: "builtins.list[FlowLog] | None" = Field(default_factory=list)
    """
