...
class FlowLogManager(ReadonlyBoto3ModelManager):
    service_name: str = "ec2"
...
class FlowLog(TagsDictMixin, PrimaryBoto3Model):
    ...
    """
    DeliverLogsErrorMessage: "str | None" = None
    """
    ...
    accounts.
    """
    DeliverLogsStatus: "str | None" = None
    """
    The status of the logs delivery (``SUCCESS`` | ``FAILED``).
    """
    FlowLogId: "str | None" = None
    """
    The ID of the flow log.
    """
    FlowLogStatus: "str | None" = None
    """
