...
class ClassicELBManager(ClassicELBManagerMixin, Boto3ModelManager):
    ...
    def add_tags(
        self, LoadBalancerNames: "builtins.list[str]", Tags: "builtins.list[Tag]"
    ) -> None:
        """
        ...
        Each load balancer can have a maximum of 10 tags.
                Args:
                    LoadBalancerNames: The name of the load balancer. You can specify
    ...
    def describe_tags(
        self, LoadBalancerNames: "builtins.list[str]"
    ) -> "builtins.list[ClassicELBTagDescription]":
        """
        ...
        results: "builtins.list[ClassicELBTagDescription]" = None
        if response is not None:
            results = response.TagDescriptions

        self.sessionize(results)
        return cast("builtins.list[ClassicELBTagDescription]", results)

    def remove_tags(
        self, LoadBalancerNames: "builtins.list[str]", Tags: "builtins.list[TagKeyOnly]"
    ) -> None:
        """
    ...
    def instance_health(
        ...
        *,
        ...
        that are currently registered with the load balancer. If
        instances are specified, their state is returned even if they are no longer
        registered with the load balancer. The state
    ...
    def apply_security_groups(
        ...
        Args:
            ...
            SecurityGroups: The IDs of the security groups to associate with the load
                balancer. Note that you cannot specify the
    ...
    def set_listener_policies(
        ...
        Args:
            ...
            PolicyNames: The names of the policies. This list must include all policies
                to be enabled. If you omit a policy that
                is currently enabled, it is disabled. If the list is empty, all current
    ...
    def set_backend_policies(
        ...
        Args:
            ...
            PolicyNames: The names of the policies. If the list is empty, then all
                current polices are removed from the EC2
                instance.
        """
        args: dict[str, Any] = dict(
            LoadBalancerName=self.serialize(LoadBalancerName),
        ...
        *,
        ...
        Args:
            ...
            PolicyName: The name of the load balancer policy to be created. This name
                must be unique within the set of policies
    ...
    def describe_policy_types(
        ...
        Args:
            PolicyTypeNames: The names of the policy types. If no names are specified,
                describes all policy types defined by
...
class ClassicELB(ClassicELBModelMixin, PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = ClassicELBManager
    ...
    def add_listeners(self, Listeners: builtins.list[ClassicELBListener]) -> "None":
        """
    ...
    def remove_listeners(self, LoadBalancerPorts: builtins.list[int]) -> "None":
        """
    ...
    def policies(self) -> "builtins.list[PolicyDescription]":
        """
...
class DescribeTagsOutput(Boto3Model):
    ...
    """
    TagDescriptions: "builtins.list[ClassicELBTagDescription] | None" = Field(
        default_factory=list
    )
    """
