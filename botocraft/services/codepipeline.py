...
class EnvironmentVariable(Boto3Model):
    ...
    """
    type: "Literal['PLAINTEXT', 'SECRETS_MANAGER'] | None" = None
    """
    Specifies the type of use for the environment variable value.

    The value can be either ``PLAINTEXT`` or
    ``SECRETS_MANAGER``. If the value is ``SECRETS_MANAGER``, provide the Secrets reference in the EnvironmentVariable
    value.
    """
