...
class BucketManager(BucketManagerMixin, Boto3ModelManager):
    ...
    def list(
        ...
        *,
        ...
        Keyword Args:
            MaxBuckets: Maximum number of buckets to be returned in response. When the
                number is more than the count of buckets
                that are owned by an Amazon Web Services account, return all the buckets
                in response.
            ContinuationToken: ``ContinuationToken`` indicates to Amazon S3 that the
                list is being continued on this bucket with
                a token. ``ContinuationToken`` is obfuscated and is not a real key. You
                can use this ``ContinuationToken`` for
                pagination of the list results.
            Prefix: Limits the response to bucket names that begin with the specified
                bucket name prefix.
            BucketRegion: Limits the response to buckets that are located in the
                specified Amazon Web Services Region. The
                Amazon Web Services Region must be expressed according to the Amazon Web
                Services Region code, such as ``us-west-2``
                for the US West (Oregon) Region. For a list of the valid values for all
                of the Amazon Web Services Regions, see
    ...
    def get_bucket_policy(
        ...
        Keyword Args:
            ExpectedBucketOwner: The account ID of the expected bucket owner. If the
                account ID that you provide does not match
                the actual owner of the bucket, the request fails with the HTTP status
    ...
    def put_bucket_policy(
        ...
        *,
        ...
        Keyword Args:
            ...
            ChecksumAlgorithm: Indicates the algorithm used to create the checksum for
                the request when you use the SDK. This
                header will not provide any additional functionality if you don't use
                the SDK. When you send this header, there must
                be a corresponding ``x-amz- checksum-algorithm``  or ``x-amz-trailer``
                header sent. Otherwise, Amazon S3 fails the
                request with the HTTP status code ``400 Bad Request``.
            ConfirmRemoveSelfBucketAccess: Set this parameter to true to confirm that
                you want to remove your permissions to
        ...
        *,
        ...
        Keyword Args:
            ContentMD5: The Base64 encoded 128-bit ``MD5`` digest of the data. You must
                use this header as a message integrity
                check to verify that the request body was not corrupted in transit. For
            ...
            ChecksumAlgorithm: Indicates the algorithm used to create the checksum for
                ...
                header will not provide any additional functionality if you don't use
                the SDK. When you send this header, there must
                be a corresponding ``x-amz- checksum`` or ``x-amz-trailer`` header sent.
                Otherwise, Amazon S3 fails the request with
    ...
    def delete_website(
        ...
        Args:
            Bucket: The bucket name for which you want to remove the website
                configuration.
    ...
    def get_tags(
        ...
        results: "builtins.list[Tag]" = None
        if response is not None:
            results = response.TagSet

        self.sessionize(results)
        return cast("builtins.list[Tag]", results)
    ...
    def get_lifecycle(
        ...
        For information about lifecycle configuration, see `Object Lifecycle Management <https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html>`_.
    ...
    def put_lifecycle(
        ...
        *,
        ...
        you want to retain any configuration details, they must
        be included in the new lifecycle configuration. For information about lifecycle
        configuration, see `Managing your
        ...
        Keyword Args:
            ...
            ExpectedBucketOwner: The account ID of the expected bucket owner. If the
                ...
                the actual owner of the bucket, the request fails with the HTTP status
                code ``403 Forbidden`` (access denied).
            TransitionDefaultMinimumObjectSize: Indicates which default minimum object
                size behavior is applied to the lifecycle
                configuration.
        """
        args: dict[str, Any] = dict(
            Bucket=self.serialize(Bucket),
    ...
    def put_public_access_block(
        ...
        *,
        ...
        Args:
            ...
            PublicAccessBlockConfiguration: The ``PublicAccessBlock`` configuration that
                you want to apply to this Amazon S3
                bucket. You can enable the configuration options in any combination. For
                more information about when Amazon S3
        ...
        Keyword Args:
            ...
            ChecksumAlgorithm: Indicates the algorithm used to create the checksum for
                the object when you use the SDK. This
                header will not provide any additional functionality if you don't use
                the SDK. When you send this header, there must
                be a corresponding ``x-amz- checksum`` or ``x-amz-trailer`` header sent.
                Otherwise, Amazon S3 fails the request with
...
class S3ObjectManager(Boto3ModelManager):
    ...
    def create(
        ...
        Grantee ACL in a request after October 1, 2025, the request will receive an
        ...
        Keyword Args:
            ACL: The canned ACL to apply to the object. For more information, see
                `Canned ACL
                <https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#CannedACL>`_ in the *Amazon S3 User Guide*.
            Body: Object data.
            CacheControl: Can be used to specify caching behavior along the
                request/reply chain. For more information, see
            ...
            ContentEncoding: Specifies what content encodings have been applied to the
                object and thus what decoding mechanisms
                must be applied to obtain the media-type referenced by the Content-Type
                header field. For more information, see
                <https://www.rfc- editor.org/rfc/rfc9110.html#field.content-encoding>.
            ContentLanguage: The language the content is in.
            ContentLength: Size of the body in bytes. This parameter is useful when the
                size of the body cannot be determined
            ...
            ContentMD5: The Base64 encoded 128-bit ``MD5`` digest of the message
                ...
                This header can be used as a message integrity check to verify that the
                data is the same data that was originally
                sent. Although it is optional, we recommend using the Content-MD5
                mechanism as an end-to-end integrity check. For
                more information about REST request authentication, see `REST
                Authentication
            ...
            ChecksumCRC32: This header can be used as a data integrity check to verify
                that the data received is the same data
                that was originally sent. This header specifies the Base64 encoded,
                32-bit ``CRC32`` checksum of the object. For
            ...
            ChecksumCRC32C: This header can be used as a data integrity check to verify
                that the data received is the same data
                that was originally sent. This header specifies the Base64 encoded,
                32-bit ``CRC32C`` checksum of the object. For
                more information, see `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-
                object-integrity.html>`_ in the *Amazon S3 User Guide*.
            ChecksumCRC64NVME: This header can be used as a data integrity check to
                verify that the data received is the same
                data that was originally sent. This header specifies the Base64 encoded,
                64-bit ``CRC64NVME`` checksum of the
                ...
                integrity.html>`_.
            ChecksumSHA1: This header can be used as a data integrity check to verify
                that the data received is the same data
                that was originally sent. This header specifies the Base64 encoded,
                160-bit ``SHA1`` digest of the object. For more
            ...
            ChecksumSHA256: This header can be used as a data integrity check to verify
                that the data received is the same data
                that was originally sent. This header specifies the Base64 encoded,
                256-bit ``SHA256`` digest of the object. For
                more information, see `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-
                object-integrity.html>`_ in the *Amazon S3 User Guide*.
            ChecksumSHA512: This header can be used as a data integrity check to verify
                that the data received is the same data
                that was originally sent. This header specifies the Base64 encoded,
                512-bit ``SHA512`` digest of the object. For
                more information, see `Checking object integrity in the Amazon S3 User
                Guide
                <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking- object-integrity.html>`_.
            ChecksumMD5: This header can be used as a data integrity check to verify
                that the data received is the same data
                that was originally sent. This header specifies the Base64 encoded,
                128-bit ``MD5`` digest of the object. For more
                information, see `Checking object integrity in the Amazon S3 User Guide
                <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking- object-integrity.html>`_.
            ChecksumXXHASH64: This header can be used as a data integrity check to
                verify that the data received is the same
                data that was originally sent. This header specifies the Base64 encoded,
                64-bit ``XXHASH64`` checksum of the object.
                For more information, see `Checking object integrity in the Amazon S3
                User Guide
                <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking- object-integrity.html>`_.
            ChecksumXXHASH3: This header can be used as a data integrity check to verify
                that the data received is the same data
                that was originally sent. This header specifies the Base64 encoded,
                64-bit ``XXHASH3`` checksum of the object. For
                more information, see `Checking object integrity in the Amazon S3 User
                Guide
                <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking- object-integrity.html>`_.
            ChecksumXXHASH128: This header can be used as a data integrity check to
                verify that the data received is the same
                data that was originally sent. This header specifies the Base64 encoded,
                128-bit ``XXHASH128`` checksum of the
            ...
            IfMatch: Uploads the object only if the ETag (entity tag) value provided
                during the WRITE operation matches the ETag
                of the object in S3. If the ETag values do not match, the operation
                returns a ``412 Precondition Failed`` error.
            IfNoneMatch: Uploads the object only if the object key name does not already
                exist in the bucket specified.
            ...
            WriteOffsetBytes: Specifies the offset for appending data to existing
                objects in bytes. The offset must be equal to
                the size of the existing object being appended to. If no object exists,
                setting this header to 0 will create a new
                object.
            Metadata: A map of metadata to store with the object in S3.
            ServerSideEncryption: The server-side encryption algorithm that was used
                when you store this object in Amazon S3 or
                Amazon FSx.
            WebsiteRedirectLocation: If the bucket is configured as a website, redirects
                requests for this object to another
                object in the same bucket or to an external URL. Amazon S3 stores the
            ...
            SSECustomerAlgorithm: Specifies the algorithm to use when encrypting the
                object (for example, ``AES256``).
            SSECustomerKey: Specifies the customer-provided encryption key for Amazon S3
                to use in encrypting data. This value
                is used to store the object and then it is discarded; Amazon S3 does not
                store the encryption key. The key must be
                appropriate for use with the algorithm specified in the
                ``x-amz-server-side-encryption-customer-algorithm`` header.
            SSECustomerKeyMD5: Specifies the 128-bit MD5 digest of the encryption key
                according to RFC 1321. Amazon S3 uses this
                header for a message integrity check to ensure that the encryption key
                was transmitted without error.
            SSEKMSKeyId: Specifies the KMS key ID (Key ID, Key ARN, or Key Alias) to use
                for object encryption. If the KMS key
                doesn't exist in the same account that's issuing the command, you must
                use the full Key ARN not the Key ID.
            SSEKMSEncryptionContext: Specifies the Amazon Web Services KMS Encryption
                Context as an additional encryption
                context to use for object encryption. The value of this header is a
                Base64 encoded string of a UTF-8 encoded JSON,
                which contains the encryption context as key-value pairs. This value is
                stored as object metadata and automatically
                gets passed on to Amazon Web Services KMS for future ``GetObject``
                operations on this object.
            BucketKeyEnabled: Specifies whether Amazon S3 should use an S3 Bucket Key
                for object encryption with server-side
                encryption using Key Management Service (KMS) keys (SSE-KMS).
            RequestPayer: Confirms that the requester knows that they will be charged
                for the request. Bucket owners need not
                specify this parameter in their requests. If either the source or
                destination S3 bucket has Requester Pays enabled,
                the requester will pay for the corresponding charges. For information
                about downloading objects from Requester Pays
            ...
            ObjectLockRetainUntilDate: The date and time when you want this object's
                Object Lock to expire. Must be formatted as
                a timestamp parameter.
            ObjectLockLegalHoldStatus: Specifies whether a legal hold will be applied to
                this object. For more information about
        ...
        *,
        ...
        Keyword Args:
            IfMatch: Return the object only if its entity tag (ETag) is the same as the
                one specified in this header; otherwise,
                return a ``412 Precondition Failed`` error.
            IfModifiedSince: Return the object only if it has been modified since the
                specified time; otherwise, return a ``304
                Not Modified`` error.
            IfNoneMatch: Return the object only if its entity tag (ETag) is different
                from the one specified in this header;
                otherwise, return a ``304 Not Modified`` error.
            IfUnmodifiedSince: Return the object only if it has not been modified since
                the specified time; otherwise, return a
                ``412 Precondition Failed`` error.
            Range: Downloads the specified byte range of an object. For more information
            ...
            SSECustomerAlgorithm: Specifies the algorithm to use when decrypting the
                object (for example, ``AES256``).
            SSECustomerKey: Specifies the customer-provided encryption key that you
                originally provided for Amazon S3 to encrypt
                the data before storing it. This value is used to decrypt the object
                when recovering it and must match the one used
                when storing the data. The key must be appropriate for use with the
                algorithm specified in the ``x-amz-server-side-
                encryption-customer- algorithm`` header.
            SSECustomerKeyMD5: Specifies the 128-bit MD5 digest of the customer-provided
                encryption key according to RFC 1321.
                Amazon S3 uses this header for a message integrity check to ensure that
                the encryption key was transmitted without
                error.
            RequestPayer: Confirms that the requester knows that they will be charged
                for the request. Bucket owners need not
                specify this parameter in their requests. If either the source or
                ...
                <https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html>`_ in the *Amazon S3 User
                Guide*.
            PartNumber: Part number of the object being read. This is a positive integer
                between 1 and 10,000. Effectively
    ...
    def list(
        ...
        *,
        ...
        and handle it appropriately. For more
        ...
        Args:
            Bucket: **Directory buckets** - When you use this operation with a directory
                bucket, you must use virtual-hosted-
                style requests   in the format
                ``Bucket-name.s3express-zone-id.region-code.amazonaws.com``. Path-style
                requests are
                not supported.   Directory bucket names must be unique in the chosen
                Zone (Availability Zone or Local Zone). Bucket
                names must follow the   format  ``bucket-base-name--zone-id--x-s3`` (for
                example,  ``amzn-s3-demo-bucket--usw2-az1--
                x-s3``). For information   about bucket naming restrictions, see
        ...
        Keyword Args:
            ...
            EncodingType: Encoding type used by Amazon S3 to encode the `object keys
                ...
                only in UTF-8. An object key can contain any Unicode character. However,
                the XML 1.0 parser can't parse certain
                characters, such as characters with an ASCII value from 0 to 10. For
                characters that aren't supported in XML 1.0,
                you can add this parameter to request that Amazon S3 encode the keys in
                the response. For more information about
            ...
            MaxKeys: Sets the maximum number of keys returned in the response. By
                default, the action returns up to 1,000 key
                names. The response might contain fewer keys but will never contain
                more.
            ...
            FetchOwner: The owner field is not present in ``ListObjectsV2`` by default.
                If you want to return the owner field
                with each key in the result, then set the ``FetchOwner`` field to
                ``true``.
            StartAfter: StartAfter is where you want Amazon S3 to start listing from.
                Amazon S3 starts listing after this
            ...
            RequestPayer: Confirms that the requester knows that she or he will be
                charged for the list objects request in V2
                style. Bucket owners need not specify this parameter in their requests.
            ExpectedBucketOwner: The account ID of the expected bucket owner. If the
                account ID that you provide does not match
                the actual owner of the bucket, the request fails with the HTTP status
                code ``403 Forbidden`` (access denied).
            OptionalObjectAttributes: Specifies the optional fields that you want
                returned in the response. Fields that you do
                not specify are not returned.
            Include: Extra things to include in the response. Tags are expensive to
                retrieve because they need a second, slow
    ...
    def copy(
        ...
        *,
        ...
        Args:
            ...
            CopySource: Specifies the source object for the copy operation. The source
                object can be up to 5 GB. If the source
                object is an object that was uploaded by using a multipart upload, the
                object copy will be a single part object
        ...
        Keyword Args:
            ...
            ChecksumAlgorithm: Indicates the algorithm that you want Amazon S3 to use to
                create the checksum for the object. For
                more information, see `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-
                object-integrity.html>`_ in the *Amazon S3 User Guide*.
            ContentDisposition: Specifies presentational information for the object.
                Indicates whether an object should be
                displayed in a web browser or downloaded as a file. It allows specifying
                the desired filename for the downloaded
                file.
            ContentEncoding: Specifies what content encodings have been applied to the
                object and thus what decoding mechanisms
                must be applied to obtain the media-type referenced by the Content-Type
                header field.
            ContentLanguage: The language the content is in.
            ContentType: A standard MIME type that describes the format of the object
                data.
            CopySourceIfMatch: Copies the object if its entity tag (ETag) matches the
                specified tag.
            CopySourceIfModifiedSince: Copies the object if it has been modified since
                the specified time.
            ...
            GrantReadACP: Allows grantee to read the object ACL.
            GrantWriteACP: Allows grantee to write the ACL for the applicable object.
            IfMatch: Copies the object if the entity tag (ETag) of the destination
                object matches the specified tag. If the ETag
                values do not match, the operation returns a ``412 Precondition Failed``
                error. If a concurrent operation occurs
                during the upload S3 returns a ``409 ConditionalRequestConflict``
                response. On a 409 failure you should fetch the
                object's ETag and retry the upload.
            IfNoneMatch: Copies the object only if the object key name at the
                destination does not already exist in the bucket
                specified. Otherwise, Amazon S3 returns a ``412 Precondition Failed``
                error. If a concurrent operation occurs during
            ...
            MetadataDirective: Specifies whether the metadata is copied from the source
                object or replaced with metadata that's
                provided in the request. When copying an object, you can preserve all
                metadata (the default) or specify new
                metadata. If this header isn’t specified, ``COPY`` is the default
                behavior.
            TaggingDirective: Specifies whether the object tag-set is copied from the
                source object or replaced with the tag-set
                that's provided in the request.
            ServerSideEncryption: The server-side encryption algorithm used when storing
                this object in Amazon S3. Unrecognized
                or unsupported values won’t write a destination object and will receive
                a ``400 Bad Request`` response.
            StorageClass: If the ``x-amz-storage-class`` header is not used, the copied
                object will be stored in the
                ``STANDARD`` Storage Class by default. The ``STANDARD`` storage class
                provides high durability and high
                availability. Depending on performance needs, you can specify a
                different Storage Class.
            WebsiteRedirectLocation: If the destination bucket is configured as a
                website, redirects requests for this object
                copy to another object in the same bucket or to an external URL. Amazon
                S3 stores the value of this header in the
                object metadata. This value is unique to each object and is not copied
                when using the ``x-amz-metadata-directive``
                header. Instead, you may opt to provide this header in combination with
            ...
            SSECustomerKeyMD5: Specifies the 128-bit MD5 digest of the encryption key
                ...
                was transmitted without error.
            SSEKMSKeyId: Specifies the KMS key ID (Key ID, Key ARN, or Key Alias) to use
                for object encryption. All GET and PUT
                requests for an object protected by KMS will fail if they're not made
                via SSL or using SigV4. For information about
            ...
            SSEKMSEncryptionContext: Specifies the Amazon Web Services KMS Encryption
                Context as an additional encryption
                context to use for the destination object encryption. The value of this
                header is a base64-encoded UTF-8 string
                holding JSON with the encryption context key-value pairs.
            BucketKeyEnabled: Specifies whether Amazon S3 should use an S3 Bucket Key
                for object encryption with server-side
                encryption using Key Management Service (KMS) keys (SSE-KMS). If a
                target object uses SSE-KMS, you can enable an S3
                Bucket Key for the object.
            CopySourceSSECustomerAlgorithm: Specifies the algorithm to use when
                decrypting the source object (for example,
                ``AES256``).
            CopySourceSSECustomerKey: Specifies the customer-provided encryption key for
                Amazon S3 to use to decrypt the source
                object. The encryption key provided in this header must be the same one
                that was used when the source object was
                created.
            CopySourceSSECustomerKeyMD5: Specifies the 128-bit MD5 digest of the
                encryption key according to RFC 1321. Amazon S3
                uses this header for a message integrity check to ensure that the
            ...
            RequestPayer: Confirms that the requester knows that they will be charged
                ...
                <https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html>`_ in the *Amazon S3 User
                Guide*.
            Tagging: The tag-set for the object copy in the destination bucket. This
                value must be used in conjunction with the
                ``x-amz- tagging-directive`` if you choose ``REPLACE`` for the
                ``x-amz-tagging-directive``. If you choose ``COPY``
                for the ``x-amz-tagging-directive``, you don't need to set the
                ``x-amz-tagging`` header, because the tag-set will be
                copied from the source object directly. The tag-set must be encoded as
                URL Query parameters.
            ObjectLockMode: The Object Lock mode that you want to apply to the object
                copy.
            ObjectLockRetainUntilDate: The date and time when you want the Object Lock
                of the object copy to expire.
            ObjectLockLegalHoldStatus: Specifies whether you want to apply a legal hold
                to the object copy.
            ExpectedBucketOwner: The account ID of the expected destination bucket
                owner. If the account ID that you provide
                does not match the actual owner of the destination bucket, the request
                fails with the HTTP status code ``403
                Forbidden`` (access denied).
            ExpectedSourceBucketOwner: The account ID of the expected source bucket
                owner. If the account ID that you provide
                does not match the actual owner of the source bucket, the request fails
    ...
    def rename(
        ...
        *,
        ...
        source and the new name of the object as the destination
        ...
        Args:
            ...
            RenameSource: Specifies the source for the rename operation. The value must
                be URL encoded.

        Keyword Args:
            DestinationIfMatch: Renames the object only if the ETag (entity tag) value
                provided during the operation matches the
                ETag of the object in S3. The ``If-Match`` header field makes the
                request method conditional on ETags. If the ETag
                values do not match, the operation returns a ``412 Precondition Failed``
                error.
            DestinationIfNoneMatch: Renames the object only if the destination does not
                already exist in the specified directory
                bucket. If the object does exist when you send a request with
                ``If-None-Match:*``, the S3 API will return a ``412
                Precondition Failed`` error, preventing an overwrite. The
                ``If-None-Match`` header prevents overwrites of existing
                data by validating that there's not an object with the same key name
                already in your directory bucket.
            DestinationIfModifiedSince: Renames the object if the destination exists and
                if it has been modified since the
                specified time.
            DestinationIfUnmodifiedSince: Renames the object if it hasn't been modified
                since the specified time.
            SourceIfMatch: Renames the object if the source exists and if its entity tag
                (ETag) matches the specified ETag.
            SourceIfNoneMatch: Renames the object if the source exists and if its entity
                tag (ETag) is different than the
                specified ETag. If an asterisk (``*``) character is provided, the
                operation will fail and return a ``412
                Precondition Failed`` error.
            SourceIfModifiedSince: Renames the object if the source exists and if it has
                been modified since the specified time.
            SourceIfUnmodifiedSince: Renames the object if the source exists and hasn't
                been modified since the specified time.
            ClientToken: A unique string with a max of 64 ASCII characters in the ASCII
                range of 33 - 126.
        """
        args: dict[str, Any] = dict(
            Bucket=self.serialize(Bucket),
    ...
    def select_content(
        ...
        *,
        ...
        Args:
            ...
            InputSerialization: Describes the format of the data in the object that is
                being queried.
            OutputSerialization: Describes the format of the data that you want Amazon
                S3 to return in response.

        Keyword Args:
            SSECustomerAlgorithm: The server-side encryption (SSE) algorithm used to
                encrypt the object. This parameter is
                needed only when the object was created using a checksum algorithm. For
                more information, see `Protecting data using
                SSE-C keys <https://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html>`_ in the *Amazon
                S3 User Guide*.
            SSECustomerKey: The server-side encryption (SSE) customer managed key. This
                parameter is needed only when the object
                was created using a checksum algorithm. For more information, see
            ...
            SSECustomerKeyMD5: The MD5 server-side encryption (SSE) customer managed
                key. This parameter is needed only when the
                object was created using a checksum algorithm. For more information, see
                `Protecting data using SSE-C keys
                <https://docs.aws.amazon.com/AmazonS3/latest/dev/ServerSideEncryptionCustomerKeys.html>`_ in the *Amazon S3 User
                Guide*.
            RequestProgress: Specifies if periodic request progress information should
                be enabled.
            ScanRange: Specifies the byte range of the object to get the records from. A
                record is processed when its first byte
                is contained by the range. This parameter is optional, but when
                specified, it must not be empty. See RFC 2616,
        ...
        *,
        ...
        Keyword Args:
            MFA: The concatenation of the authentication device's serial number, a
                space, and the value that is displayed on
                your authentication device. Required to permanently delete a versioned
                object if versioning is configured with MFA
                delete enabled.
            RequestPayer: Confirms that the requester knows that they will be charged
                for the request. Bucket owners need not
                specify this parameter in their requests. If either the source or
                ...
                <https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html>`_ in the *Amazon S3 User
                Guide*.
            BypassGovernanceRetention: Specifies whether you want to delete this object
                even if it has a Governance-type Object
    ...
    def get_tags(
        ...
        *,
        ...
        Args:
            Bucket: The bucket name containing the object for which to get the tagging
                information.
            Key: Object key for which to get the tagging information.

        Keyword Args:
            VersionId: The versionId of the object for which to get the tagging
                information.
            ExpectedBucketOwner: The account ID of the expected bucket owner. If the
                account ID that you provide does not match
                the actual owner of the bucket, the request fails with the HTTP status
        ...
        *,
        ...
        Keyword Args:
            ...
            ExpectedBucketOwner: The account ID of the expected bucket owner. If the
                ...
                code ``403 Forbidden`` (access denied).
            RequestPayer: Confirms that the requester knows that she or he will be
                charged for the tagging object request.
    ...
    def delete_tags(
        ...
        *,
        ...
        Args:
            Bucket: The bucket name containing the objects from which to remove the
                tags.
            Key: The key that identifies the object in the bucket from which to remove
                all tags.
    ...
    def get_acl(
        ...
        *,
        ...
        Args:
            Bucket: The bucket name that contains the object for which to get the ACL
                information.
    ...
    def put_acl(
        ...
        *,
        ...
        Args:
            Bucket: The bucket name that contains the object to which you want to attach
                the ACL.
        ...
        Keyword Args:
            ...
            AccessControlPolicy: Contains the elements that set the ACL permissions for
                an object per grantee.
            ContentMD5: The Base64 encoded 128-bit ``MD5`` digest of the data. This
                header must be used as a message integrity
                check to verify that the request body was not corrupted in transit. For
                more information, go to `RFC 1864.>
                <http://www.ietf.org/rfc/rfc1864.txt>`_
            ChecksumAlgorithm: Indicates the algorithm used to create the checksum for
                the object when you use the SDK. This
                header will not provide any additional functionality if you don't use
    ...
    def get_legal_hold(
        ...
        *,
        ...
        Args:
            Bucket: The bucket name containing the object whose legal hold status you
                want to retrieve.
            Key: The key name for the object whose legal hold status you want to
                retrieve.

        Keyword Args:
            VersionId: The version ID of the object whose legal hold status you want to
                retrieve.
            RequestPayer: Confirms that the requester knows that they will be charged
                for the request. Bucket owners need not
                specify this parameter in their requests. If either the source or
    ...
    def put_legal_hold(
        ...
        *,
        ...
        Args:
            Bucket: The bucket name containing the object that you want to place a legal
                hold on.
            Key: The key name for the object that you want to place a legal hold on.

        Keyword Args:
            LegalHold: Container element for the legal hold configuration you want to
            ...
            RequestPayer: Confirms that the requester knows that they will be charged
                ...
                <https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html>`_ in the *Amazon S3 User
                Guide*.
            VersionId: The version ID of the object that you want to place a legal hold
                on.
            ContentMD5: The MD5 hash for the request body.
            ChecksumAlgorithm: Indicates the algorithm used to create the checksum for
                the object when you use the SDK. This
    ...
    def get_retention(
        ...
        *,
        ...
        Args:
            Bucket: The bucket name containing the object whose retention settings you
                want to retrieve.
            Key: The key name for the object whose retention settings you want to
                retrieve.

        Keyword Args:
            VersionId: The version ID for the object whose retention settings you want
                to retrieve.
            RequestPayer: Confirms that the requester knows that they will be charged
                for the request. Bucket owners need not
                specify this parameter in their requests. If either the source or
    ...
    def put_retention(
        ...
        *,
        ...
        Args:
            Bucket: The bucket name that contains the object you want to apply this
        ...
        Keyword Args:
            ...
            RequestPayer: Confirms that the requester knows that they will be charged
                ...
                <https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectsinRequesterPaysBuckets.html>`_ in the *Amazon S3 User
                Guide*.
            VersionId: The version ID for the object that you want to apply this Object
                Retention configuration to.
            BypassGovernanceRetention: Indicates whether this action should bypass
    ...
    def get_attributes(
        ...
        *,
        ...
        Args:
            ...
            Key: The object key.
            ObjectAttributes: Specifies the fields at the root level that you want
                returned in the response. Fields that you do
                not specify are not returned.

        Keyword Args:
            VersionId: The version ID used to reference a specific version of the
                object.
            MaxParts: Sets the maximum number of parts to return. For more information,
                see `Uploading and copying objects using
                multipart upload in Amazon S3 <https://docs.aws.amazon.com/AmazonS3/latest/userguide/mpuoverview.html>`_  in the
                *Amazon Simple Storage Service user guide*.
            PartNumberMarker: Specifies the part after which listing should begin. Only
                parts with higher part numbers will be
    ...
    def get_versions(
        ...
        *,
        ...
        Keyword Args:
            Delimiter: A delimiter is a character that you specify to group keys. All
                keys that contain the same string between
                the ``prefix`` and the first occurrence of the delimiter are grouped
                under a single result element in
                ``CommonPrefixes``. These groups are counted as one result against the
                ``max-keys`` limitation. These keys are not
            ...
            MaxKeys: Sets the maximum number of keys returned in the response. By
                default, the action returns up to 1,000 key
                names. The response might contain fewer keys but will never contain
                more. If additional keys satisfy the search
            ...
            Prefix: Use this parameter to select only those keys that begin with the
                specified prefix. You can use prefixes to
                separate a bucket into different groupings of keys. (You can think of
                using ``prefix`` to make groups in the same
                way that you'd use a folder in a file system.) You can use ``prefix``
                with ``delimiter`` to roll up numerous objects
...
class S3Condition(Boto3Model):
    ...
    redirect is applied. Required when parent element ``Condition`` is specified and
    sibling ``KeyPrefixEquals`` is not specified. If both are specified, then both must
...
class Redirect(Boto3Model):
    ...
    For example, to redirect requests for all pages with prefix ``docs/`` (objects in
    the ``docs/`` folder) to ``documents/``, you can set a condition block with
    ``KeyPrefixEquals`` set to ``docs/`` and in the Redirect set
    ``ReplaceKeyPrefixWith`` to ``/documents``. Not required if one of the siblings is
...
class Transition(Boto3Model):
    ...
    *Amazon S3 User Guide*.
    ...
    If the specified storage class is ``INTELLIGENT_TIERING``, ``GLACIER_IR``,
    ``GLACIER``, or ``DEEP_ARCHIVE``, valid values are
    ``0`` or positive integers. If the specified storage class is ``STANDARD_IA`` or
    ``ONEZONE_IA``, valid values are
    positive integers greater than ``30``. Be aware that some storage classes have a
    minimum storage duration and that
    you're charged for transitioning objects before their minimum storage duration. For
    ...
    considerations.html#lifecycle-configuration-constraints>`_ in the *Amazon S3 User
    Guide*.
    """
...
class LifecycleRule(Boto3Model):
    ...
    We recommend using ``Filter`` instead of ``Prefix`` for new PUTs. Previous
...
class S3PublicAccessBlockConfiguration(Boto3Model):
    ...
    work alongside account-level settings (which may inherit from
    organization-level policies). For more information about when Amazon S3 considers a
    bucket or object public, see `The
    ...
    Services service principals and authorized users within this account if the bucket
    has a public policy.
    """

class Bucket(TagsDictMixin, PrimaryBoto3Model):
    tag_class: ClassVar[ModelType[Boto3Model]] = Tag
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = BucketManager
    ...
    def pk(self) -> str | None:
        ...
        This is the value of the :py:attr:`BucketName` attribute.
...
class S3RestoreStatus(Boto3Model):
    ...
    If the object restoration is in progress, the header returns the value ``TRUE``. For
    example:
    """
...
class S3Object(TagsDictMixin, PrimaryBoto3Model):
    ...
    tag_class: ClassVar[ModelType[Boto3Model]] = Any
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = S3ObjectManager
    ...
    ETag may or may not be an MD5 digest of the object data. Whether or not it is
    ...
    def name(self) -> str | None:
        ...
        This is the value of the :py:attr:`Key` attribute.
...
class ListBucketsOutput(Boto3Model):
    ...
    The next ``ListBuckets`` request to Amazon S3 can be continued with this
...
S3/latest/API/API_PutBucketLifecycleConfiguration.html>`_) in the *Amazon S3 User
Guide*, the response includes this
...
expiration. The value of the ``rule-id`` is URL-encoded.
    ...
    This header is present if the object was uploaded with the ``CRC64NVME`` checksum
    algorithm, or if it was uploaded without a checksum (and Amazon S3 added the default
    checksum, ``CRC64NVME``, to the uploaded object). For more information about how
    ...
    This header is present if the object was uploaded with the ``SHA512`` checksum
    ...
    This header is present if the object was uploaded with the ``MD5`` checksum
    algorithm. For more information, see
    `Checking object integrity in the Amazon S3 User Guide <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_.
    """
    ChecksumXXHASH64: "str | None" = None
    ...
    This header is present if the object was uploaded with the ``XXHASH64`` checksum
    algorithm. For more information, see
    `Checking object integrity in the Amazon S3 User Guide <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_.
    """
    ChecksumXXHASH3: "str | None" = None
    ...
    This header is present if the object was uploaded with the ``XXHASH3`` checksum
    algorithm. For more information, see
    `Checking object integrity in the Amazon S3 User Guide <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_.
    """
    ...
    This header is present if the object was uploaded with the ``XXHASH128`` checksum
    algorithm. For more information, see
    `Checking object integrity in the Amazon S3 User Guide <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_.
    """
    ...
    For ``PutObject`` uploads, the checksum type is always ``FULL_OBJECT``. You can use
    this header as a data integrity check to verify that the checksum type that is
    received is the same checksum that was specified. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
    ...
    This value is stored as object metadata and automatically gets passed on to Amazon
    Web Services KMS for future
...
latest/API/API_PutBucketLifecycleConfiguration.html>`_ ), the response includes this
header. It includes the ``expiry-
date`` and ``rule-id`` key-value pairs providing object expiration information. The
...
encoded.
    ...
    You can use this header response to verify that the checksum type that is received
    is the same checksum type that was specified in the ``CreateMultipartUpload``
...
class ListObjectsV2Output(Boto3Model):
    ...
    Set to ``true`` if more keys are available to return. If the number of results
    ...
    These rolled-up keys are not returned elsewhere in the response. Each rolled-up
    ...
    The next list requests to Amazon S3 can be continued with this
...
class S3CopyObjectResult(Boto3Model):
    ...
    ``CRC64NVME`` checksum algorithm, or if the object was uploaded without a checksum
    (and Amazon S3 added the default checksum, ``CRC64NVME``, to the uploaded object).
    For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    ...
    This checksum is only present if the object was uploaded with the ``SHA512``
    ...
    This checksum is only present if the object was uploaded with the ``MD5`` checksum
    algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    ...
    This checksum is only present if the object was uploaded with the ``XXHASH64``
    checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    ...
    This checksum is only present if the object was uploaded with the ``XXHASH3``
    checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    ...
    This checksum is only present if the object was uploaded with the ``XXHASH128``
    checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
...
class S3SelectParameters(Boto3Model):
    ...
    Learn
    `How to optimize querying your data in Amazon S3 <http://aws.amazon.com/blogs/storage/how-to-optimize-querying-
     your-data-in-amazon-s3/>`_ using
    `Amazon Athena <https://docs.aws.amazon.com/athena/latest/ug/what-is.html>`_,
    `S3 Object Lambda <https://docs.aws.amazon.com/AmazonS3/latest/userguide/transforming-objects.html>`_,
...
class ScanRange(Boto3Model):
    ...
    is 0. If only ``start`` is supplied, it means scan from that point to the end of the
    file. For example, ``<scanrange><start>50</start></scanrange>`` means scan from byte
    ...
    This parameter is optional. Valid values: non-negative integers. The default value
    is one less than the size of the object being queried. If only the End parameter is
...
class RecordsEvent(Boto3Model):
    ...
    S3 Select doesn't guarantee that a record will be self-contained in one record
    frame. To ensure continuous streaming of data, S3 Select might split the same record
    across multiple record frames instead of aggregating the results in memory. Some S3
    ...
    behavior by default. In those cases, you must aggregate the results on the client
...
class S3ObjectLockRule(Boto3Model):
    ...
    Bucket settings require both a mode and a period. The period can be either ``Days``
    or ``Years`` but you must select one. You cannot specify ``Days`` and ``Years`` at
    the same time.
    """
...
class S3ObjectLockConfiguration(Boto3Model):
    ...
    Enable the this rule when you apply ``ObjectLockConfiguration`` to a bucket. Bucket
    settings require both a mode and a period. The period can be either ``Days`` or
    ``Years`` but you must select one. You cannot specify ``Days`` and ``Years`` at the
    same time.
    """
...
class S3Checksum(Boto3Model):
    ...
    This checksum is present if the object was uploaded with the ``CRC64NVME`` checksum
    algorithm, or if the object was uploaded without a checksum (and Amazon S3 added the
    default checksum, ``CRC64NVME``, to the uploaded object). For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
    ...
    This checksum is present if the object was uploaded with the ``SHA512`` checksum
    algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    ...
    This checksum is present if the object was uploaded with the ``MD5`` checksum
    algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    ...
    This checksum is present if the object was uploaded with the ``XXHASH64`` checksum
    algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    ...
    This checksum is present if the object was uploaded with the ``XXHASH3`` checksum
    algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    ...
    This checksum is present if the object was uploaded with the ``XXHASH128`` checksum
    algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
...
class ObjectPart(Boto3Model):
    ...
    This checksum is present if the multipart upload request was created with the
    ``CRC32`` checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
    ...
    This checksum is present if the multipart upload request was created with the
    ``CRC32C`` checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
    ...
    This checksum is present if the multipart upload request was created with the
    ``SHA1`` checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
    ...
    This checksum is present if the multipart upload request was created with the
    ``SHA256`` checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
    ...
    This checksum is present if the multipart upload request was created with the
    ``SHA512`` checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
    ...
    This checksum is present if the multipart upload request was created with the
    ``MD5`` checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
    ...
    This checksum is present if the multipart upload request was created with the
    ``XXHASH64`` checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
    ...
    This checksum is present if the multipart upload request was created with the
    ``XXHASH3`` checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
    ...
    This checksum is present if the multipart upload request was created with the
    ``XXHASH128`` checksum algorithm. For more information, see
    `Checking object integrity <https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html>`_
    in the *Amazon S3 User
    Guide*.
    """
class GetObjectAttributesParts(Boto3Model):
    ...
    A value of ``true`` indicates that the list was truncated. A list can be truncated
...
class GetObjectAttributesOutput(Boto3Model):
    ...
    If ``false``, this response header does not appear in the response. To learn more
...
class ListObjectVersionsOutput(Boto3Model):
    ...
    If your results were truncated, you can make a follow-up paginated request by using
    the ``NextKeyMarker`` and ``NextVersionIdMarker`` response parameters as a starting
    ...
    same string between the prefix and the first occurrence of the delimiter are grouped
    under a single result element in ``CommonPrefixes``. These groups are counted as one
    result against the ``max-keys`` limitation. These keys are not returned elsewhere in
    the response.
    """
