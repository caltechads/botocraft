...
class EventRuleManager(Boto3ModelManager):
    ...
    def create(
        self, model: "EventRule", Tags: "builtins.list[Tag] | None" = None
    ) -> str:
        """
    ...
    def delete(
        ...
        Keyword Args:
            EventBusName: The name or ARN of the event bus associated with the rule. If
                you omit this, the default event bus is
                used.
            Force: If this is a managed rule, created by an Amazon Web Services service
                on your behalf, you must specify
                ``Force`` as ``True`` to delete the rule. This parameter is ignored for
                rules that are not managed rules. You can
                check whether a rule is a managed rule by using ``DescribeRule`` or
                ``ListRules`` and checking the ``ManagedBy``
    ...
    def list(
        ...
        *,
        ...
        Keyword Args:
            ...
            EventBusName: The name or ARN of the event bus to list the rules for. If you
                omit this, the default event bus is
                used.
    ...
    def list_by_target(
        ...
        *,
        ...
        Keyword Args:
            EventBusName: The name or ARN of the event bus to list rules for. If you
    ...
    def list_targets(
        ...
        *,
        ...
        results: "builtins.list[EventTarget]" = []
        ...
        self.sessionize(results)
        return cast("builtins.list[EventTarget]", results)
    ...
    def enable(self, Name: str, *, EventBusName: "str | None" = None) -> None:
        ...
        If the rule does not exist, the operation fails.
                ...
                Keyword Args:
                    EventBusName: The name or ARN of the event bus associated with the
                        rule. If you omit this, the default event bus is
                        used.
        """
        args: dict[str, Any] = dict(
            Name=self.serialize(Name), EventBusName=self.serialize(EventBusName)
...
class EventBusManager(Boto3ModelManager):
    ...
    def create(
        ...
        Keyword Args:
            EventSourceName: If you are creating a partner event bus, this specifies the
                partner event source that the new event
                bus will be matched with.
            KmsKeyIdentifier: The identifier of the KMS customer managed key for
                EventBridge to use, if you choose to use a
                customer managed key to encrypt events on this event bus. The identifier
                can be the key Amazon Resource Name (ARN),
                KeyId, key alias, or key alias ARN.
            DeadLetterConfig: Configuration details of the Amazon SQS queue for
                EventBridge to use as a dead-letter queue (DLQ).
    ...
    def get(self, *, Name: "str | None" = None) -> "EventBus | None":
        """
        ...
        event buses and partner event
        buses, it displays the name, ARN, policy, state, and creation time.

        Keyword Args:
            Name: The name or ARN of the event bus to show details for. If you omit
        ...
        *,
        ...
        Keyword Args:
            NamePrefix: Specifying this limits the results to only those event buses
                with names that start with the specified
                prefix.
            NextToken: The token returned by a previous call, which you can use to
                retrieve the next set of results.
            Limit: Specifying this limits the number of results returned by this
                operation. The operation also returns a
                NextToken which you can use in a subsequent operation to retrieve the
                next set of results.
        """
        args: dict[str, Any] = dict(
            NamePrefix=self.serialize(NamePrefix),
    ...
    def put_events(
        self,
        Entries: "builtins.list[PutEventsRequestEntry]",
        *,
        ...
        Args:
            Entries: The entry that defines an event in your system. You can specify
                several parameters for the entry such as
                the source and type of the event, resources associated with the event,
                and so on.

        Keyword Args:
            EndpointId: The URL subdomain of the endpoint. For example, if the URL for
                Endpoint is
    ...
    def list_rules(
        ...
        *,
        ...
        results: builtins.list["EventRule"] = []
        ...
        self.sessionize(results)
        return cast("builtins.list[EventRule]", results)
...
class EventRule(PrimaryBoto3Model):
    ...
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = EventRuleManager
...
class EventsInputTransformer(Boto3Model):
    ...
    InputPathsMap: "dict[str, str] | None" = Field(default_factory=dict)
    """
...
class RunCommandTarget(Boto3Model):
    ...
    Each
    ``RunCommandTarget`` block can include only one key, but this key may specify
    multiple values.
    """
...
class EventsRunCommandParameters(Boto3Model):
    ...
    RunCommandTargets: "builtins.list[RunCommandTarget]"
    """
...
class EventsCapacityProviderStrategyItem(Boto3Model):
    ...
    om/AmazonECS/latest/APIReference/API_CapacityProviderStrategyItem.html>`_ in the
...
class EventsEcsParameters(TagsDictMixin, Boto3Model):
    ...
    `Fargate on Amazon ECS <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/AWS-Fargate.html>`_
    ...
    ``LaunchType`` is ``FARGATE`` because the ``awsvpc`` mode is required for Fargate
    tasks.
    """
    ...
    CapacityProviderStrategy: "builtins.list[EventsCapacityProviderStrategyItem] | None" = Field(
    ...
    PlacementConstraints: "builtins.list[EventsPlacementConstraint] | None" = Field(
        default_factory=list
    )
    """
    ...
    PlacementStrategy: "builtins.list[EventsPlacementStrategy] | None" = Field(
        default_factory=list
    )
    """
...
class EventsRedshiftDataParameters(Boto3Model):
    ...
    Sqls: "builtins.list[str] | None" = Field(default_factory=list)
    """
...
class EventsSageMakerPipelineParameters(Boto3Model):
    ...
    """
    PipelineParameterList: "builtins.list[SageMakerPipelineParameter] | None" = Field(
        default_factory=list
    )
    """
...
class EventTarget(PrimaryBoto3Model):
    ...
    `PutTargets <https://docs.aws.amazon.com/eventbridge/latest/APIReference/API_PutTargets.html>`_.

    If you are setting the event bus of another account as the target, and that account
    granted permission to your account through an organization instead of directly by
    the account ID, then you must specify a ``RoleArn`` with proper permissions in the
    ``Target`` structure. For more information, see
    `Sending and Receiving Events Between Amazon Web Services Accounts <https://docs.aws.amazon.com/eventbridge/latest/userguide/eventbridge-cross-account-event-
    delivery.html>`_ in the *Amazon EventBridge User Guide*.
    """
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = EventTargetManager
    ...
    In this case, nothing from the event itself is passed to the target. For more information, see `The JavaScript Object Notation (JSON) Data Interchange Format <http://www.rfc-
...
is used.
    ...
    Resources: "builtins.list[str] | None" = Field(default_factory=list)
    """
...
class EventBus(PrimaryBoto3Model):
    ...
    """
    manager_class: ClassVar[ModelType[Boto3ModelManager]] = EventBusManager
    ...
    def rules(self) -> builtins.list["EventRule"]:
        """
...
class DescribeRuleResponse(Boto3Model):
    ...
    If you use ``PutRule`` to put a rule on an event bus in another account, the other
    account is the owner of the rule, and the rule ARN includes the account ID for that
    account. However, the value for ``CreatedBy`` is the account ID as the account that
    created the rule in the other account.
    """

class ListRulesResponse(Boto3Model):
    Rules: "builtins.list[EventRule] | None" = Field(default_factory=list)
    """
...
class ListRuleNamesByTargetResponse(Boto3Model):
    RuleNames: "builtins.list[str] | None" = Field(default_factory=list)
    """
...
class ListTargetsByRuleResponse(Boto3Model):
    Targets: "builtins.list[EventTarget] | None" = Field(default_factory=list)
    """
...
class PutTargetsResultEntry(Boto3Model):
    ...
    If the value is ``ConcurrentModificationException``, too many requests were made at
    the same time.
    """
...
class PutTargetsResponse(Boto3Model):
    ...
    FailedEntries: "builtins.list[PutTargetsResultEntry] | None" = Field(
        default_factory=list
    )
    """
...
class RemoveTargetsResponse(Boto3Model):
    ...
    FailedEntries: "builtins.list[RemoveTargetsResultEntry] | None" = Field(
        default_factory=list
    )
    """
    The failed target entries.
...
class ListEventBusesResponse(Boto3Model):
    EventBuses: "builtins.list[EventBus] | None" = Field(default_factory=list)
    """
...
class PutEventsResponse(Boto3Model):
    ...
    Entries: "builtins.list[PutEventsResultEntry] | None" = Field(default_factory=list)
    """
