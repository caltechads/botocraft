...
class Elbv2AWSAPICallViaCloudTrail(BaseModel):
    """
    Detail payload for an ELBv2 API call delivered via CloudTrail.
...
class Elbv2AWSAPICallViaCloudTrailEvent(BaseModel):
    """
    Top-level EventBridge envelope for ELBv2 CloudTrail API call events.
    """

    #: Detailed CloudTrail API call payload.
    detail: Elbv2AWSAPICallViaCloudTrail
