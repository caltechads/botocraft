...
class CodePipelineAWSAPICallViaCloudTrail(BaseModel):
    """
    Detail payload for a CodePipeline API call delivered via CloudTrail.
...
class CodepipelineAWSAPICallViaCloudTrailEvent(BaseModel):
    """
    Top-level EventBridge envelope for CodePipeline CloudTrail API call events.
    """

    #: Detailed CloudTrail API call payload.
    detail: CodePipelineAWSAPICallViaCloudTrail
