...
class ElasticacheAWSAPICallViaCloudTrail(BaseModel):
    """
    Detail payload for an ElastiCache API call delivered via CloudTrail.
...
class ElasticacheAWSAPICallViaCloudTrailEvent(BaseModel):
    """
    Top-level EventBridge envelope for ElastiCache CloudTrail API call events.
    """

    #: Detailed CloudTrail API call payload.
    detail: ElasticacheAWSAPICallViaCloudTrail
