...
class ECSAWSAPICallViaCloudTrail(BaseModel):
    """
    Detail payload for an ECS API call delivered via CloudTrail.
...
class ECSAWSAPICallViaCloudTrailEvent(BaseModel):
    """
    Top-level EventBridge envelope for ECS CloudTrail API call events.
    """

    #: Detailed CloudTrail API call payload.
    detail: ECSAWSAPICallViaCloudTrail
