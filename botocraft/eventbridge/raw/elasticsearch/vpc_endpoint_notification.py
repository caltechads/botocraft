...
class ElasticsearchVPCEndpointNotificationEvent(BaseModel):
    """
    Top-level EventBridge envelope for ``aws.es`` VPC endpoint notifications.
    """

    #: Detailed VPC endpoint notification payload.
