...
class ElasticsearchSoftwareUpdateNotificationEvent(BaseModel):
    """
    Top-level EventBridge envelope for ``aws.es`` software update notifications.
    """

    #: Detailed software update notification payload.
