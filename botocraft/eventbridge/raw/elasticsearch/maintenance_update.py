...
class ElasticsearchMaintenanceUpdateEvent(BaseModel):
    """
    Top-level EventBridge envelope for ``aws.es`` maintenance update events.
    """

    #: Detailed maintenance update payload.
