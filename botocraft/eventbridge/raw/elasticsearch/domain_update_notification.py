...
class ElasticsearchDomainUpdateNotificationEvent(BaseModel):
    """
    Top-level EventBridge envelope for ``aws.es`` domain update notifications.
    """

    #: Detailed domain update payload.
