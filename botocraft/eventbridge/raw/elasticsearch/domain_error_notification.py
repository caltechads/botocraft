...
class ElasticsearchDomainErrorNotificationEvent(BaseModel):
    """
    Top-level EventBridge envelope for ``aws.es`` domain error notifications.
    """

    #: Detailed domain error payload.
